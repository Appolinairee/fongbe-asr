...
public class FlutterImageView extends View implements RenderSurface {
    ...
    private void updateCurrentBitmap() {
        if (Build.VERSION.SDK_INT >= 29) {
            HardwareBuffer m = FileVisitorImpl$$ExternalSyntheticApiModelOutline0.m(this.currentImage);
            this.currentBitmap = Bitmap.wrapHardwareBuffer(m, ColorSpace.get(ColorKt$$ExternalSyntheticApiModelOutline0.m()));
            m.close();
            return;
        }
