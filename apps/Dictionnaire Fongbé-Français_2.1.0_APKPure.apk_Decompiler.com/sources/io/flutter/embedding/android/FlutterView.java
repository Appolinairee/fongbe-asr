...
public class FlutterView extends FrameLayout implements MouseCursorPlugin.MouseCursorViewDelegate, KeyboardManager.ViewDelegate {
    ...
    public final WindowInsets onApplyWindowInsets(WindowInsets windowInsets) {
        ...
        if (Build.VERSION.SDK_INT == 29) {
            Insets m$2 = windowInsets.getSystemGestureInsets();
            this.viewportMetrics.systemGestureInsetTop = m$2.top;
            this.viewportMetrics.systemGestureInsetRight = m$2.right;
            this.viewportMetrics.systemGestureInsetBottom = m$2.bottom;
            this.viewportMetrics.systemGestureInsetLeft = m$2.left;
        }
        boolean z = true;
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            Insets m$1 = windowInsets.getInsets(FileVisitorImpl$$ExternalSyntheticApiModelOutline0.m());
            this.viewportMetrics.viewPaddingTop = m$1.top;
            this.viewportMetrics.viewPaddingRight = m$1.right;
            this.viewportMetrics.viewPaddingBottom = m$1.bottom;
            this.viewportMetrics.viewPaddingLeft = m$1.left;
            Insets m$12 = windowInsets.getInsets(HalfKt$$ExternalSyntheticApiModelOutline0.m());
            this.viewportMetrics.viewInsetTop = m$12.top;
            this.viewportMetrics.viewInsetRight = m$12.right;
            this.viewportMetrics.viewInsetBottom = m$12.bottom;
            this.viewportMetrics.viewInsetLeft = m$12.left;
            Insets m$13 = windowInsets.getInsets(PrintHelper$$ExternalSyntheticApiModelOutline0.m$3());
            this.viewportMetrics.systemGestureInsetTop = m$13.top;
            this.viewportMetrics.systemGestureInsetRight = m$13.right;
            this.viewportMetrics.systemGestureInsetBottom = m$13.bottom;
            this.viewportMetrics.systemGestureInsetLeft = m$13.left;
            DisplayCutout m2 = HalfKt$$ExternalSyntheticApiModelOutline0.m(windowInsets);
            if (m2 != null) {
                Insets m3 = m2.getWaterfallInsets();
                FlutterRenderer.ViewportMetrics viewportMetrics2 = this.viewportMetrics;
                viewportMetrics2.viewPaddingTop = Math.max(Math.max(viewportMetrics2.viewPaddingTop, m3.top), m2.getSafeInsetTop());
                FlutterRenderer.ViewportMetrics viewportMetrics3 = this.viewportMetrics;
                viewportMetrics3.viewPaddingRight = Math.max(Math.max(viewportMetrics3.viewPaddingRight, m3.right), m2.getSafeInsetRight());
                FlutterRenderer.ViewportMetrics viewportMetrics4 = this.viewportMetrics;
                viewportMetrics4.viewPaddingBottom = Math.max(Math.max(viewportMetrics4.viewPaddingBottom, m3.bottom), m2.getSafeInsetBottom());
                FlutterRenderer.ViewportMetrics viewportMetrics5 = this.viewportMetrics;
                viewportMetrics5.viewPaddingLeft = Math.max(Math.max(viewportMetrics5.viewPaddingLeft, m3.left), m2.getSafeInsetLeft());
            }
        } else {
        ...
        ArrayList arrayList = new ArrayList();
        if (Build.VERSION.SDK_INT >= 28 && (m = HalfKt$$ExternalSyntheticApiModelOutline0.m(windowInsets)) != null) {
    ...
    public void sendUserSettingsToFlutter() {
        ...
        L_0x0015:
            ...
            android.view.textservice.TextServicesManager r1 = r6.textServicesManager
            java.util.List r1 = kotlin.io.path.FileVisitorImpl$$ExternalSyntheticApiModelOutline0.m((android.view.textservice.TextServicesManager) r1)
            java.util.stream.Stream r1 = r1.stream()
            io.flutter.embedding.android.FlutterView$$ExternalSyntheticLambda6 r4 = new io.flutter.embedding.android.FlutterView$$ExternalSyntheticLambda6
            r4.<init>()
            boolean r1 = r1.anyMatch(r4)
            android.view.textservice.TextServicesManager r4 = r6.textServicesManager
            boolean r4 = kotlin.io.path.FileVisitorImpl$$ExternalSyntheticApiModelOutline0.m((android.view.textservice.TextServicesManager) r4)
