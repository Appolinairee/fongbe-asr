...
public class KeyEmbedderResponder implements KeyboardManager.Responder {
    ...
    public void synchronizePressingKey(KeyboardMap.PressingGoal pressingGoal, boolean z, long j, long j2, KeyEvent keyEvent, ArrayList<Runnable> arrayList) {
        ...
        while (true) {
            boolean z3 = true;
            if (i >= pressingGoal2.keys.length) {
                break;
            }
            KeyboardMap.KeyPair keyPair = pressingGoal2.keys[i];
    ...
    public /* synthetic */ void m387lambda$synchronizePressingKey$0$ioflutterembeddingandroidKeyEmbedderResponder(KeyboardMap.KeyPair keyPair, long j, KeyEvent keyEvent) {
    ...
    public /* synthetic */ void m388lambda$synchronizePressingKey$1$ioflutterembeddingandroidKeyEmbedderResponder(KeyboardMap.KeyPair keyPair, KeyEvent keyEvent) {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:68:0x0145 A[LOOP:2: B:66:0x013f->B:68:0x0145, LOOP_END] */
    ...
    private void sendKeyEvent(KeyData keyData, KeyboardManager.Responder.OnKeyEventHandledCallback onKeyEventHandledCallback) {
        KeyEmbedderResponder$$ExternalSyntheticLambda0 keyEmbedderResponder$$ExternalSyntheticLambda0;
        if (onKeyEventHandledCallback == null) {
            keyEmbedderResponder$$ExternalSyntheticLambda0 = null;
        } else {
            keyEmbedderResponder$$ExternalSyntheticLambda0 = new KeyEmbedderResponder$$ExternalSyntheticLambda0(onKeyEventHandledCallback);
        }
        this.messenger.send(KeyData.CHANNEL, keyData.toBytes(), keyEmbedderResponder$$ExternalSyntheticLambda0);
    }
