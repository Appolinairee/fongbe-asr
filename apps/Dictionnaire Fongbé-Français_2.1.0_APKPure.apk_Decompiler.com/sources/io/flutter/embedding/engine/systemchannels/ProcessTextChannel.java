...
public class ProcessTextChannel {
    ...
    public ProcessTextChannel(DartExecutor dartExecutor, PackageManager packageManager2) {
    ...
    public void setMethodHandler(ProcessTextMethodHandler processTextMethodHandler2) {
