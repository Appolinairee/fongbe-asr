...
public class FlutterJNI {
    ...
    public static Bitmap decodeImage(ByteBuffer byteBuffer, long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            try {
                return ColorKt$$ExternalSyntheticApiModelOutline0.m(ImageDecoder.createSource(byteBuffer), (ImageDecoder.OnHeaderDecodedListener) new FlutterJNI$$ExternalSyntheticLambda4(j));
            } catch (IOException e) {
    ...
    static /* synthetic */ void lambda$decodeImage$0(long j, ImageDecoder imageDecoder, ImageDecoder.ImageInfo imageInfo, ImageDecoder.Source source) {
        ...
        Size m = imageInfo.getSize();
        nativeImageHeaderCallback(j, m.getWidth(), m.getHeight());
    }
