...
class DartMessenger implements BinaryMessenger, PlatformMessageHandler {
    ...
    static class SerialTaskQueue implements DartMessengerTaskQueue {
        ...
        /* renamed from: flush */
        public void m391lambda$flush$1$ioflutterembeddingenginedartDartMessenger$SerialTaskQueue() {
    ...
    public void setMessageHandler(java.lang.String r9, io.flutter.plugin.common.BinaryMessenger.BinaryMessageHandler r10, io.flutter.plugin.common.BinaryMessenger.TaskQueue r11) {
        /*
            ...
            monitor-enter(r0)
            java.util.Map<java.lang.String, io.flutter.embedding.engine.dart.DartMessenger$HandlerInfo> r10 = r8.messageHandlers     // Catch:{ all -> 0x0024 }
            r10.remove(r9)     // Catch:{ all -> 0x0024 }
        ...
        L_0x003d:
            ...
            java.lang.Object r0 = r8.handlersLock
            monitor-enter(r0)
            java.util.Map<java.lang.String, io.flutter.embedding.engine.dart.DartMessenger$HandlerInfo> r1 = r8.messageHandlers     // Catch:{ all -> 0x0095 }
            io.flutter.embedding.engine.dart.DartMessenger$HandlerInfo r2 = new io.flutter.embedding.engine.dart.DartMessenger$HandlerInfo     // Catch:{ all -> 0x0095 }
            r2.<init>(r10, r11)     // Catch:{ all -> 0x0095 }
            r1.put(r9, r2)     // Catch:{ all -> 0x0095 }
            java.util.Map<java.lang.String, java.util.List<io.flutter.embedding.engine.dart.DartMessenger$BufferedMessageInfo>> r10 = r8.bufferedMessages     // Catch:{ all -> 0x0095 }
            java.lang.Object r10 = r10.remove(r9)     // Catch:{ all -> 0x0095 }
            java.util.List r10 = (java.util.List) r10     // Catch:{ all -> 0x0095 }
    ...
    public /* synthetic */ void m389lambda$dispatchMessageToQueue$0$ioflutterembeddingenginedartDartMessenger(String str, int i, HandlerInfo handlerInfo, ByteBuffer byteBuffer, long j) {
        TraceSection scoped;
