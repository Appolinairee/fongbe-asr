...
public class FlutterEngine implements ViewUtils.DisplayUpdater {
    ...
    public FlutterEngine(Context context, FlutterLoader flutterLoader, FlutterJNI flutterJNI2, PlatformViewsController platformViewsController2, String[] strArr, boolean z, boolean z2, FlutterEngineGroup flutterEngineGroup) {
        ...
        this.scribeChannel = new ScribeChannel(dartExecutor2);
