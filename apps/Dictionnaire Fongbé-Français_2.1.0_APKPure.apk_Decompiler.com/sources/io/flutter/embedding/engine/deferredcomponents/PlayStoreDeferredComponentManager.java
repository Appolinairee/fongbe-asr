...
public class PlayStoreDeferredComponentManager implements DeferredComponentManager {
    ...
    public void installDeferredComponent(int i, String str) {
        ...
        if (str2 == null) {
            ...
            this.splitInstallManager.startInstall(SplitInstallRequest.newBuilder().addModule(str2).build()).addOnSuccessListener(new PlayStoreDeferredComponentManager$$ExternalSyntheticLambda0(this, str2, i)).addOnFailureListener(new PlayStoreDeferredComponentManager$$ExternalSyntheticLambda1(this, i, str));
        } else {
    ...
    public /* synthetic */ void m392lambda$installDeferredComponent$0$ioflutterembeddingenginedeferredcomponentsPlayStoreDeferredComponentManager(String str, int i, Integer num) {
    ...
    public /* synthetic */ void m393lambda$installDeferredComponent$1$ioflutterembeddingenginedeferredcomponentsPlayStoreDeferredComponentManager(int i, String str, Exception exc) {
