...
final class SharedPreferencesPlugin$getString$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    SharedPreferencesPlugin$getString$1(String str, SharedPreferencesPlugin sharedPreferencesPlugin, Ref.ObjectRef<String> objectRef, Continuation<? super SharedPreferencesPlugin$getString$1> continuation) {
    ...
    public final Object invokeSuspend(T t) {
        ...
        if (i == 0) {
            ...
            this.L$0 = objectRef2;
            this.label = 1;
            T firstOrNull = FlowKt.firstOrNull(new SharedPreferencesPlugin$getString$1$invokeSuspend$$inlined$map$1(SharedPreferencesPluginKt.getSharedPreferencesDataStore(access$getContext$p).getData(), stringKey), this);
