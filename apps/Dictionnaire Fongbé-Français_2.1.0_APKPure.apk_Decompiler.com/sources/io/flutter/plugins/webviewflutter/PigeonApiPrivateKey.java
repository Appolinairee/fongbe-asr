...
public class PigeonApiPrivateKey {
    ...
    public final void pigeon_newInstance(PrivateKey privateKey, Function1<? super Result<Unit>, Unit> function1) {
        Intrinsics.checkNotNullParameter(privateKey, "pigeon_instanceArg");
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            ...
            new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.PrivateKey.pigeon_newInstance", getPigeonRegistrar().getCodec()).send(CollectionsKt.listOf(Long.valueOf(getPigeonRegistrar().getInstanceManager().addHostCreatedInstance(privateKey))), new PigeonApiPrivateKey$$ExternalSyntheticLambda0(function1, "dev.flutter.pigeon.webview_flutter_android.PrivateKey.pigeon_newInstance"));
        }
    }
