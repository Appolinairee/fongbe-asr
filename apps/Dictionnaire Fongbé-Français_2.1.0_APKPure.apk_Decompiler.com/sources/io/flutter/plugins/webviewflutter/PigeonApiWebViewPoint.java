...
public abstract class PigeonApiWebViewPoint {
    ...
    public final void pigeon_newInstance(WebViewPoint webViewPoint, Function1<? super Result<Unit>, Unit> function1) {
        Intrinsics.checkNotNullParameter(webViewPoint, "pigeon_instanceArg");
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
        ...
        } else if (getPigeonRegistrar().getInstanceManager().containsInstance(webViewPoint)) {
            ...
            new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.WebViewPoint.pigeon_newInstance", getPigeonRegistrar().getCodec()).send(CollectionsKt.listOf(Long.valueOf(addHostCreatedInstance), Long.valueOf(x), Long.valueOf(y)), new PigeonApiWebViewPoint$$ExternalSyntheticLambda0(function1, "dev.flutter.pigeon.webview_flutter_android.WebViewPoint.pigeon_newInstance"));
        }
    }
