...
public abstract class PigeonApiFileChooserParams {
    ...
    public final void pigeon_newInstance(WebChromeClient.FileChooserParams fileChooserParams, Function1<? super Result<Unit>, Unit> function1) {
        Intrinsics.checkNotNullParameter(fileChooserParams, "pigeon_instanceArg");
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            ...
            List<String> acceptTypes = acceptTypes(fileChooserParams);
            FileChooserMode mode = mode(fileChooserParams);
            String filenameHint = filenameHint(fileChooserParams);
            new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.FileChooserParams.pigeon_newInstance", getPigeonRegistrar().getCodec()).send(CollectionsKt.listOf(Long.valueOf(addHostCreatedInstance), Boolean.valueOf(isCaptureEnabled), acceptTypes, mode, filenameHint), new PigeonApiFileChooserParams$$ExternalSyntheticLambda0(function1, "dev.flutter.pigeon.webview_flutter_android.FileChooserParams.pigeon_newInstance"));
        }
    }
