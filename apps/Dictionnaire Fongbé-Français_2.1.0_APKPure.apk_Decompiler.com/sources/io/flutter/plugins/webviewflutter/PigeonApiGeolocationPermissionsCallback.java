...
public abstract class PigeonApiGeolocationPermissionsCallback {
    ...
    public PigeonApiGeolocationPermissionsCallback(AndroidWebkitLibraryPigeonProxyApiRegistrar androidWebkitLibraryPigeonProxyApiRegistrar) {
    ...
    public static final class Companion {
        ...
        public final void setUpMessageHandlers(BinaryMessenger binaryMessenger, PigeonApiGeolocationPermissionsCallback pigeonApiGeolocationPermissionsCallback) {
            ...
            if (pigeonApiGeolocationPermissionsCallback == null || (pigeonRegistrar = pigeonApiGeolocationPermissionsCallback.getPigeonRegistrar()) == null || (messageCodec = pigeonRegistrar.getCodec()) == null) {
                messageCodec = new AndroidWebkitLibraryPigeonCodec();
            }
            Companion companion = this;
            BasicMessageChannel basicMessageChannel = new BasicMessageChannel(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android.GeolocationPermissionsCallback.invoke", messageCodec);
            if (pigeonApiGeolocationPermissionsCallback != null) {
                basicMessageChannel.setMessageHandler(new PigeonApiGeolocationPermissionsCallback$Companion$$ExternalSyntheticLambda0(pigeonApiGeolocationPermissionsCallback));
            } else {
    ...
    public final void pigeon_newInstance(GeolocationPermissions.Callback callback, Function1<? super Result<Unit>, Unit> function1) {
        Intrinsics.checkNotNullParameter(callback, "pigeon_instanceArg");
        ...
        } else if (getPigeonRegistrar().getInstanceManager().containsInstance(callback)) {
            Result.Companion companion2 = Result.Companion;
            function1.invoke(Result.m510boximpl(Result.m511constructorimpl(Unit.INSTANCE)));
        } else {
            new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.GeolocationPermissionsCallback.pigeon_newInstance", getPigeonRegistrar().getCodec()).send(CollectionsKt.listOf(Long.valueOf(getPigeonRegistrar().getInstanceManager().addHostCreatedInstance(callback))), new PigeonApiGeolocationPermissionsCallback$$ExternalSyntheticLambda0(function1, "dev.flutter.pigeon.webview_flutter_android.GeolocationPermissionsCallback.pigeon_newInstance"));
        }
    }
