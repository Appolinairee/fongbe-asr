...
public abstract class PigeonApiCustomViewCallback {
    ...
    @Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0018\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\b\u0010\u0007\u001a\u0004\u0018\u00010\b¨\u0006\t"}, d2 = {"Lio/flutter/plugins/webviewflutter/PigeonApiCustomViewCallback$Companion;", "", "()V", "setUpMessageHandlers", "", "binaryMessenger", "Lio/flutter/plugin/common/BinaryMessenger;", "api", "Lio/flutter/plugins/webviewflutter/PigeonApiCustomViewCallback;", "webview_flutter_android_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    /* compiled from: AndroidWebkitLibrary.g.kt */
    public static final class Companion {
        ...
        public final void setUpMessageHandlers(BinaryMessenger binaryMessenger, PigeonApiCustomViewCallback pigeonApiCustomViewCallback) {
            ...
            if (pigeonApiCustomViewCallback == null || (pigeonRegistrar = pigeonApiCustomViewCallback.getPigeonRegistrar()) == null || (messageCodec = pigeonRegistrar.getCodec()) == null) {
                messageCodec = new AndroidWebkitLibraryPigeonCodec();
            }
            Companion companion = this;
            BasicMessageChannel basicMessageChannel = new BasicMessageChannel(binaryMessenger, "dev.flutter.pigeon.webview_flutter_android.CustomViewCallback.onCustomViewHidden", messageCodec);
            if (pigeonApiCustomViewCallback != null) {
                basicMessageChannel.setMessageHandler(new PigeonApiCustomViewCallback$Companion$$ExternalSyntheticLambda0(pigeonApiCustomViewCallback));
            } else {
    ...
    public final void pigeon_newInstance(WebChromeClient.CustomViewCallback customViewCallback, Function1<? super Result<Unit>, Unit> function1) {
        Intrinsics.checkNotNullParameter(customViewCallback, "pigeon_instanceArg");
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            ...
            new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.CustomViewCallback.pigeon_newInstance", getPigeonRegistrar().getCodec()).send(CollectionsKt.listOf(Long.valueOf(getPigeonRegistrar().getInstanceManager().addHostCreatedInstance(customViewCallback))), new PigeonApiCustomViewCallback$$ExternalSyntheticLambda0(function1, "dev.flutter.pigeon.webview_flutter_android.CustomViewCallback.pigeon_newInstance"));
        }
    }
