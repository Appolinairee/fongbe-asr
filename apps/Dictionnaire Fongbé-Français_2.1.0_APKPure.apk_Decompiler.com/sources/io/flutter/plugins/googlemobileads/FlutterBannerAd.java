...
class FlutterBannerAd extends FlutterAd implements FlutterAdLoadedListener {
    ...
    public FlutterBannerAd(int i, AdInstanceManager adInstanceManager, String str, FlutterAdRequest flutterAdRequest, FlutterAdSize flutterAdSize, BannerAdCreator bannerAdCreator2) {
        super(i);
