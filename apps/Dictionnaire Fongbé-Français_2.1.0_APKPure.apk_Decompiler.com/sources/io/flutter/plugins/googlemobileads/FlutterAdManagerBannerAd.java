...
class FlutterAdManagerBannerAd extends FlutterAd implements FlutterAdLoadedListener {
    ...
    public FlutterAdManagerBannerAd(int i, AdInstanceManager adInstanceManager, String str, List<FlutterAdSize> list, FlutterAdManagerAdRequest flutterAdManagerAdRequest, BannerAdCreator bannerAdCreator2) {
        super(i);
