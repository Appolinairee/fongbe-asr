...
public class FlutterAdLoader {
    ...
    public void loadAppOpen(String str, AdRequest adRequest, AppOpenAd.AppOpenAdLoadCallback appOpenAdLoadCallback) {
        AppOpenAd.load(this.context, str, adRequest, appOpenAdLoadCallback);
    }

    public void loadAdManagerAppOpen(String str, AdManagerAdRequest adManagerAdRequest, AppOpenAd.AppOpenAdLoadCallback appOpenAdLoadCallback) {
