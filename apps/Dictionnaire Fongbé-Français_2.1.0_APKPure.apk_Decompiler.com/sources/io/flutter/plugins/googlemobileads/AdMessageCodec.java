...
class AdMessageCodec extends StandardMessageCodec {
    ...
    public Object readValueOfType(byte b, ByteBuffer byteBuffer) {
        ...
        switch (b) {
            ...
            case -127:
                return new FlutterAdRequest.Builder().setKeywords((List) readValueOfType(byteBuffer.get(), byteBuffer2)).setContentUrl((String) readValueOfType(byteBuffer.get(), byteBuffer2)).setNonPersonalizedAds(booleanValueOf(readValueOfType(byteBuffer.get(), byteBuffer2))).setNeighboringContentUrls((List) readValueOfType(byteBuffer.get(), byteBuffer2)).setHttpTimeoutMillis((Integer) readValueOfType(byteBuffer.get(), byteBuffer2)).setMediationNetworkExtrasIdentifier((String) readValueOfType(byteBuffer.get(), byteBuffer2)).setMediationNetworkExtrasProvider(this.mediationNetworkExtrasProvider).setAdMobExtras((Map) readValueOfType(byteBuffer.get(), byteBuffer2)).setRequestAgent(this.requestAgentProvider.getRequestAgent()).setMediationExtras((List) readValueOfType(byteBuffer.get(), byteBuffer2)).build();
            case -126:
            ...
            case -122:
                ...
                builder.setMediationExtras((List) readValueOfType(byteBuffer.get(), byteBuffer2));
            ...
            case -102:
                String str2 = (String) readValueOfType(byteBuffer.get(), byteBuffer2);
                Map map = (Map) readValueOfType(byteBuffer.get(), byteBuffer2);
                try {
