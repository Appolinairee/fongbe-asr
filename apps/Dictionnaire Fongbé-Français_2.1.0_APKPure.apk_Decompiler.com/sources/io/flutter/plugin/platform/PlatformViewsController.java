...
public class PlatformViewsController implements PlatformViewsAccessibilityDelegate {
    ...
    private final PlatformViewsChannel.PlatformViewsHandler channelHandler = new PlatformViewsChannel.PlatformViewsHandler() {
        ...
        public void resize(PlatformViewsChannel.PlatformViewResizeRequest platformViewResizeRequest, PlatformViewsChannel.PlatformViewBufferResized platformViewBufferResized) {
            ...
            if (PlatformViewsController.this.usesVirtualDisplay(i)) {
                ...
                virtualDisplayController.resize(access$1100, access$11002, new PlatformViewsController$1$$ExternalSyntheticLambda0(this, virtualDisplayController, access$1200, platformViewBufferResized));
                return;
            }
            PlatformView platformView = (PlatformView) PlatformViewsController.this.platformViews.get(i);
            PlatformViewWrapper platformViewWrapper = (PlatformViewWrapper) PlatformViewsController.this.viewWrappers.get(i);
        ...
        public /* synthetic */ void m406lambda$resize$0$ioflutterpluginplatformPlatformViewsController$1(VirtualDisplayController virtualDisplayController, float f, PlatformViewsChannel.PlatformViewBufferResized platformViewBufferResized) {
    ...
    public /* synthetic */ void m403lambda$configureForVirtualDisplay$0$ioflutterpluginplatformPlatformViewsController(PlatformViewsChannel.PlatformViewCreationRequest platformViewCreationRequest, View view, boolean z) {
        if (z) {
    ...
    public long configureForTextureLayerComposition(PlatformView platformView, PlatformViewsChannel.PlatformViewCreationRequest platformViewCreationRequest) {
        ...
        platformViewWrapper.setOnDescendantFocusChangeListener(new PlatformViewsController$$ExternalSyntheticLambda1(this, platformViewCreationRequest));
    ...
    public /* synthetic */ void m402lambda$configureForTextureLayerComposition$1$ioflutterpluginplatformPlatformViewsController(PlatformViewsChannel.PlatformViewCreationRequest platformViewCreationRequest, View view, boolean z) {
        if (z) {
            this.platformViewsChannel.invokeViewFocused(platformViewCreationRequest.viewId);
            return;
        }
    ...
    public /* synthetic */ void m404lambda$initializePlatformViewIfNeeded$2$ioflutterpluginplatformPlatformViewsController(int i, View view, boolean z) {
        if (z) {
    ...
    public /* synthetic */ void m405lambda$onEndFrame$3$ioflutterpluginplatformPlatformViewsController() {
        finishFrame(false);
    }
