...
public final class DurationKt {
    ...
    private static final long m328timesmvk6XK0(int i, long j) {
        return Duration.m239timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk  reason: not valid java name */
    private static final long m327timeskIfJnKk(double d, long j) {
        return Duration.m238timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        if (length != 0) {
            long r82 = Duration.Companion.m304getZEROUwyO8pc();
            ...
            if (length > i) {
                ...
                if (str2.charAt(i) == 'P') {
                                ...
                                if (charSequence.length() != 0) {
                                    ...
                                    if (durationUnit2 == null || durationUnit2.compareTo(durationUnitByIsoChar) > 0) {
                                        ...
                                        if (durationUnitByIsoChar != DurationUnit.SECONDS || indexOf$default <= 0) {
                                            r82 = Duration.m237plusLRDsOJo(r82, toDuration(parseOverLongIsoComponent(substring), durationUnitByIsoChar));
                                        } else {
                                            Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                                            String substring2 = substring.substring(0, indexOf$default);
                                            Intrinsics.checkNotNullExpressionValue(substring2, "substring(...)");
                                            long r83 = Duration.m237plusLRDsOJo(r82, toDuration(parseOverLongIsoComponent(substring2), durationUnitByIsoChar));
                                            Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                                            String substring3 = substring.substring(indexOf$default);
                                            Intrinsics.checkNotNullExpressionValue(substring3, "substring(...)");
                                            r82 = Duration.m237plusLRDsOJo(r83, toDuration(Double.parseDouble(substring3), durationUnitByIsoChar));
                                        }
                                        obj2 = obj;
                    ...
                    if (!z) {
                        ...
                        if (StringsKt.regionMatches(str, i, "Infinity", 0, Math.max(length - i, 8), true)) {
                            r82 = Duration.Companion.m302getINFINITEUwyO8pc();
                        } else {
                            boolean z7 = !z4;
                                ...
                                if (charSequence3.length() != 0) {
                                    ...
                                    if (durationUnit == null || durationUnit.compareTo(durationUnitByShortName) > 0) {
                                        ...
                                        if (indexOf$default2 > 0) {
                                            ...
                                            long r84 = Duration.m237plusLRDsOJo(r82, toDuration(Long.parseLong(substring6), durationUnitByShortName));
                                            Intrinsics.checkNotNull(substring4, "null cannot be cast to non-null type java.lang.String");
                                            String substring7 = substring4.substring(indexOf$default2);
                                            Intrinsics.checkNotNullExpressionValue(substring7, str4);
                                            r8 = Duration.m237plusLRDsOJo(r84, toDuration(Double.parseDouble(substring7), durationUnitByShortName));
                                            if (i < length) {
                                                throw new IllegalArgumentException("Fractional component must be last");
                                            }
                                        } else {
                                            r8 = Duration.m237plusLRDsOJo(r82, toDuration(Long.parseLong(substring4), durationUnitByShortName));
                                        }
                ...
                if (z2) {
                    return Duration.m254unaryMinusUwyO8pc(r82);
                }
                return r82;
            }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m201constructorimpl(j << 1);
    }

    /* access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m201constructorimpl((j << 1) + 1);
    }

    /* access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m201constructorimpl((j << 1) + ((long) i));
    }
