...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m190getAdjustmentUwyO8pc() {
    ...
    public TimeMark m191minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m341minusLRDsOJo(this, j);
    }

    /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
    public long m189elapsedNowUwyO8pc() {
        return Duration.m236minusLRDsOJo(this.mark.m338elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m192plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m237plusLRDsOJo(this.adjustment, j), (DefaultConstructorMarker) null);
    }
}
