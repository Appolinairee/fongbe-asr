...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public ComparableTimeMark m179minusLRDsOJo(long j) {
            return ComparableTimeMark.DefaultImpls.m196minusLRDsOJo(this, j);
        }

        /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
        public long m177elapsedNowUwyO8pc() {
            return Duration.m236minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public ComparableTimeMark m182plusLRDsOJo(long j) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m237plusLRDsOJo(this.offset, j), (DefaultConstructorMarker) null);
        }

        /* renamed from: minus-UwyO8pc  reason: not valid java name */
        public long m180minusUwyO8pc(ComparableTimeMark comparableTimeMark) {
            ...
            if (comparableTimeMark instanceof DoubleTimeMark) {
                ...
                if (Intrinsics.areEqual((Object) this.timeSource, (Object) doubleTimeMark.timeSource)) {
                    if (Duration.m206equalsimpl0(this.offset, doubleTimeMark.offset) && Duration.m233isInfiniteimpl(this.offset)) {
                        return Duration.Companion.m304getZEROUwyO8pc();
                    }
                    long r2 = Duration.m236minusLRDsOJo(this.offset, doubleTimeMark.offset);
                    long duration = DurationKt.toDuration(this.startedAt - doubleTimeMark.startedAt, this.timeSource.getUnit());
                    return Duration.m206equalsimpl0(duration, Duration.m254unaryMinusUwyO8pc(r2)) ? Duration.Companion.m304getZEROUwyO8pc() : Duration.m237plusLRDsOJo(duration, r2);
                }
            }
        ...
        public boolean equals(Object obj) {
            return (obj instanceof DoubleTimeMark) && Intrinsics.areEqual((Object) this.timeSource, (Object) ((DoubleTimeMark) obj).timeSource) && Duration.m206equalsimpl0(m180minusUwyO8pc((ComparableTimeMark) obj), Duration.Companion.m304getZEROUwyO8pc());
        }

        public int hashCode() {
            return Duration.m229hashCodeimpl(Duration.m237plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + Duration.m250toStringimpl(this.offset) + ", " + this.timeSource + ')';
        }
    }

    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m304getZEROUwyO8pc(), (DefaultConstructorMarker) null);
    }
}
