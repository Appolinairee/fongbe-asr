...
public final class LongSaturatedMathKt {
    ...
    public static final long m330saturatingAddNuflL3o(long j, DurationUnit durationUnit, long j2) {
        Intrinsics.checkNotNullParameter(durationUnit, "unit");
        long r5 = Duration.m247toLongimpl(j2, durationUnit);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m329checkInfiniteSumDefinedPjuGub4(j, j2, r5);
        }
        if ((1 | (r5 - 1)) == Long.MAX_VALUE) {
            return m331saturatingAddInHalvesNuflL3o(j, durationUnit, j2);
        }
        long j3 = j + r5;
        if (((j ^ j3) & (r5 ^ j3)) >= 0) {
            return j3;
    ...
    private static final long m329checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
        if (!Duration.m233isInfiniteimpl(j2) || (j ^ j3) >= 0) {
            return j;
        }
    ...
    private static final long m331saturatingAddInHalvesNuflL3o(long j, DurationUnit durationUnit, long j2) {
        long r0 = Duration.m204divUwyO8pc(j2, 2);
        long r2 = Duration.m247toLongimpl(r0, durationUnit);
        if ((1 | (r2 - 1)) == Long.MAX_VALUE) {
            return r2;
        }
        return m330saturatingAddNuflL3o(m330saturatingAddNuflL3o(j, durationUnit, r0), durationUnit, Duration.m236minusLRDsOJo(j2, r0));
    }

    private static final long infinityOfSign(long j) {
        int i = (j > 0 ? 1 : (j == 0 ? 0 : -1));
        Duration.Companion companion = Duration.Companion;
        return i < 0 ? companion.m303getNEG_INFINITEUwyO8pc$kotlin_stdlib() : companion.m302getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long j, long j2, DurationUnit durationUnit) {
        Intrinsics.checkNotNullParameter(durationUnit, "unit");
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m254unaryMinusUwyO8pc(infinityOfSign(j2));
        }
    ...
    private static final long saturatingFiniteDiff(long j, long j2, DurationUnit durationUnit) {
        ...
        if (durationUnit.compareTo(DurationUnit.MILLISECONDS) >= 0) {
            return Duration.m254unaryMinusUwyO8pc(infinityOfSign(j3));
        }
        ...
        Duration.Companion companion = Duration.Companion;
        return Duration.m237plusLRDsOJo(DurationKt.toDuration((j / convertDurationUnit) - (j2 / convertDurationUnit), DurationUnit.MILLISECONDS), DurationKt.toDuration(j4, durationUnit));
    }
}
