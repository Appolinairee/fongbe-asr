...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> collection) {
        ...
        byte[] r0 = UByteArray.m581constructorimpl(collection.size());
        int i = 0;
        for (UByte r2 : collection) {
            UByteArray.m592setVurrAj0(r0, i, r2.m579unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        int[] r0 = UIntArray.m660constructorimpl(collection.size());
        int i = 0;
        for (UInt r2 : collection) {
            UIntArray.m671setVXSXFK8(r0, i, r2.m658unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        long[] r0 = ULongArray.m739constructorimpl(collection.size());
        int i = 0;
        for (ULong r2 : collection) {
            ULongArray.m750setk8EXiF4(r0, i, r2.m737unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        short[] r0 = UShortArray.m844constructorimpl(collection.size());
        int i = 0;
        for (UShort r2 : collection) {
            UShortArray.m855set01HTLdE(r0, i, r2.m842unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int sumOfUInt(Iterable<UInt> iterable) {
        ...
        for (UInt r1 : iterable) {
            i = UInt.m606constructorimpl(i + r1.m658unboximpl());
        }
        return i;
    }
    ...
    public static final long sumOfULong(Iterable<ULong> iterable) {
        ...
        for (ULong r2 : iterable) {
            j = ULong.m685constructorimpl(j + r2.m737unboximpl());
        }
        return j;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> iterable) {
        ...
        for (UByte r1 : iterable) {
            i = UInt.m606constructorimpl(i + UInt.m606constructorimpl(r1.m579unboximpl() & 255));
        }
        return i;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> iterable) {
        ...
        for (UShort r1 : iterable) {
            i = UInt.m606constructorimpl(i + UInt.m606constructorimpl(r1.m842unboximpl() & UShort.MAX_VALUE));
        }
        return i;
    }
}
