...
public final class UStringsKt {
    ...
    public static final String m174toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m176toStringolVBNx4(short s, int i) {
    ...
    public static final String m175toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m173toStringJSWoG40(long j, int i) {
    ...
    public static final byte toUByte(String str) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m579unboximpl();
        }
    ...
    public static final short toUShort(String str) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m842unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final int toUInt(String str) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m658unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final long toULong(String str) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m737unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m658unboximpl();
        if (Integer.compare(r1 ^ Integer.MIN_VALUE, UInt.m606constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m523boximpl(UByte.m529constructorimpl((byte) r1));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m658unboximpl();
        if (Integer.compare(r1 ^ Integer.MIN_VALUE, UInt.m606constructorimpl(SupportMenu.USER_MASK) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m786boximpl(UShort.m792constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r3 = UInt.m606constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            int r2 = UInt.m606constructorimpl(i3 * r3);
            int r7 = UInt.m606constructorimpl(UInt.m606constructorimpl(digitOf) + r2);
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r5 = ULong.m685constructorimpl((long) i2);
        long j = 0;
        ...
        while (i3 < length) {
            ...
            long r9 = ULong.m685constructorimpl(j * r5);
            long r13 = ULong.m685constructorimpl(ULong.m685constructorimpl(((long) UInt.m606constructorimpl(digitOf)) & KeyboardMap.kValueMask) + r9);
