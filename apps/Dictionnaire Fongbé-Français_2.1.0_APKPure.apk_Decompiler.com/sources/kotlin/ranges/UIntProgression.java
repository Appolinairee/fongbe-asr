...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    public final int m88getFirstpVg5ArA() {
        return this.first;
    }

    /* renamed from: getLast-pVg5ArA  reason: not valid java name */
    public final int m89getLastpVg5ArA() {
        return this.last;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(UInt.m652toStringimpl(this.first));
            sb.append("..");
            sb.append(UInt.m652toStringimpl(this.last));
            sb.append(" step ");
            i = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final UIntProgression m90fromClosedRangeNkh28Cs(int i, int i2, int i3) {
