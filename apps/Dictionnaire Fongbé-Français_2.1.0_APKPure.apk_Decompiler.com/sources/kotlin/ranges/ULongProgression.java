...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public final long m97getFirstsVKNKU() {
        return this.first;
    }

    /* renamed from: getLast-s-VKNKU  reason: not valid java name */
    public final long m98getLastsVKNKU() {
        return this.last;
    }
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + (((((int) ULong.m685constructorimpl(j ^ ULong.m685constructorimpl(j >>> 32))) * 31) + ((int) ULong.m685constructorimpl(j2 ^ ULong.m685constructorimpl(j2 >>> 32)))) * 31);
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            sb.append(ULong.m731toStringimpl(this.first));
            sb.append("..");
            sb.append(ULong.m731toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
    ...
    public static final class Companion {
        ...
        public final ULongProgression m99fromClosedRange7ftBX0g(long j, long j2, long j3) {
