...
public final class OptionalsKt {
    ...
    public static final <T> T getOrDefault(Optional<? extends T> optional, T t) {
        Intrinsics.checkNotNullParameter(optional, "<this>");
        return PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((Optional) optional) ? PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((Optional) optional) : t;
    }

    public static final <T> T getOrElse(Optional<? extends T> optional, Function0<? extends T> function0) {
        Intrinsics.checkNotNullParameter(optional, "<this>");
        Intrinsics.checkNotNullParameter(function0, "defaultValue");
        return PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((Optional) optional) ? PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((Optional) optional) : function0.invoke();
    }

    public static final <T, C extends Collection<? super T>> C toCollection(Optional<T> optional, C c) {
        Intrinsics.checkNotNullParameter(optional, "<this>");
        Intrinsics.checkNotNullParameter(c, "destination");
        if (PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((Optional) optional)) {
            Object m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((Optional) optional);
    ...
    public static final <T> List<T> toList(Optional<? extends T> optional) {
        Intrinsics.checkNotNullParameter(optional, "<this>");
        return PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((Optional) optional) ? CollectionsKt.listOf(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((Optional) optional)) : CollectionsKt.emptyList();
    }

    public static final <T> Set<T> toSet(Optional<? extends T> optional) {
        Intrinsics.checkNotNullParameter(optional, "<this>");
        return PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((Optional) optional) ? SetsKt.setOf(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((Optional) optional)) : SetsKt.emptySet();
    }
    ...
    public static final <T> Sequence<T> asSequence(Optional<? extends T> optional) {
        ...
        return SequencesKt.sequenceOf(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((Optional) optional));
    }
}
