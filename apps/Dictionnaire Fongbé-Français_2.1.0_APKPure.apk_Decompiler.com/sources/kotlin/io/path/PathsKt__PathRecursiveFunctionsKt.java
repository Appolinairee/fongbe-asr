...
class PathsKt__PathRecursiveFunctionsKt extends PathsKt__PathReadWriteKt {
    ...
    public static final Path copyToRecursively(Path path, Path path2, Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> function3, boolean z, Function3<? super CopyActionContext, ? super Path, ? super Path, ? extends CopyActionResult> function32) {
        ...
        if (PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))) {
            boolean z2 = false;
            if (PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path, (LinkOption[]) Arrays.copyOf(new LinkOption[0], 0)) && (z || !PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(path))) {
                boolean z3 = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path2, (LinkOption[]) Arrays.copyOf(new LinkOption[0], 0)) && !PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(path2);
                if (!z3 || !PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path, path2)) {
                    if (Intrinsics.areEqual((Object) PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path), (Object) PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path2))) {
                        if (z3) {
                            z2 = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path2, new LinkOption[0]), PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path, new LinkOption[0]));
                        } else {
                            Path m$1 = path2.getParent();
                            if (m$1 != null && PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(m$1, (LinkOption[]) Arrays.copyOf(new LinkOption[0], 0)) && PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(m$1, new LinkOption[0]), PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(path, new LinkOption[0]))) {
                                z2 = true;
                            }
                        }
                    }
                    if (z2) {
                        FileVisitorImpl$$ExternalSyntheticApiModelOutline0.m$4();
    ...
    public static final void deleteRecursively(Path path) {
        ...
        if (!deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt.isEmpty()) {
            FileSystemException m = FileVisitorImpl$$ExternalSyntheticApiModelOutline0.m("Failed to delete one or more files. See suppressed exceptions for details.");
    ...
    private static final java.util.List<java.lang.Exception> deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt(java.nio.file.Path r8) {
        ...
        L_0x0015:
            ...
            java.nio.file.DirectoryStream r6 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r5)     // Catch:{ all -> 0x003f }
            boolean r7 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r6)     // Catch:{ all -> 0x003f }
            if (r7 == 0) goto L_0x0037
            r0.setPath(r4)     // Catch:{ all -> 0x003f }
            java.nio.file.SecureDirectoryStream r2 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r6)     // Catch:{ all -> 0x003f }
            java.nio.file.Path r4 = r8.getFileName()     // Catch:{ all -> 0x003f }
            java.lang.String r6 = "getFileName(...)"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r4, r6)     // Catch:{ all -> 0x003f }
            handleEntry$PathsKt__PathRecursiveFunctionsKt(r2, r4, r0)     // Catch:{ all -> 0x003f }
            goto L_0x0038
        L_0x0037:
            r1 = 1
        L_0x0038:
            kotlin.Unit r2 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x003f }
    ...
    private static final void handleEntry$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, ExceptionsCollector exceptionsCollector) {
        ...
        try {
            if (isDirectory$PathsKt__PathRecursiveFunctionsKt(secureDirectoryStream, path, FileVisitorImpl$$ExternalSyntheticApiModelOutline0.m())) {
    ...
    private static final void enterDirectory$PathsKt__PathRecursiveFunctionsKt(java.nio.file.SecureDirectoryStream<java.nio.file.Path> r4, java.nio.file.Path r5, kotlin.io.path.ExceptionsCollector r6) {
        /*
            ...
            java.nio.file.LinkOption r2 = kotlin.io.path.FileVisitorImpl$$ExternalSyntheticApiModelOutline0.m()     // Catch:{ NoSuchFileException -> 0x0012 }
            r3 = 0
        ...
        L_0x0020:
            ...
            java.nio.file.Path r2 = kotlin.io.path.FileVisitorImpl$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r2)     // Catch:{ all -> 0x0041 }
    ...
    private static final boolean isDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, LinkOption... linkOptionArr) {
        Boolean bool;
        try {
            bool = Boolean.valueOf(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((Object) secureDirectoryStream.getFileAttributeView(path, PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(), (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))).readAttributes().isDirectory());
        } catch (NoSuchFileException unused) {
            bool = null;
        }
        if (bool != null) {
    ...
    private static final void insecureHandleEntry$PathsKt__PathRecursiveFunctionsKt(Path path, ExceptionsCollector exceptionsCollector) {
        try {
            if (Files.isDirectory(path, (LinkOption[]) Arrays.copyOf(new LinkOption[]{FileVisitorImpl$$ExternalSyntheticApiModelOutline0.m()}, 1))) {
                int totalExceptions = exceptionsCollector.getTotalExceptions();
    ...
    private static final void insecureEnterDirectory$PathsKt__PathRecursiveFunctionsKt(java.nio.file.Path r3, kotlin.io.path.ExceptionsCollector r4) {
        /*
            r0 = 0
            java.nio.file.DirectoryStream r3 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r3)     // Catch:{ NoSuchFileException -> 0x0008 }
            goto L_0x000a
        L_0x0006:
            r3 = move-exception
            goto L_0x0038
        ...
        L_0x000a:
            ...
            java.nio.file.DirectoryStream r1 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r3)     // Catch:{ all -> 0x0031 }
        ...
        L_0x0016:
            ...
            java.nio.file.Path r2 = kotlin.io.path.FileVisitorImpl$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r2)     // Catch:{ all -> 0x0031 }
