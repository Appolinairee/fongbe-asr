    ...
    public final void collect(Exception exc) {
        ...
        if (this.collectedExceptions.size() < this.limit) {
            if (this.path != null) {
                ...
                Throwable m = FileVisitorImpl$$ExternalSyntheticApiModelOutline0.m(String.valueOf(this.path)).initCause(exc);
                Intrinsics.checkNotNull(m, "null cannot be cast to non-null type java.nio.file.FileSystemException");
                exc = FileVisitorImpl$$ExternalSyntheticApiModelOutline0.m((Object) m);
            }
