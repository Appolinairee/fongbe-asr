...
final class DirectoryEntriesReader extends SimpleFileVisitor<Path> {
    ...
    public final List<PathNode> readEntries(PathNode pathNode) {
        ...
        Path unused = Files.walkFileTree(pathNode.getPath(), LinkFollowing.INSTANCE.toVisitOptions(this.followLinks), 1, FileVisitorImpl$$ExternalSyntheticApiModelOutline0.m((Object) this));
