...
final class zzaev extends zzaex {
    ...
    private static Double zzg(zzdy zzdy) {
        return Double.valueOf(Double.longBitsToDouble(zzdy.zzt()));
    }
    ...
    private static String zzi(zzdy zzdy) {
        ...
        int zzd2 = zzdy.zzd();
        zzdy.zzM(zzq);
        return new String(zzdy.zzN(), zzd2, zzq);
    }
    ...
    public final boolean zzb(zzdy zzdy, long j) {
        if (zzdy.zzm() == 2 && "onMetaData".equals(zzi(zzdy)) && zzdy.zzb() != 0 && zzdy.zzm() == 8) {
    ...
    private static java.lang.Object zzh(com.google.android.gms.internal.ads.zzdy r4, int r5) {
        ...
        L_0x007a:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzaev.zzh(com.google.android.gms.internal.ads.zzdy, int):java.lang.Object");
    }
}
