...
public final class zzaap {
    ...
    static /* bridge */ /* synthetic */ void zzb(zzaap zzaap, Display display) {
        if (display != null) {
            long refreshRate = (long) (1.0E9d / ((double) display.getRefreshRate()));
            zzaap.zzk = refreshRate;
            zzaap.zzl = (refreshRate * 80) / 100;
            return;
        }
        zzdo.zzf("VideoFrameReleaseHelper", "Unable to query display refresh rate");
        zzaap.zzk = -9223372036854775807L;
        zzaap.zzl = -9223372036854775807L;
    }
    ...
    public final long zza(long j) {
        ...
        if (!(zzaao == null || this.zzk == -9223372036854775807L)) {
            long j4 = zzaao.zza;
    ...
    public zzaap(Context context) {
        ...
        if (context == null || (displayManager = (DisplayManager) context.getSystemService("display")) == null) {
            ...
            zzaan = new zzaan(this, displayManager);
        }
        this.zzb = zzaan;
        this.zzc = zzaan != null ? zzaao.zza() : zzaao;
