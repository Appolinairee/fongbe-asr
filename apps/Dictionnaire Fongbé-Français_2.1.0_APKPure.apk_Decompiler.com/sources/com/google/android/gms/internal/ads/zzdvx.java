...
public final class zzdvx extends zzfqz {
    ...
    public final void zza(SensorEvent sensorEvent) {
        if (((Boolean) zzbe.zzc().zza(zzbcl.zziR)).booleanValue()) {
            ...
            if (((float) Math.sqrt((double) ((f2 * f2) + (f3 * f3) + (f4 * f4)))) >= ((Float) zzbe.zzc().zza(zzbcl.zziS)).floatValue()) {
                long currentTimeMillis = zzv.zzC().currentTimeMillis();
                if (this.zzd + ((long) ((Integer) zzbe.zzc().zza(zzbcl.zziT)).intValue()) <= currentTimeMillis) {
                    if (this.zzd + ((long) ((Integer) zzbe.zzc().zza(zzbcl.zziU)).intValue()) < currentTimeMillis) {
                        this.zze = 0;
                    }
                    ...
                    int i = this.zze + 1;
                    this.zze = i;
                    zzdvw zzdvw = this.zzf;
                    if (zzdvw != null) {
                        if (i == ((Integer) zzbe.zzc().zza(zzbcl.zziV)).intValue()) {
                            zzduv zzduv = (zzduv) zzdvw;
                            zzduv.zzh(new zzdus(zzduv), zzduu.GESTURE);
                        }
                    }
                }
            }
    ...
    public final void zzc() {
        /*
            r6 = this;
            monitor-enter(r6)
            com.google.android.gms.internal.ads.zzbcc r0 = com.google.android.gms.internal.ads.zzbcl.zziR     // Catch:{ all -> 0x006a }
            com.google.android.gms.internal.ads.zzbcj r1 = com.google.android.gms.ads.internal.client.zzbe.zzc()     // Catch:{ all -> 0x006a }
        ...
        L_0x0015:
            ...
            com.google.android.gms.ads.internal.util.client.zzo.zzj(r0)     // Catch:{ all -> 0x006a }
            monitor-exit(r6)     // Catch:{ all -> 0x006a }
            return
        L_0x002f:
        ...
        L_0x0035:
            ...
            com.google.android.gms.internal.ads.zzbcc r0 = com.google.android.gms.internal.ads.zzbcl.zziT     // Catch:{ all -> 0x006a }
            com.google.android.gms.internal.ads.zzbcj r4 = com.google.android.gms.ads.internal.client.zzbe.zzc()     // Catch:{ all -> 0x006a }
        ...
        L_0x006a:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzdvx.zzc():void");
    }

    public final void zzd(zzdvw zzdvw) {
        this.zzf = zzdvw;
    }
}
