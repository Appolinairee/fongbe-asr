...
public final class zzdd implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public zzdd(Handler handler, zzdc zzdc) {
        this.zzb = handler;
    }
    ...
    public final void zzb(int i) throws zzde {
        ...
        zzdf.zza(eglGetDisplay != null, "eglGetDisplay failed");
        int[] iArr = new int[2];
        ...
        zzdf.zza(eglChooseConfig && iArr2[0] > 0 && eGLConfigArr[0] != null, String.format(Locale.US, "eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", new Object[]{Boolean.valueOf(eglChooseConfig), Integer.valueOf(iArr2[0]), eGLConfigArr[0]}));
        ...
        zzdf.zza(eglCreateContext != null, "eglCreateContext failed");
        ...
        if (i == 1) {
            ...
            zzdf.zza(eGLSurface != null, "eglCreatePbufferSurface failed");
        }
        zzdf.zza(EGL14.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, eglCreateContext), "eglMakeCurrent failed");
        this.zzf = eGLSurface;
