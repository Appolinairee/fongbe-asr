...
public final class zzfvc {
    ...
    public static zzfvc zzb(zzfty zzfty) {
        return new zzfvc(new zzfuu(zzfty));
    }

    public static zzfvc zzc(Pattern pattern) {
        zzfue zzfue = new zzfue(pattern);
        zzfun.zzi(!((zzfud) zzfue.zza("")).zza.matches(), "The pattern may not match the empty string: %s", zzfue);
        return new zzfvc(new zzfuw(zzfue));
    }
