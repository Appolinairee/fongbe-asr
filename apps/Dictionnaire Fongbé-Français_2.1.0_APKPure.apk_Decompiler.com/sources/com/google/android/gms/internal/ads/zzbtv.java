...
public final class zzbtv {
    ...
    public zzbtv(Context context, AdFormat adFormat, zzei zzei, String str) {
        this.zzb = context;
        this.zzc = adFormat;
        this.zzd = zzei;
        this.zze = str;
    ...
    public final void zzb(QueryInfoGenerationCallback queryInfoGenerationCallback) {
        ...
        try {
            zza2.zzf(wrap, new zzbyy(this.zze, this.zzc.name(), (zzs) null, zzm, 0, (String) null), new zzbtu(this, queryInfoGenerationCallback));
