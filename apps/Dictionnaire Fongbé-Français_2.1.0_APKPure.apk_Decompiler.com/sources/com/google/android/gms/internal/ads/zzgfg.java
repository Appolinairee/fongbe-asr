...
public final class zzgfg {
    ...
    /* synthetic */ zzgfg(zzgfj zzgfj) {
    }

    public final zzgfg zzb(zzgfh zzgfh) {
        this.zze = zzgfh;
        return this;
    }

    public final zzgfg zzf(zzgfi zzgfi) {
        this.zzf = zzgfi;
        return this;
    }
    ...
    public final zzgfk zzg() throws GeneralSecurityException {
        if (this.zza == null) {
            ...
            if (num == null) {
                ...
                return new zzgfk(this.zza.intValue(), this.zzb.intValue(), this.zzc.intValue(), this.zzd.intValue(), this.zzf, this.zze, (zzgfj) null);
            } else {
