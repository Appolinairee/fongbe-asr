...
final class zzfnp implements BaseGmsClient.BaseConnectionCallbacks, BaseGmsClient.BaseOnConnectionFailedListener {
    ...
    public zzfnp(Context context, String str, String str2) {
        ...
        handlerThread.start();
        zzfop zzfop = new zzfop(context, handlerThread.getLooper(), this, this, 9200000);
        this.zza = zzfop;
    ...
    public final void onConnected(android.os.Bundle r4) {
        /*
            r3 = this;
            com.google.android.gms.internal.ads.zzfou r4 = r3.zzd()
            if (r4 == 0) goto L_0x0039
            com.google.android.gms.internal.ads.zzfoq r0 = new com.google.android.gms.internal.ads.zzfoq     // Catch:{ all -> 0x0025 }
            java.lang.String r1 = r3.zzb     // Catch:{ all -> 0x0025 }
            java.lang.String r2 = r3.zzc     // Catch:{ all -> 0x0025 }
            r0.<init>(r1, r2)     // Catch:{ all -> 0x0025 }
            com.google.android.gms.internal.ads.zzfos r4 = r4.zze(r0)     // Catch:{ all -> 0x0025 }
            com.google.android.gms.internal.ads.zzasy r4 = r4.zza()     // Catch:{ all -> 0x0025 }
        ...
        L_0x0025:
            ...
            com.google.android.gms.internal.ads.zzasy r0 = zza()     // Catch:{ InterruptedException -> 0x001c, all -> 0x002f }
        ...
        L_0x0039:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzfnp.onConnected(android.os.Bundle):void");
    }
    ...
    public final zzasy zzb(int i) {
        zzasy zzasy;
        try {
            zzasy = (zzasy) this.zzd.poll(CoroutineLiveDataKt.DEFAULT_TIMEOUT, TimeUnit.MILLISECONDS);
        } catch (InterruptedException unused) {
            zzasy = null;
        }
        return zzasy == null ? zza() : zzasy;
    }
