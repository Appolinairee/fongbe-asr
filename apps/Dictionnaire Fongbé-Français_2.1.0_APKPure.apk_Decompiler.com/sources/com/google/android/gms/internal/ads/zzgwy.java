...
final class zzgwy extends zzgvv implements RandomAccess, zzgxu, zzgzl {
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzgwy.zzc, 0, this.zzc, this.zzd, zzgwy.zzd);
            this.zzd = i3;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        zzgwy zzgwy = (zzgwy) obj;
        if (this.zzd != zzgwy.zzd) {
            return false;
        }
        double[] dArr = zzgwy.zzc;
    ...
    public final zzgxu zzf(int i) {
        ...
        if (i >= this.zzd) {
            ...
            return new zzgwy(dArr, this.zzd, true);
        }
