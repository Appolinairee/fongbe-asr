...
final class zzgwl extends zzgwp {
    ...
    /* synthetic */ zzgwl(Iterable iterable, int i, boolean z, zzgwo zzgwo) {
        super((zzgwo) null);
        this.zzh = i;
        this.zze = iterable;
    ...
    private final void zzK(byte[] bArr, int i, int i2) throws IOException {
        if (i2 <= zzI()) {
            ...
            while (i3 > 0) {
                ...
                long j = (long) min;
                zzhao.zzo(this.zzm, bArr, (long) (i2 - i3), j);
                i3 -= min;
                this.zzm += j;
            }
        } else if (i2 > 0) {
    ...
    public final int zzi() throws IOException {
        ...
        if (j - j2 >= 4) {
            this.zzm = 4 + j2;
            return (zzhao.zza(j2) & 255) | ((zzhao.zza(1 + j2) & 255) << 8) | ((zzhao.zza(2 + j2) & 255) << Ascii.DLE) | ((zzhao.zza(j2 + 3) & 255) << Ascii.CAN);
        }
    ...
    public final long zzq() throws IOException {
        ...
        if (j - j2 >= 8) {
            this.zzm = 8 + j2;
            byte zza = zzhao.zza(j2 + 4);
            long zza2 = (((long) zzhao.zza(3 + j2)) & 255) << 24;
            byte zza3 = zzhao.zza(j2 + 6);
            return (((long) zzhao.zza(j2)) & 255) | ((((long) zzhao.zza(1 + j2)) & 255) << 8) | ((((long) zzhao.zza(j2 + 2)) & 255) << 16) | zza2 | ((((long) zza) & 255) << 32) | ((((long) zzhao.zza(5 + j2)) & 255) << 40) | ((((long) zza3) & 255) << 48) | ((((long) zzhao.zza(j2 + 7)) & 255) << 56);
        }
        long zzh2 = (((long) zzh()) & 255) << 32;
        long zzh3 = (((long) zzh()) & 255) << 40;
        return (((long) zzh()) & 255) | ((((long) zzh()) & 255) << 8) | ((((long) zzh()) & 255) << 16) | ((((long) zzh()) & 255) << 24) | zzh2 | zzh3 | ((((long) zzh()) & 255) << 48) | ((((long) zzh()) & 255) << 56);
    }
    ...
    public final String zzx() throws IOException {
        ...
        if (zzp > 0) {
            ...
            long j3 = (long) zzp;
            if (j3 <= j - j2) {
                String zzg2 = zzhat.zzg(this.zzg, (int) (j2 - this.zzn), zzp);
                this.zzm += j3;
                return zzg2;
            }
        }
    ...
    public final int zzp() throws IOException {
        ...
        if (this.zzo != j) {
            ...
            if (zza >= 0) {
                ...
                long j3 = 2 + j;
                byte zza2 = (zzhao.zza(j2) << 7) ^ zza;
                if (zza2 < 0) {
                    b = zza2 ^ Byte.MIN_VALUE;
                } else {
                    long j4 = 3 + j;
                    byte zza3 = (zzhao.zza(j3) << Ascii.SO) ^ zza2;
                    if (zza3 >= 0) {
                        b2 = zza3 ^ 16256;
                    } else {
                        long j5 = 4 + j;
                        byte zza4 = zza3 ^ (zzhao.zza(j4) << Ascii.NAK);
                        if (zza4 < 0) {
                            b = -2080896 ^ zza4;
                        } else {
                            j4 = 5 + j;
                            byte zza5 = zzhao.zza(j5);
    ...
    public final long zzr() throws IOException {
        ...
        if (this.zzo != j4) {
            long j5 = j4 + 1;
            byte zza = zzhao.zza(j4);
            if (zza >= 0) {
                this.zzm++;
                return (long) zza;
            } else if (this.zzo - this.zzm >= 10) {
                long j6 = 2 + j4;
                byte zza2 = (zzhao.zza(j5) << 7) ^ zza;
                if (zza2 < 0) {
                    j = (long) (zza2 ^ Byte.MIN_VALUE);
                } else {
                    long j7 = 3 + j4;
                    byte zza3 = (zzhao.zza(j6) << Ascii.SO) ^ zza2;
                    if (zza3 >= 0) {
                        j = (long) (zza3 ^ 16256);
                    } else {
                        long j8 = 4 + j4;
                        byte zza4 = zza3 ^ (zzhao.zza(j7) << Ascii.NAK);
                        if (zza4 < 0) {
                            j = (long) (-2080896 ^ zza4);
                            j6 = j8;
                        } else {
                            j7 = 5 + j4;
                            long zza5 = (((long) zzhao.zza(j8)) << 28) ^ ((long) zza4);
                            if (zza5 >= 0) {
                                j = 266354560 ^ zza5;
                            } else {
                                long j9 = 6 + j4;
                                long zza6 = zza5 ^ (((long) zzhao.zza(j7)) << 35);
                                if (zza6 < 0) {
                                    j3 = -34093383808L;
                                } else {
                                    long j10 = 7 + j4;
                                    long zza7 = zza6 ^ (((long) zzhao.zza(j9)) << 42);
                                    if (zza7 >= 0) {
                                        j2 = 4363953127296L ^ zza7;
                                    } else {
                                        j9 = 8 + j4;
                                        zza6 = zza7 ^ (((long) zzhao.zza(j10)) << 49);
                                        if (zza6 < 0) {
                                            j3 = -558586000294016L;
                                        } else {
                                            j10 = 9 + j4;
                                            long zza8 = (zza6 ^ (((long) zzhao.zza(j9)) << 56)) ^ 71499008037633920L;
                                            if (zza8 < 0) {
                                                long j11 = j4 + 10;
                                                if (((long) zzhao.zza(j10)) >= 0) {
                                                    long j12 = j11;
                                                    j = zza8;
                                                    j6 = j12;
                                                }
