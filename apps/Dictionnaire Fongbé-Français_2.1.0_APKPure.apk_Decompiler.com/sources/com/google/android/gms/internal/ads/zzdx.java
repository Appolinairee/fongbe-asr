...
public final class zzdx {
    ...
    public final long zze(int i) {
        if (i <= 32) {
            int zzd2 = zzd(i);
            int i2 = zzei.zza;
            return KeyboardMap.kValueMask & ((long) zzd2);
        }
        int zzd3 = zzd(i - 32);
        int zzd4 = zzd(32);
        int i3 = zzei.zza;
        return (KeyboardMap.kValueMask & ((long) zzd4)) | ((((long) zzd3) & KeyboardMap.kValueMask) << 32);
    }
    ...
    public final void zzj(zzdy zzdy) {
        zzk(zzdy.zzN(), zzdy.zze());
        zzl(zzdy.zzd() * 8);
    }
