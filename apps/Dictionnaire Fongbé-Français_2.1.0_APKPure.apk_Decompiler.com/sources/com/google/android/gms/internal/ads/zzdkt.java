...
public final class zzdkt {
    ...
    public zzdkt(zzbo zzbo, Clock clock, Executor executor) {
        this.zza = zzbo;
        this.zzb = clock;
        this.zzc = executor;
    }
    ...
    public final /* synthetic */ Bitmap zza(double d, boolean z, zzapi zzapi) {
        byte[] bArr = zzapi.zzb;
        ...
        if (((Boolean) zzbe.zzc().zza(zzbcl.zzfY)).booleanValue()) {
            ...
            if (i > 0) {
                options.inSampleSize = 1 << ((33 - Integer.numberOfLeadingZeros((i - 1) / ((Integer) zzbe.zzc().zza(zzbcl.zzfZ)).intValue())) / 2);
            }
        }
    ...
    public final ListenableFuture zzb(String str, double d, boolean z) {
        return zzgch.zzm(this.zza.zza(str), new zzdks(this, d, z), this.zzc);
    }
}
