...
final class zzcbp extends zzfqz {
    ...
    public final void zzb(zzcbo zzcbo) {
        this.zzh = zzcbo;
    }
    ...
    public final void zzc() {
        if (this.zzg == null) {
            ...
            handlerThread.start();
            zzfqw zzfqw = new zzfqw(handlerThread.getLooper());
            this.zzg = zzfqw;
            if (!this.zza.registerListener(this, defaultSensor, 0, zzfqw)) {
