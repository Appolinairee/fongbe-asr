...
final class zzgap extends AbstractList implements RandomAccess, Serializable {
    ...
    public final boolean equals(@CheckForNull Object obj) {
        ...
        zzgap zzgap = (zzgap) obj;
        int i = this.zzc - this.zzb;
        if (zzgap.zzc - zzgap.zzb != i) {
            return false;
        }
        for (int i2 = 0; i2 < i; i2++) {
            if (this.zza[this.zzb + i2] != zzgap.zza[zzgap.zzb + i2]) {
                return false;
            }
        }
        return true;
    ...
    public final int indexOf(@CheckForNull Object obj) {
        int zza2;
        if (!(obj instanceof Integer) || (zza2 = zzgaq.zza(this.zza, ((Integer) obj).intValue(), this.zzb, this.zzc)) < 0) {
            return -1;
        }
