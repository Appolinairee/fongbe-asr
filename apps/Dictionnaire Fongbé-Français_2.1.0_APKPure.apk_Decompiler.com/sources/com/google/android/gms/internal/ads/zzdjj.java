...
public final class zzdjj implements GestureDetector.OnGestureListener {
    ...
    public final synchronized boolean onFling(android.view.MotionEvent r7, android.view.MotionEvent r8, float r9, float r10) {
        /*
            r6 = this;
            monitor-enter(r6)
            com.google.android.gms.internal.ads.zzdia r0 = r6.zza     // Catch:{ all -> 0x007d }
            r1 = 0
        ...
        L_0x0065:
            r7 = 0
        L_0x0066:
            com.google.android.gms.internal.ads.zzdia r8 = r6.zza     // Catch:{ all -> 0x007d }
            int r8 = r8.zza()     // Catch:{ all -> 0x007d }
            if (r3 != r8) goto L_0x007b
            com.google.android.gms.internal.ads.zzdia r8 = r6.zza     // Catch:{ all -> 0x007d }
            com.google.android.gms.internal.ads.zzdjb r9 = r6.zzb     // Catch:{ all -> 0x007d }
            android.widget.FrameLayout r9 = r9.zzr()     // Catch:{ all -> 0x007d }
            r8.zzE(r9, r7)     // Catch:{ all -> 0x007d }
            monitor-exit(r6)
            return r1
        L_0x007b:
            monitor-exit(r6)
        ...
        L_0x007d:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzdjj.onFling(android.view.MotionEvent, android.view.MotionEvent, float, float):boolean");
    }
