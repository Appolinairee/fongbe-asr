...
public final class zzfiv {
    ...
    public zzfiv(zzegq zzegq, VersionInfoParcel versionInfoParcel, String str, String str2, Context context, zzfcb zzfcb, zzfcc zzfcc, Clock clock, zzava zzava) {
        this.zza = zzegq;
    ...
    public final List zzc(zzfca zzfca, zzfbo zzfbo, List list) {
        return zzd(zzfca, zzfbo, false, "", "", list);
    }

    public final List zzd(zzfca zzfca, zzfbo zzfbo, boolean z, String str, String str2, List list) {
        ArrayList arrayList = new ArrayList();
        Iterator it = list.iterator();
        while (it.hasNext()) {
            boolean z2 = true;
            String zzj = zzj(zzj(zzj((String) it.next(), "@gw_adlocid@", zzfca.zza.zza.zzf), "@gw_adnetrefresh@", true != z ? "0" : "1"), "@gw_sdkver@", this.zzb);
            if (zzfbo != null) {
                zzj = zzbyk.zzc(zzj(zzj(zzj(zzj, "@gw_qdata@", zzfbo.zzy), "@gw_adnetid@", zzfbo.zzx), "@gw_allocid@", zzfbo.zzw), this.zze, zzfbo.zzW, zzfbo.zzaw);
            }
            ...
            boolean z3 = false;
            if (((Boolean) zzbe.zzc().zza(zzbcl.zzdE)).booleanValue() && !TextUtils.isEmpty(str)) {
                z3 = true;
            }
