...
public final class zzgl extends zzfr implements zzgt {
    ...
    private final zzgs zzf = new zzgs();
    private zzgd zzg;
    ...
    /* synthetic */ zzgl(String str, int i, int i2, boolean z, boolean z2, zzgs zzgs, zzfuo zzfuo, boolean z3, zzgk zzgk) {
        super(true);
        this.zzd = str;
        this.zzb = i;
        this.zzc = i2;
    ...
    private final URL zzl(URL url, String str, zzgd zzgd) throws zzgp {
        if (str != null) {
            try {
                URL url2 = new URL(url, str);
                String protocol = url2.getProtocol();
                if (!ProxyConfig.MATCH_HTTPS.equals(protocol) && !ProxyConfig.MATCH_HTTP.equals(protocol)) {
                    throw new zzgp("Unsupported protocol redirect: ".concat(String.valueOf(protocol)), zzgd, 2001, 1);
                } else if (this.zza || protocol.equals(url.getProtocol())) {
                    return url2;
                } else {
                    String protocol2 = url.getProtocol();
                    throw new zzgp("Disallowed cross-protocol redirect (" + protocol2 + " to " + protocol + ")", zzgd, 2001, 1);
                }
            } catch (MalformedURLException e) {
                throw new zzgp((IOException) e, zzgd, 2001, 1);
            }
        } else {
            throw new zzgp("Null location redirect", zzgd, 2001, 1);
        }
    }
    ...
    public final long zzb(com.google.android.gms.internal.ads.zzgd r25) throws com.google.android.gms.internal.ads.zzgp {
        /*
            ...
            int r0 = r13.zzb     // Catch:{ IOException -> 0x01f5 }
            byte[] r0 = r13.zzc     // Catch:{ IOException -> 0x01f5 }
            long r9 = r13.zze     // Catch:{ IOException -> 0x01f5 }
            long r7 = r13.zzf     // Catch:{ IOException -> 0x01f5 }
            boolean r0 = r13.zzb(r11)     // Catch:{ IOException -> 0x01f5 }
            boolean r1 = r12.zza     // Catch:{ IOException -> 0x01f5 }
            r5 = 0
            if (r1 != 0) goto L_0x0041
            java.util.Map r6 = r13.zzd     // Catch:{ IOException -> 0x01f5 }
            r3 = 1
            r4 = 0
            r16 = 1
            r1 = r24
            ...
            r10 = r16
            r11 = r17
            java.net.HttpURLConnection r0 = r1.zzk(r2, r3, r4, r5, r7, r9, r10, r11)     // Catch:{ IOException -> 0x01f5 }
            goto L_0x008b
        L_0x0041:
            r11 = r2
            r5 = 0
        L_0x0043:
            ...
            java.util.Map r5 = r13.zzd     // Catch:{ IOException -> 0x01f5 }
            r3 = 1
            r4 = 0
            r16 = 0
            r1 = r24
            ...
            r23 = r11
            r11 = r17
            java.net.HttpURLConnection r1 = r1.zzk(r2, r3, r4, r5, r7, r9, r10, r11)     // Catch:{ IOException -> 0x01f5 }
        ...
        L_0x008a:
            r0 = r1
        L_0x008b:
            r12.zzh = r0     // Catch:{ IOException -> 0x01f5 }
            int r1 = r0.getResponseCode()     // Catch:{ IOException -> 0x01f5 }
            r12.zzk = r1     // Catch:{ IOException -> 0x01f5 }
        ...
        L_0x00ce:
            ...
            long r3 = com.google.android.gms.internal.ads.zzgu.zza(r3, r4)
        ...
        L_0x00e9:
            ...
            java.io.InputStream r0 = r0.getInputStream()     // Catch:{ IOException -> 0x015a }
            r12.zzi = r0     // Catch:{ IOException -> 0x015a }
            if (r1 == 0) goto L_0x00fc
            java.util.zip.GZIPInputStream r0 = new java.util.zip.GZIPInputStream     // Catch:{ IOException -> 0x015a }
            java.io.InputStream r1 = r12.zzi     // Catch:{ IOException -> 0x015a }
            r0.<init>(r1)     // Catch:{ IOException -> 0x015a }
            r12.zzi = r0     // Catch:{ IOException -> 0x015a }
        L_0x00fc:
            r5 = 1
            r12.zzj = r5
        ...
        L_0x0107:
            ...
            byte[] r0 = new byte[r0]     // Catch:{ IOException -> 0x0149 }
        L_0x010b:
            int r1 = (r8 > r14 ? 1 : (r8 == r14 ? 0 : -1))
            if (r1 <= 0) goto L_0x0146
            r6 = 4096(0x1000, double:2.0237E-320)
            long r6 = java.lang.Math.min(r8, r6)     // Catch:{ IOException -> 0x0149 }
            int r1 = (int) r6     // Catch:{ IOException -> 0x0149 }
            java.io.InputStream r4 = r12.zzi     // Catch:{ IOException -> 0x0149 }
            int r6 = com.google.android.gms.internal.ads.zzei.zza     // Catch:{ IOException -> 0x0149 }
            r6 = r4
            java.io.InputStream r6 = (java.io.InputStream) r6     // Catch:{ IOException -> 0x0149 }
            r6 = 0
            int r1 = r4.read(r0, r6, r1)     // Catch:{ IOException -> 0x0149 }
            java.lang.Thread r4 = java.lang.Thread.currentThread()     // Catch:{ IOException -> 0x0149 }
            boolean r4 = r4.isInterrupted()     // Catch:{ IOException -> 0x0149 }
            if (r4 != 0) goto L_0x013b
            r4 = -1
            if (r1 == r4) goto L_0x0135
            long r10 = (long) r1     // Catch:{ IOException -> 0x0149 }
            long r8 = r8 - r10
            r12.zzg(r1)     // Catch:{ IOException -> 0x0149 }
            goto L_0x010b
        L_0x0135:
            com.google.android.gms.internal.ads.zzgp r0 = new com.google.android.gms.internal.ads.zzgp     // Catch:{ IOException -> 0x0149 }
            r0.<init>(r13, r2, r5)     // Catch:{ IOException -> 0x0149 }
            throw r0     // Catch:{ IOException -> 0x0149 }
        L_0x013b:
            com.google.android.gms.internal.ads.zzgp r0 = new com.google.android.gms.internal.ads.zzgp     // Catch:{ IOException -> 0x0149 }
            java.io.InterruptedIOException r1 = new java.io.InterruptedIOException     // Catch:{ IOException -> 0x0149 }
            r1.<init>()     // Catch:{ IOException -> 0x0149 }
            r0.<init>((java.io.IOException) r1, (com.google.android.gms.internal.ads.zzgd) r13, (int) r3, (int) r5)     // Catch:{ IOException -> 0x0149 }
            throw r0     // Catch:{ IOException -> 0x0149 }
        L_0x0146:
            long r0 = r12.zzl
            return r0
        L_0x0149:
            r0 = move-exception
            r24.zzm()
            boolean r1 = r0 instanceof com.google.android.gms.internal.ads.zzgp
            if (r1 == 0) goto L_0x0154
            com.google.android.gms.internal.ads.zzgp r0 = (com.google.android.gms.internal.ads.zzgp) r0
            throw r0
        L_0x0154:
            com.google.android.gms.internal.ads.zzgp r1 = new com.google.android.gms.internal.ads.zzgp
            r1.<init>((java.io.IOException) r0, (com.google.android.gms.internal.ads.zzgd) r13, (int) r3, (int) r5)
            throw r1
        L_0x015a:
            r0 = move-exception
            r5 = 1
        ...
        L_0x0165:
            ...
            long r10 = com.google.android.gms.internal.ads.zzgu.zzb(r1)
            r4 = r3
            long r2 = r13.zze
        ...
        L_0x018d:
            ...
            byte[] r0 = com.google.android.gms.internal.ads.zzgad.zzb(r0)     // Catch:{ IOException -> 0x019c }
            goto L_0x019a
        L_0x0198:
            byte[] r0 = com.google.android.gms.internal.ads.zzei.zzf     // Catch:{ IOException -> 0x019c }
        L_0x019a:
            r7 = r0
            goto L_0x019f
        L_0x019c:
            byte[] r0 = com.google.android.gms.internal.ads.zzei.zzf
            goto L_0x019a
        L_0x019f:
            r24.zzm()
            int r0 = r12.zzk
        ...
        L_0x01ae:
            r0 = 0
        L_0x01af:
            com.google.android.gms.internal.ads.zzgr r9 = new com.google.android.gms.internal.ads.zzgr
            int r2 = r12.zzk
            r1 = r9
            r3 = r4
            r4 = r0
        ...
        L_0x01d0:
            r18 = r6
            r5 = 1
            com.google.android.gms.internal.ads.zzgp r0 = new com.google.android.gms.internal.ads.zzgp     // Catch:{ IOException -> 0x01f3 }
            ...
            r2.<init>()     // Catch:{ IOException -> 0x01f3 }
            ...
            r0.<init>((java.io.IOException) r1, (com.google.android.gms.internal.ads.zzgd) r13, (int) r2, (int) r5)     // Catch:{ IOException -> 0x01f3 }
        ...
        L_0x01f7:
            r24.zzm()
            com.google.android.gms.internal.ads.zzgp r0 = com.google.android.gms.internal.ads.zzgp.zza(r0, r13, r5)
            throw r0
        */
