...
public final class zzbsc extends zzbsi {
    ...
    public zzbsc(zzcex zzcex, zzbsj zzbsj) {
        super(zzcex, "resize");
        this.zzj = zzcex;
        this.zzk = zzcex.zzi();
        this.zzo = zzbsj;
        ...
        synchronized (this.zzi) {
            if (this.zzp != null) {
                if (!((Boolean) zzbe.zzc().zza(zzbcl.zzkH)).booleanValue() || Looper.getMainLooper().getThread() == Thread.currentThread()) {
                    ...
                    zzbzw.zzf.zza(new zzbsa(this, z));
                }
            }
        }
    }
    ...
    public final void zzb(java.util.Map r19) {
        /*
            ...
            monitor-enter(r3)
            android.app.Activity r4 = r1.zzk     // Catch:{ all -> 0x047e }
            ...
            return
        L_0x0014:
            com.google.android.gms.internal.ads.zzcex r4 = r1.zzj     // Catch:{ all -> 0x047e }
            com.google.android.gms.internal.ads.zzcgr r4 = r4.zzO()     // Catch:{ all -> 0x047e }
        ...
        L_0x0045:
            ...
            com.google.android.gms.ads.internal.zzv.zzq()     // Catch:{ all -> 0x047e }
            java.lang.String r4 = "width"
            java.lang.Object r4 = r0.get(r4)     // Catch:{ all -> 0x047e }
            java.lang.String r4 = (java.lang.String) r4     // Catch:{ all -> 0x047e }
            int r4 = com.google.android.gms.ads.internal.util.zzs.zzO(r4)     // Catch:{ all -> 0x047e }
        ...
        L_0x00dd:
            ...
            r1.zza = r0     // Catch:{ all -> 0x047e }
        L_0x00ed:
            int r0 = r1.zzh     // Catch:{ all -> 0x047e }
            if (r0 < 0) goto L_0x0477
            int r0 = r1.zze     // Catch:{ all -> 0x047e }
            if (r0 < 0) goto L_0x0477
            android.app.Activity r0 = r1.zzk     // Catch:{ all -> 0x047e }
        ...
        L_0x0105:
            com.google.android.gms.ads.internal.zzv.zzq()     // Catch:{ all -> 0x047e }
            android.app.Activity r4 = r1.zzk     // Catch:{ all -> 0x047e }
            int[] r4 = com.google.android.gms.ads.internal.util.zzs.zzV(r4)     // Catch:{ all -> 0x047e }
            com.google.android.gms.ads.internal.zzv.zzq()     // Catch:{ all -> 0x047e }
            android.app.Activity r5 = r1.zzk     // Catch:{ all -> 0x047e }
            int[] r5 = com.google.android.gms.ads.internal.util.zzs.zzR(r5)     // Catch:{ all -> 0x047e }
            r6 = 0
            ...
            goto L_0x025b
        L_0x012d:
            int r14 = r1.zze     // Catch:{ all -> 0x047e }
        ...
        L_0x0135:
            ...
            com.google.android.gms.ads.internal.util.client.zzo.zzj(r4)     // Catch:{ all -> 0x047e }
            goto L_0x0260
        L_0x0140:
            boolean r4 = r1.zzb     // Catch:{ all -> 0x047e }
            if (r4 == 0) goto L_0x0212
            java.lang.String r4 = r1.zza     // Catch:{ all -> 0x047e }
        ...
        L_0x018b:
            ...
            int r4 = r1.zzc     // Catch:{ all -> 0x047e }
        ...
        L_0x01ad:
            ...
            int r6 = r1.zzd     // Catch:{ all -> 0x047e }
        L_0x01b8:
            int r9 = r1.zzg     // Catch:{ all -> 0x047e }
            goto L_0x01c3
        L_0x01bb:
            int r4 = r1.zzc     // Catch:{ all -> 0x047e }
            int r6 = r1.zzf     // Catch:{ all -> 0x047e }
        ...
        L_0x0203:
            ...
            int r4 = r4 + r5
            int r5 = r1.zzd     // Catch:{ all -> 0x047e }
        ...
        L_0x0212:
            ...
            int r6 = r1.zzc     // Catch:{ all -> 0x047e }
            int r7 = r1.zzf     // Catch:{ all -> 0x047e }
            int r6 = r6 + r7
            int r7 = r1.zzd     // Catch:{ all -> 0x047e }
            int r9 = r1.zzg     // Catch:{ all -> 0x047e }
            int r7 = r7 + r9
        ...
        L_0x0260:
            ...
            return
        L_0x0269:
            com.google.android.gms.ads.internal.client.zzbc.zzb()     // Catch:{ all -> 0x047e }
            android.app.Activity r4 = r1.zzk     // Catch:{ all -> 0x047e }
            int r5 = r1.zzh     // Catch:{ all -> 0x047e }
            int r4 = com.google.android.gms.ads.internal.util.client.zzf.zzx(r4, r5)     // Catch:{ all -> 0x047e }
            com.google.android.gms.ads.internal.client.zzbc.zzb()     // Catch:{ all -> 0x047e }
            android.app.Activity r5 = r1.zzk     // Catch:{ all -> 0x047e }
            int r6 = r1.zze     // Catch:{ all -> 0x047e }
            int r5 = com.google.android.gms.ads.internal.util.client.zzf.zzx(r5, r6)     // Catch:{ all -> 0x047e }
            com.google.android.gms.internal.ads.zzcex r6 = r1.zzj     // Catch:{ all -> 0x047e }
            ...
            com.google.android.gms.internal.ads.zzcex r7 = r1.zzj     // Catch:{ all -> 0x047e }
            android.view.View r7 = (android.view.View) r7     // Catch:{ all -> 0x047e }
            r6.removeView(r7)     // Catch:{ all -> 0x047e }
            android.widget.PopupWindow r7 = r1.zzp     // Catch:{ all -> 0x047e }
            ...
            android.app.Activity r9 = r1.zzk     // Catch:{ all -> 0x047e }
            r6.<init>(r9)     // Catch:{ all -> 0x047e }
            r1.zzm = r6     // Catch:{ all -> 0x047e }
            r6.setImageBitmap(r7)     // Catch:{ all -> 0x047e }
            com.google.android.gms.internal.ads.zzcex r6 = r1.zzj     // Catch:{ all -> 0x047e }
            com.google.android.gms.internal.ads.zzcgr r6 = r6.zzO()     // Catch:{ all -> 0x047e }
            r1.zzl = r6     // Catch:{ all -> 0x047e }
            android.view.ViewGroup r6 = r1.zzr     // Catch:{ all -> 0x047e }
            android.widget.ImageView r7 = r1.zzm     // Catch:{ all -> 0x047e }
        ...
        L_0x02d7:
            ...
            android.app.Activity r7 = r1.zzk     // Catch:{ all -> 0x047e }
            r6.<init>(r7)     // Catch:{ all -> 0x047e }
            r1.zzq = r6     // Catch:{ all -> 0x047e }
            r7 = 0
            r6.setBackgroundColor(r7)     // Catch:{ all -> 0x047e }
            android.widget.RelativeLayout r6 = r1.zzq     // Catch:{ all -> 0x047e }
            ...
            r1.zzp = r7     // Catch:{ all -> 0x047e }
            r7.setOutsideTouchable(r9)     // Catch:{ all -> 0x047e }
            android.widget.PopupWindow r6 = r1.zzp     // Catch:{ all -> 0x047e }
            r6.setTouchable(r8)     // Catch:{ all -> 0x047e }
            android.widget.PopupWindow r6 = r1.zzp     // Catch:{ all -> 0x047e }
            boolean r7 = r1.zzb     // Catch:{ all -> 0x047e }
            r7 = r7 ^ r8
            ...
            com.google.android.gms.ads.internal.client.zzbc.zzb()     // Catch:{ all -> 0x047e }
            android.app.Activity r7 = r1.zzk     // Catch:{ all -> 0x047e }
            int r7 = com.google.android.gms.ads.internal.util.client.zzf.zzx(r7, r15)     // Catch:{ all -> 0x047e }
            com.google.android.gms.ads.internal.client.zzbc.zzb()     // Catch:{ all -> 0x047e }
            android.app.Activity r14 = r1.zzk     // Catch:{ all -> 0x047e }
            int r14 = com.google.android.gms.ads.internal.util.client.zzf.zzx(r14, r15)     // Catch:{ all -> 0x047e }
            r6.<init>(r7, r14)     // Catch:{ all -> 0x047e }
            java.lang.String r7 = r1.zza     // Catch:{ all -> 0x047e }
        ...
        L_0x03bb:
            ...
            r6.addRule(r7)     // Catch:{ all -> 0x047e }
        L_0x03c1:
            android.widget.LinearLayout r7 = r1.zzn     // Catch:{ all -> 0x047e }
            com.google.android.gms.internal.ads.zzbsb r9 = new com.google.android.gms.internal.ads.zzbsb     // Catch:{ all -> 0x047e }
            ...
            android.widget.RelativeLayout r7 = r1.zzq     // Catch:{ all -> 0x047e }
            android.widget.LinearLayout r9 = r1.zzn     // Catch:{ all -> 0x047e }
            r7.addView(r9, r6)     // Catch:{ all -> 0x047e }
            android.widget.PopupWindow r6 = r1.zzp     // Catch:{ RuntimeException -> 0x0431 }
            android.view.View r0 = r0.getDecorView()     // Catch:{ RuntimeException -> 0x0431 }
            com.google.android.gms.ads.internal.client.zzbc.zzb()     // Catch:{ RuntimeException -> 0x0431 }
            android.app.Activity r7 = r1.zzk     // Catch:{ RuntimeException -> 0x0431 }
            r9 = 0
            r10 = r16[r9]     // Catch:{ RuntimeException -> 0x0431 }
            int r7 = com.google.android.gms.ads.internal.util.client.zzf.zzx(r7, r10)     // Catch:{ RuntimeException -> 0x0431 }
            com.google.android.gms.ads.internal.client.zzbc.zzb()     // Catch:{ RuntimeException -> 0x0431 }
            android.app.Activity r9 = r1.zzk     // Catch:{ RuntimeException -> 0x0431 }
            r10 = r16[r8]     // Catch:{ RuntimeException -> 0x0431 }
            int r9 = com.google.android.gms.ads.internal.util.client.zzf.zzx(r9, r10)     // Catch:{ RuntimeException -> 0x0431 }
            r10 = 0
            r6.showAtLocation(r0, r10, r7, r9)     // Catch:{ RuntimeException -> 0x0431 }
            r0 = r16[r10]     // Catch:{ all -> 0x047e }
            r2 = r16[r8]     // Catch:{ all -> 0x047e }
            com.google.android.gms.internal.ads.zzbsj r6 = r1.zzo     // Catch:{ all -> 0x047e }
            if (r6 == 0) goto L_0x0409
            int r7 = r1.zzh     // Catch:{ all -> 0x047e }
            int r9 = r1.zze     // Catch:{ all -> 0x047e }
            r6.zza(r0, r2, r7, r9)     // Catch:{ all -> 0x047e }
        L_0x0409:
            com.google.android.gms.internal.ads.zzcex r0 = r1.zzj     // Catch:{ all -> 0x047e }
            com.google.android.gms.internal.ads.zzcgr r2 = com.google.android.gms.internal.ads.zzcgr.zzb(r4, r5)     // Catch:{ all -> 0x047e }
        ...
        L_0x0431:
            ...
            r1.zzh(r0)     // Catch:{ all -> 0x047e }
            android.widget.RelativeLayout r0 = r1.zzq     // Catch:{ all -> 0x047e }
            com.google.android.gms.internal.ads.zzcex r2 = r1.zzj     // Catch:{ all -> 0x047e }
            android.view.View r2 = (android.view.View) r2     // Catch:{ all -> 0x047e }
            r0.removeView(r2)     // Catch:{ all -> 0x047e }
            android.view.ViewGroup r0 = r1.zzr     // Catch:{ all -> 0x047e }
            if (r0 == 0) goto L_0x0467
            android.widget.ImageView r2 = r1.zzm     // Catch:{ all -> 0x047e }
            r0.removeView(r2)     // Catch:{ all -> 0x047e }
            android.view.ViewGroup r0 = r1.zzr     // Catch:{ all -> 0x047e }
            com.google.android.gms.internal.ads.zzcex r2 = r1.zzj     // Catch:{ all -> 0x047e }
            android.view.View r2 = (android.view.View) r2     // Catch:{ all -> 0x047e }
            ...
            com.google.android.gms.internal.ads.zzcex r0 = r1.zzj     // Catch:{ all -> 0x047e }
            com.google.android.gms.internal.ads.zzcgr r2 = r1.zzl     // Catch:{ all -> 0x047e }
            r0.zzaj(r2)     // Catch:{ all -> 0x047e }
        L_0x0467:
            monitor-exit(r3)     // Catch:{ all -> 0x047e }
            return
