                ...
                try {
                    ...
                    if (signatureArr == null || (r0 = signatureArr.length) == 0) {
                        ...
                        for (Signature byteArray : signatureArr) {
                            String zza2 = zzftp.zza(byteArray.toByteArray());
                            arrayList.add(zza2);
                        ...
                        zzfto.zzd(String.format("Play Store package certs are not valid. Found these sha256 certs: [%s].", new Object[]{sb.toString()}), new Object[0]);
                    }
