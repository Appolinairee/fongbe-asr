...
final class zzcei extends zzfr implements zzgt {
    ...
    private final zzgs zze = new zzgs();
    private zzgd zzf;
    ...
    zzcei(String str, zzgy zzgy, int i, int i2, long j, long j2) {
        super(true);
        zzcw.zzc(str);
        this.zzd = str;
        this.zzb = i;
    ...
    public final long zzb(zzgd zzgd) throws zzgp {
        long j;
        this.zzf = zzgd;
        this.zzm = 0;
        long j2 = zzgd.zze;
        ...
        throw new zzceg(headerField, zzgd);
    }
    ...
    public final HttpURLConnection zzk(long j, long j2, int i) throws zzgp {
        ...
        try {
            ...
            try {
                ...
                zzgd zzgd = this.zzf;
                throw new zzgp("Unable to connect to ".concat(valueOf), e2, zzgd, 2000, i);
            }
        } catch (IOException e3) {
            IOException iOException = e3;
            String valueOf2 = String.valueOf(uri);
            throw new zzgp("Unable to connect to ".concat(valueOf2), iOException, this.zzf, 2000, i);
        }
    }
}
