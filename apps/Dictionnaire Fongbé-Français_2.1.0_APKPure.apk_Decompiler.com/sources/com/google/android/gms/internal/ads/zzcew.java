...
public final class zzcew extends WebChromeClient {
    ...
    private static final Context zzb(WebView webView) {
        ...
        Activity zzi = zzcex.zzi();
        if (zzi != null) {
            return zzi;
        }
        return zzcex.getContext();
    }
    ...
    public final void onGeolocationPermissionsShowPrompt(String str, GeolocationPermissions.Callback callback) {
        ...
        if (callback != null) {
            ...
            zzv.zzq();
            if (!zzs.zzB(zzcex.getContext(), "android.permission.ACCESS_FINE_LOCATION")) {
                zzcex zzcex2 = this.zza;
                zzv.zzq();
                if (!zzs.zzB(zzcex2.getContext(), "android.permission.ACCESS_COARSE_LOCATION")) {
                    z = false;
    ...
    public final boolean zza(Context context, String str, String str2, String str3, String str4, JsResult jsResult, JsPromptResult jsPromptResult, boolean z) {
        ...
        try {
            zzcex zzcex = this.zza;
            if (zzcex == null || zzcex.zzN() == null || this.zza.zzN().zzd() == null || (zzd = this.zza.zzN().zzd()) == null || zzd.zzc()) {
                zzv.zzq();
                ...
                if (z) {
                    ...
                    zzL.setView(linearLayout).setPositiveButton(17039370, new zzceu(jsPromptResult, editText)).setNegativeButton(17039360, new zzcet(jsPromptResult)).setOnCancelListener(new zzces(jsPromptResult)).create().show();
                } else {
                    zzL.setMessage(str3).setPositiveButton(17039370, new zzcer(jsResult)).setNegativeButton(17039360, new zzceq(jsResult)).setOnCancelListener(new zzcep(jsResult)).create().show();
                }
                return true;
            }
