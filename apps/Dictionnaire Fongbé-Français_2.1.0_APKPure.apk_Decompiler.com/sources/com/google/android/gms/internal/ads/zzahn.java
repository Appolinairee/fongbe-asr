...
final class zzahn {
    ...
    private final long zzb(zzaco zzaco) throws IOException {
        int i;
        zzacc zzacc = (zzacc) zzaco;
        int i2 = 0;
        zzacc.zzm(this.zza.zzN(), 0, 1, false);
        ...
        int i5 = b & (~i3);
        zzacc.zzm(this.zza.zzN(), 1, i4, false);
        while (i2 < i4) {
            i2++;
    ...
    public final boolean zza(zzaco zzaco) throws IOException {
        long zzb2;
        int i;
        long zzd = zzaco.zzd();
        long j = 1024;
        ...
        if (zzb3 != Long.MIN_VALUE) {
            ...
            if (i2 == 0 || j3 < zzd) {
                while (true) {
                    ...
                    if (i5 < 0) {
                        if (zzb(zzaco) == Long.MIN_VALUE || zzb2 < 0) {
                            return false;
                        }
                        if (i != 0) {
                            int zzb4 = (int) (zzb2 = zzb(zzaco));
                            zzacc.zzl(zzb4, false);
                            this.zzb += zzb4;
                        }
                    } else if (i5 == 0) {
                        return true;
