...
public final class zzazt {
    ...
    public static void zzc(String[] strArr, int i, int i2, PriorityQueue priorityQueue) {
        ...
        while (true) {
            ...
            if (i3 < length2 - 5) {
                ...
                zze = ((((((zze + 1073807359) - ((zza(16785407, 5) * ((((long) zzazp.zza(strArr2[i3 - 1])) + 2147483647L) % 1073807359)) % 1073807359)) % 1073807359) * 16785407) % 1073807359) + ((((long) zzazp.zza(strArr2[i3 + 5])) + 2147483647L) % 1073807359)) % 1073807359;
    ...
    static void zzd(int i, long j, String str, int i2, PriorityQueue priorityQueue) {
        zzazs zzazs = new zzazs(j, str, i2);
        if ((priorityQueue.size() != i || (((zzazs) priorityQueue.peek()).zzc <= zzazs.zzc && ((zzazs) priorityQueue.peek()).zza <= zzazs.zza)) && !priorityQueue.contains(zzazs)) {
            priorityQueue.add(zzazs);
    ...
    private static long zze(String[] strArr, int i, int i2) {
        long zza = (((long) zzazp.zza(strArr[0])) + 2147483647L) % 1073807359;
        for (int i3 = 1; i3 < i2; i3++) {
            zza = (((zza * 16785407) % 1073807359) + ((((long) zzazp.zza(strArr[i3])) + 2147483647L) % 1073807359)) % 1073807359;
        }
        return zza;
    }
}
