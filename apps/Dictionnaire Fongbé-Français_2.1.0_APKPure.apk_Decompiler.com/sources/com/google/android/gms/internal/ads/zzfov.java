...
final class zzfov implements zzfnl {
    ...
    zzfov(Object obj, zzfow zzfow, zzfph zzfph, zzfni zzfni) {
        this.zza = obj;
        this.zzb = zzfow;
        this.zzc = zzfph;
        this.zzd = zzfni;
    ...
    private static String zzi(byte[] bArr) {
        ...
        zza2.zzc(5);
        zza2.zza(zzgwj.zzv(bArr, 0, bArr.length));
        return Base64.encodeToString(((zzatn) zza2.zzbr()).zzaV(), 11);
    }
    ...
    public final synchronized void zzd(String str, MotionEvent motionEvent) throws zzfpf {
        try {
            ...
            throw new zzfpf(2005, (Throwable) e);
        }
    }
    ...
    public final synchronized int zze() throws zzfpf {
        try {
            ...
            throw new zzfpf(2006, (Throwable) e);
        }
    ...
    public final synchronized void zzg() throws zzfpf {
        try {
            ...
            throw new zzfpf(2003, (Throwable) e);
        }
    }

    /* access modifiers changed from: package-private */
    public final synchronized boolean zzh() throws zzfpf {
        try {
        } catch (Exception e) {
            throw new zzfpf(2001, (Throwable) e);
        }
