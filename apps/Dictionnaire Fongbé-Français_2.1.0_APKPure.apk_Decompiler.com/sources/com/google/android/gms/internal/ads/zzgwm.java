...
final class zzgwm extends zzgwp {
    ...
    /* synthetic */ zzgwm(InputStream inputStream, int i, zzgwo zzgwo) {
        super((zzgwo) null);
        byte[] bArr = zzgye.zzb;
    ...
    public final zzgwj zzv() throws IOException {
        ...
        int i2 = this.zzi;
        if (zzi2 <= i - i2 && zzi2 > 0) {
            zzgwj zzv = zzgwj.zzv(this.zzf, i2, zzi2);
            this.zzi += zzi2;
            return zzv;
        } else if (zzi2 == 0) {
            return zzgwj.zzb;
    ...
    public final String zzw() throws IOException {
        ...
        if (zzi2 > 0) {
            ...
            int i2 = this.zzi;
            if (zzi2 <= i - i2) {
                String str = new String(this.zzf, i2, zzi2, zzgye.zza);
                this.zzi += zzi2;
                return str;
            }
        }
        ...
        if (zzi2 < 0) {
            ...
            return new String(zzM(zzi2, false), zzgye.zza);
        } else {
            zzK(zzi2);
            String str2 = new String(this.zzf, this.zzi, zzi2, zzgye.zza);
            this.zzi += zzi2;
            return str2;
        }
    }
