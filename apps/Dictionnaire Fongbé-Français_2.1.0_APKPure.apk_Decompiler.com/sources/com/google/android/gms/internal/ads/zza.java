...
public final class zza {
    ...
    public zza(long j) {
        this(0, -1, -1, new int[0], new zzar[0], new long[0], 0, false);
    }
    ...
    public final zza zzb(int i) {
        ...
        return new zza(0, 0, -1, copyOf, (zzar[]) Arrays.copyOf(this.zzd, 0), copyOf2, 0, false);
    }

    private zza(long j, int i, int i2, int[] iArr, zzar[] zzarArr, long[] jArr, long j2, boolean z) {
        Uri uri;
        int length = iArr.length;
        int length2 = zzarArr.length;
        int i3 = 0;
