...
final class zzhat {
    private static final zzhaq zza = new zzhar();
    ...
    static int zzd(java.lang.String r8, byte[] r9, int r10, int r11) {
        ...
        L_0x00bd:
            r1 = r4
        L_0x00be:
            com.google.android.gms.internal.ads.zzhas r8 = new com.google.android.gms.internal.ads.zzhas
            int r1 = r1 + -1
            r8.<init>(r1, r0)
            throw r8
        L_0x00c6:
    ...
    static String zzg(ByteBuffer byteBuffer, int i, int i2) throws zzgyg {
        zzhaq zzhaq = zza;
        if (byteBuffer.hasArray()) {
            return zzhaq.zzb(byteBuffer.array(), byteBuffer.arrayOffset() + i, i2);
        } else if (byteBuffer.isDirect()) {
            return zzhar.zzc(byteBuffer, i, i2);
        } else {
            return zzhaq.zzc(byteBuffer, i, i2);
        }
    }

    static String zzh(byte[] bArr, int i, int i2) throws zzgyg {
