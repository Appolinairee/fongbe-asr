...
public final class zzhek {
    ...
    public final boolean equals(Object obj) {
        ...
        zzhek zzhek = (zzhek) obj;
        return Double.compare(zzhek.zzh, this.zzh) == 0 && Double.compare(zzhek.zzi, this.zzi) == 0 && Double.compare(zzhek.zzj, this.zzj) == 0 && Double.compare(zzhek.zzk, this.zzk) == 0 && Double.compare(zzhek.zzl, this.zzl) == 0 && Double.compare(zzhek.zzm, this.zzm) == 0 && Double.compare(zzhek.zze, this.zze) == 0 && Double.compare(zzhek.zzf, this.zzf) == 0 && Double.compare(zzhek.zzg, this.zzg) == 0;
    }
