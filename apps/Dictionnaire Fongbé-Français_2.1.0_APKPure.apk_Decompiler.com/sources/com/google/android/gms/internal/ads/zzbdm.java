...
public final class zzbdm {
    ...
    public final void zzb(Activity activity) {
        String zza2;
        if (this.zzb == null && (zza2 = zzhfk.zza(activity)) != null) {
            zzhfl zzhfl = new zzhfl(this);
            this.zzc = zzhfl;
            CustomTabsClient.bindCustomTabsService(activity, zza2, zzhfl);
        }
    }
    ...
    public final void zze(zzbdl zzbdl) {
        this.zzd = zzbdl;
    }
