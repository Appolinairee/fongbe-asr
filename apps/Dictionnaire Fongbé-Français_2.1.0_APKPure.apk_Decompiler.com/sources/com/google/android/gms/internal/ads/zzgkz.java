...
public final class zzgkz {
    ...
    private final synchronized void zzh(zzgdy zzgdy, boolean z, boolean z2) throws GeneralSecurityException {
        String str = ((zzgli) zzgdy).zza;
        if (this.zzd.containsKey(str)) {
            if (!((Boolean) this.zzd.get(str)).booleanValue()) {
                throw new GeneralSecurityException("New keys are already disallowed for key type ".concat(str));
            }
        }
        zzgdy zzgdy2 = (zzgdy) this.zzc.get(str);
        if (zzgdy2 != null) {
            if (!zzgdy2.getClass().equals(zzgdy.getClass())) {
                ...
                throw new GeneralSecurityException(String.format("typeUrl (%s) is already registered with %s, cannot be re-registered with %s", new Object[]{str, zzgdy2.getClass().getName(), zzgdy.getClass().getName()}));
            }
        }
        this.zzc.putIfAbsent(str, zzgdy);
    ...
    public final synchronized void zzd(zzgdy zzgdy, boolean z) throws GeneralSecurityException {
        zzf(zzgdy, 1, true);
    }
    ...
    public final synchronized void zzf(zzgdy zzgdy, int i, boolean z) throws GeneralSecurityException {
        if (zzgks.zza(i)) {
            zzh(zzgdy, false, true);
        } else {
