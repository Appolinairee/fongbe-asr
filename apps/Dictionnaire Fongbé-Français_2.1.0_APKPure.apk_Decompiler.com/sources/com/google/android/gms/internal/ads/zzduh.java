...
public final class zzduh extends zzfqz {
    ...
    public final void zza(SensorEvent sensorEvent) {
        if (((Boolean) zzbe.zzc().zza(zzbcl.zziW)).booleanValue()) {
            ...
            if (this.zze + ((long) ((Integer) zzbe.zzc().zza(zzbcl.zziY)).intValue()) < currentTimeMillis) {
                this.zzf = 0;
            ...
            this.zzd = valueOf;
            if (valueOf.floatValue() > this.zzc + ((Float) zzbe.zzc().zza(zzbcl.zziX)).floatValue()) {
                this.zzc = this.zzd.floatValue();
                this.zzh = true;
            } else {
                if (this.zzd.floatValue() < this.zzc - ((Float) zzbe.zzc().zza(zzbcl.zziX)).floatValue()) {
                    this.zzc = this.zzd.floatValue();
                    this.zzg = true;
                }
            }
            ...
            if (this.zzg && this.zzh) {
                ...
                this.zzg = false;
                this.zzh = false;
                zzdug zzdug = this.zzi;
                if (zzdug != null) {
                    if (i == ((Integer) zzbe.zzc().zza(zzbcl.zziZ)).intValue()) {
                        zzduv zzduv = (zzduv) zzdug;
                        zzduv.zzh(new zzdut(zzduv), zzduu.GESTURE);
                    }
                }
            }
        }
    ...
    public final void zzc() {
        /*
            r3 = this;
            monitor-enter(r3)
            com.google.android.gms.internal.ads.zzbcc r0 = com.google.android.gms.internal.ads.zzbcl.zziW     // Catch:{ all -> 0x003e }
            com.google.android.gms.internal.ads.zzbcj r1 = com.google.android.gms.ads.internal.client.zzbe.zzc()     // Catch:{ all -> 0x003e }
        ...
        L_0x003e:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzduh.zzc():void");
    }

    public final void zzd(zzdug zzdug) {
        this.zzi = zzdug;
    }
}
