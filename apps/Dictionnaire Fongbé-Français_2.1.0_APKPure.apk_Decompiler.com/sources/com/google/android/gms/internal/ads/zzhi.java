...
public abstract class zzhi extends zzbq {
    ...
    public zzhi(boolean z, zzwb zzwb) {
        this.zzc = zzwb;
        this.zzb = zzwb.zzc();
    }
    ...
    public final zzbo zzd(int i, zzbo zzbo, boolean z) {
        int zzq = zzq(i);
        int zzt = zzt(zzq);
        zzu(zzq).zzd(i - zzs(zzq), zzbo, z);
        zzbo.zzc += zzt;
        if (z) {
            Object zzv = zzv(zzq);
            Object obj = zzbo.zzb;
            obj.getClass();
            zzbo.zzb = Pair.create(zzv, obj);
        }
        return zzbo;
    }
    ...
    public final zzbp zze(int i, zzbp zzbp, long j) {
        ...
        int zzt = zzt(zzr);
        int zzs = zzs(zzr);
        zzu(zzr).zze(i - zzt, zzbp, j);
        Object zzv = zzv(zzr);
        if (!zzbp.zza.equals(zzbp.zzb)) {
            zzv = Pair.create(zzv, zzbp.zzb);
        }
        zzbp.zzb = zzv;
        zzbp.zzn += zzs;
        zzbp.zzo += zzs;
    ...
    public final zzbo zzn(Object obj, zzbo zzbo) {
        Pair pair = (Pair) obj;
        Object obj2 = pair.first;
        Object obj3 = pair.second;
        int zzp = zzp(obj2);
        int zzt = zzt(zzp);
        zzu(zzp).zzn(obj3, zzbo);
        zzbo.zzc += zzt;
        zzbo.zzb = obj;
        return zzbo;
    }
