...
public interface zzbvz extends IInterface {
    ...
    void zzg(zzbwd zzbwd) throws RemoteException;
    ...
    void zzl(zzcc zzcc) throws RemoteException;

    void zzm(String str) throws RemoteException;

    void zzn(boolean z) throws RemoteException;

    void zzo(zzbwc zzbwc) throws RemoteException;
    ...
    void zzu(zzbvx zzbvx) throws RemoteException;
}
