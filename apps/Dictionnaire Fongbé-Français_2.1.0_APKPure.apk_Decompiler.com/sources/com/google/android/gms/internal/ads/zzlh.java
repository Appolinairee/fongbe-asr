...
final class zzlh extends zzhi {
    ...
    public final zzlh zzx(zzwb zzwb) {
        zzbq[] zzbqArr = new zzbq[this.zzg.length];
        int i = 0;
        while (true) {
            zzbq[] zzbqArr2 = this.zzg;
            if (i >= zzbqArr2.length) {
                return new zzlh(zzbqArr, this.zzh, zzwb);
            }
            zzbqArr[i] = new zzlg(this, zzbqArr2[i]);
            i++;
        }
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    private zzlh(zzbq[] zzbqArr, Object[] objArr, zzwb zzwb) {
        super(false, zzwb);
        int i = 0;
        this.zzg = zzbqArr;
        int length = zzbqArr.length;
