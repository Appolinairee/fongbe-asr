...
public final class zzdpr {
    ...
    private final void zzg() {
        if (!this.zzf.getAndSet(true)) {
            zzv.zzp().zzi().zzo(new zzdpp(this));
        }
    }
    ...
    public final synchronized void zze() {
        Map map;
        this.zzd = true;
        zzbzg zzg = zzv.zzp().zzi().zzg();
        if (zzg != null) {
            JSONObject zzf2 = zzg.zzf();
            if (zzf2 != null) {
                this.zzb = ((Boolean) zzbe.zzc().zza(zzbcl.zzef)).booleanValue() ? zzf2.optJSONObject("common_settings") : null;
    ...
    public final JSONObject zzb(String str, String str2) {
        if (!((Boolean) zzbe.zzc().zza(zzbcl.zzed)).booleanValue() || str == null || str2 == null) {
            return null;
        }
        if (!this.zzd) {
            zze();
        ...
        String zza2 = zzdpt.zza(this.zze, str, str2);
        if (zza2 != null) {
    ...
    public final void zzd() {
        zzg();
        this.zzc.execute(new zzdpo(this));
    }
