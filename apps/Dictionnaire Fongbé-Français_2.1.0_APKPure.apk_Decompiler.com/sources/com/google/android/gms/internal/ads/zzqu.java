...
public final class zzqu extends zzci {
    ...
    private long zzg;
    private int zzh = 0;
    private byte[] zzi = zzei.zzf;
    private int zzj = 0;
    private int zzk = 0;
    private byte[] zzl = zzei.zzf;
    ...
    private final void zzt(boolean z) {
        ...
        zzcw.zzg(i % this.zzd == 0, "bytesConsumed is not aligned to frame size: %s" + i);
        if (i3 < i2) {
            z2 = false;
        }
        zzcw.zzf(z2);
    ...
    private final void zzu(int i, int i2) {
        ...
        if (i != 0) {
            ...
            zzcw.zze(i % this.zzd == 0, "sizeToOutput is not aligned to frame size: " + i);
    ...
    public final zzcf zzi(zzcf zzcf) throws zzcg {
        if (zzcf.zzd == 2) {
            return zzcf.zzb == -1 ? zzcf.zza : zzcf;
        }
