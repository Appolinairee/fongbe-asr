...
public final class zzyn implements zzyj, zzgy {
    ...
    /* synthetic */ zzyn(Context context, Map map, int i, zzcx zzcx, boolean z, zzym zzym) {
    ...
    public final synchronized void zzl(int r9) {
        /*
            r8 = this;
            monitor-enter(r8)
            int r0 = r8.zzr     // Catch:{ all -> 0x0043 }
            if (r0 != r9) goto L_0x0006
            goto L_0x0041
        L_0x0006:
            r8.zzr = r9     // Catch:{ all -> 0x0043 }
            r0 = 1
            if (r9 == r0) goto L_0x0041
            if (r9 == 0) goto L_0x0041
            r0 = 8
            if (r9 == r0) goto L_0x0041
            long r0 = r8.zzj(r9)     // Catch:{ all -> 0x0043 }
            r8.zzp = r0     // Catch:{ all -> 0x0043 }
            long r0 = android.os.SystemClock.elapsedRealtime()     // Catch:{ all -> 0x0043 }
            int r9 = r8.zzk     // Catch:{ all -> 0x0043 }
            if (r9 <= 0) goto L_0x0026
            long r2 = r8.zzl     // Catch:{ all -> 0x0043 }
            long r2 = r0 - r2
            int r9 = (int) r2     // Catch:{ all -> 0x0043 }
            r3 = r9
            goto L_0x0028
        L_0x0026:
            r9 = 0
            r3 = 0
        L_0x0028:
            long r4 = r8.zzm     // Catch:{ all -> 0x0043 }
            long r6 = r8.zzp     // Catch:{ all -> 0x0043 }
            r2 = r8
            r2.zzk(r3, r4, r6)     // Catch:{ all -> 0x0043 }
            r8.zzl = r0     // Catch:{ all -> 0x0043 }
            r0 = 0
            r8.zzm = r0     // Catch:{ all -> 0x0043 }
            r8.zzo = r0     // Catch:{ all -> 0x0043 }
            r8.zzn = r0     // Catch:{ all -> 0x0043 }
            com.google.android.gms.internal.ads.zzzd r9 = r8.zzj     // Catch:{ all -> 0x0043 }
            r9.zzc()     // Catch:{ all -> 0x0043 }
            monitor-exit(r8)
            return
        L_0x0041:
            monitor-exit(r8)
        ...
        L_0x0043:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzyn.zzl(int):void");
    }

    private static boolean zzm(zzgd zzgd, boolean z) {
        return z && !zzgd.zzb(8);
    }
    ...
    public final synchronized void zza(zzfy zzfy, zzgd zzgd, boolean z, int i) {
        if (zzm(zzgd, z)) {
            this.zzm += (long) i;
        }
    }

    public final synchronized void zzb(zzfy zzfy, zzgd zzgd, boolean z) {
        if (zzm(zzgd, z)) {
            zzcw.zzf(this.zzk > 0);
    ...
    public final synchronized void zzd(zzfy zzfy, zzgd zzgd, boolean z) {
        if (zzm(zzgd, z)) {
            if (this.zzk == 0) {
    ...
    public final void zzg(zzyi zzyi) {
        this.zzi.zzc(zzyi);
    }
            ...
            if (zzg == null) {
                ...
                if (!(context == null || (telephonyManager = (TelephonyManager) context.getSystemService("phone")) == null)) {
                    ...
                    if (!TextUtils.isEmpty(networkCountryIso)) {
                        str = zzftt.zzb(networkCountryIso);
                        int[] zzn2 = zzn(str);
                        HashMap hashMap = new HashMap(8);
                        hashMap.put(0, 1000000L);
                        zzfxn zzfxn = zza;
                        hashMap.put(2, (Long) zzfxn.get(zzn2[0]));
                        ...
                        hashMap.put(7, (Long) zzfxn.get(zzn2[0]));
                        zzg = new zzyn(context2, hashMap, 2000, zzcx.zza, true, (zzym) null);
                    }
                }
                str = zzftt.zzb(Locale.getDefault().getCountry());
                int[] zzn22 = zzn(str);
                HashMap hashMap2 = new HashMap(8);
                hashMap2.put(0, 1000000L);
                zzfxn zzfxn2 = zza;
                hashMap2.put(2, (Long) zzfxn2.get(zzn22[0]));
                ...
                hashMap2.put(7, (Long) zzfxn2.get(zzn22[0]));
                zzg = new zzyn(context2, hashMap2, 2000, zzcx.zza, true, (zzym) null);
            }
            zzyn = zzg;
        }
        return zzyn;
    ...
    public final void zzf(Handler handler, zzyi zzyi) {
        zzyi.getClass();
        this.zzi.zza(handler, zzyi);
    }
}
