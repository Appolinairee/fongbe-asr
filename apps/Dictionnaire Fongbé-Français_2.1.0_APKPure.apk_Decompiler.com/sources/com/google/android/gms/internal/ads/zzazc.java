...
final class zzazc implements Application.ActivityLifecycleCallbacks {
    ...
    public final void onActivityPaused(Activity activity) {
        ...
        zzfqw zzfqw = zzs.zza;
        zzazb zzazb = new zzazb(this);
        this.zzh = zzazb;
        zzfqw.postDelayed(zzazb, this.zzj);
    }
    ...
    public final void zzf(zzazd zzazd) {
        synchronized (this.zzc) {
            this.zzf.add(zzazd);
        }
    }
    ...
    public final void zzg(Application application, Context context) {
        if (!this.zzi) {
            ...
            this.zzj = ((Long) zzbe.zzc().zza(zzbcl.zzbc)).longValue();
            this.zzi = true;
        }
    }

    public final void zzh(zzazd zzazd) {
        synchronized (this.zzc) {
            this.zzf.remove(zzazd);
        }
    }
