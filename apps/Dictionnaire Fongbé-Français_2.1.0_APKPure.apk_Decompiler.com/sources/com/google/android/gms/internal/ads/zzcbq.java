...
public final class zzcbq extends Thread implements SurfaceTexture.OnFrameAvailableListener, zzcbo {
    ...
    public final void run() {
        ...
        L_0x008c:
            r0 = 1
        L_0x008d:
            com.google.android.gms.internal.ads.zzbcc r1 = com.google.android.gms.internal.ads.zzbcl.zzbs
        ...
        L_0x00b9:
            ...
            goto L_0x013e
        L_0x00bc:
            com.google.android.gms.internal.ads.zzbcc r6 = com.google.android.gms.internal.ads.zzbcl.zzbt
        ...
        L_0x01c9:
            ...
            r0.countDown()
            com.google.android.gms.internal.ads.zzcbp r0 = r15.zzb
            r0.zzc()
            r15.zzA = r4     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
        L_0x01df:
            boolean r0 = r15.zzB     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            if (r0 == 0) goto L_0x01e5
            goto L_0x032f
        L_0x01e5:
            int r0 = r15.zzs     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            if (r0 <= 0) goto L_0x01f5
            android.graphics.SurfaceTexture r0 = r15.zzo     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            r0.updateTexImage()     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            int r0 = r15.zzs     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            int r0 = r0 + -1
            r15.zzs = r0     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            goto L_0x01e5
        L_0x01f5:
            com.google.android.gms.internal.ads.zzcbp r0 = r15.zzb     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float[] r1 = r15.zzc     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            boolean r0 = r0.zze(r1)     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            r1 = 5
            r6 = -1077342245(0xffffffffbfc90fdb, float:-1.5707964)
            r7 = 4
            if (r0 == 0) goto L_0x0269
            float r0 = r15.zzj     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            boolean r0 = java.lang.Float.isNaN(r0)     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            if (r0 == 0) goto L_0x025e
            float[] r0 = r15.zzc     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            r8 = 3
            float[] r9 = new float[r8]     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            r9 = {0, 1065353216, 0} // fill-array     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            r10 = r0[r5]     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            r11 = r9[r5]     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float r10 = r10 * r11
            r12 = r0[r4]     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            r9 = r9[r4]     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float r12 = r12 * r9
            float r10 = r10 + r12
            r12 = r0[r2]     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            r13 = 0
            float r12 = r12 * r13
            float r10 = r10 + r12
            r12 = r0[r8]     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float r12 = r12 * r11
            r14 = r0[r7]     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float r14 = r14 * r9
            float r12 = r12 + r14
            r14 = r0[r1]     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float r14 = r14 * r13
            float r12 = r12 + r14
            r14 = 6
            r14 = r0[r14]     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float r14 = r14 * r11
            r11 = 7
            r11 = r0[r11]     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float r11 = r11 * r9
            float r14 = r14 + r11
            r9 = 8
            r0 = r0[r9]     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float r0 = r0 * r13
            float r14 = r14 + r0
            float[] r0 = new float[r8]     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            r0[r5] = r10     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            r0[r4] = r12     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            r0[r2] = r14     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            r8 = r0[r4]     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            double r8 = (double) r8     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            r0 = r0[r5]     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            double r10 = (double) r0     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            double r8 = java.lang.Math.atan2(r8, r10)     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float r0 = (float) r8     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float r0 = r0 + r6
            float r0 = -r0
            r15.zzj = r0     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
        L_0x025e:
            float[] r0 = r15.zzh     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float r6 = r15.zzj     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float r8 = r15.zzk     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float r6 = r6 + r8
            zzk(r0, r6)     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            goto L_0x0275
        L_0x0269:
            float[] r0 = r15.zzc     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            zzj(r0, r6)     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float[] r0 = r15.zzh     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float r6 = r15.zzk     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            zzk(r0, r6)     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
        L_0x0275:
            float[] r0 = r15.zzd     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            r6 = 1070141403(0x3fc90fdb, float:1.5707964)
            zzj(r0, r6)     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float[] r0 = r15.zze     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float[] r6 = r15.zzh     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float[] r8 = r15.zzd     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            zzi(r0, r6, r8)     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float[] r0 = r15.zzf     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float[] r6 = r15.zzc     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float[] r8 = r15.zze     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            zzi(r0, r6, r8)     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float[] r0 = r15.zzg     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float r6 = r15.zzl     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            zzj(r0, r6)     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float[] r0 = r15.zzi     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float[] r6 = r15.zzg     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float[] r8 = r15.zzf     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            zzi(r0, r6, r8)     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            int r0 = r15.zzr     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float[] r6 = r15.zzi     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            android.opengl.GLES20.glUniformMatrix3fv(r0, r4, r5, r6, r5)     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            android.opengl.GLES20.glDrawArrays(r1, r5, r7)     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            java.lang.String r0 = "drawArrays"
            zzh(r0)     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            android.opengl.GLES20.glFinish()     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            javax.microedition.khronos.egl.EGL10 r0 = r15.zzw     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            javax.microedition.khronos.egl.EGLDisplay r1 = r15.zzx     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            javax.microedition.khronos.egl.EGLSurface r6 = r15.zzz     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            r0.eglSwapBuffers(r1, r6)     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            boolean r0 = r15.zzA     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            if (r0 == 0) goto L_0x0300
            int r0 = r15.zzn     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            int r1 = r15.zzm     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            android.opengl.GLES20.glViewport(r5, r5, r0, r1)     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            java.lang.String r0 = "viewport"
            zzh(r0)     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            int r0 = r15.zzq     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            java.lang.String r1 = "uFOVx"
            int r0 = android.opengl.GLES20.glGetUniformLocation(r0, r1)     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            int r1 = r15.zzq     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            java.lang.String r6 = "uFOVy"
            int r1 = android.opengl.GLES20.glGetUniformLocation(r1, r6)     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            int r6 = r15.zzn     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            int r7 = r15.zzm     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            r8 = 1063216883(0x3f5f66f3, float:0.87266463)
            if (r6 <= r7) goto L_0x02f3
            android.opengl.GLES20.glUniform1f(r0, r8)     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            int r0 = r15.zzm     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float r0 = (float) r0     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float r0 = r0 * r8
            int r6 = r15.zzn     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float r6 = (float) r6     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float r0 = r0 / r6
            android.opengl.GLES20.glUniform1f(r1, r0)     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            goto L_0x02fe
        L_0x02f3:
            float r6 = (float) r6     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float r6 = r6 * r8
            float r7 = (float) r7     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            float r6 = r6 / r7
            android.opengl.GLES20.glUniform1f(r0, r6)     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
            android.opengl.GLES20.glUniform1f(r1, r8)     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
        L_0x02fe:
            r15.zzA = r5     // Catch:{ IllegalStateException -> 0x032a, all -> 0x031a }
        L_0x0300:
            java.lang.Object r0 = r15.zzv     // Catch:{ InterruptedException -> 0x01df }
            monitor-enter(r0)     // Catch:{ InterruptedException -> 0x01df }
            boolean r1 = r15.zzB     // Catch:{ all -> 0x0317 }
            if (r1 != 0) goto L_0x0314
            boolean r1 = r15.zzA     // Catch:{ all -> 0x0317 }
            if (r1 != 0) goto L_0x0314
            int r1 = r15.zzs     // Catch:{ all -> 0x0317 }
            if (r1 != 0) goto L_0x0314
            java.lang.Object r1 = r15.zzv     // Catch:{ all -> 0x0317 }
            r1.wait()     // Catch:{ all -> 0x0317 }
        L_0x0314:
        ...
        L_0x031a:
            ...
            com.google.android.gms.ads.internal.util.client.zzo.zzh(r1, r0)     // Catch:{ all -> 0x033f }
            com.google.android.gms.internal.ads.zzbzm r1 = com.google.android.gms.ads.internal.zzv.zzp()     // Catch:{ all -> 0x033f }
            java.lang.String r2 = "SphericalVideoProcessor.run.2"
            r1.zzw(r0, r2)     // Catch:{ all -> 0x033f }
            goto L_0x032f
        L_0x032a:
            java.lang.String r0 = "SphericalVideoProcessor halted unexpectedly."
            com.google.android.gms.ads.internal.util.client.zzo.zzj(r0)     // Catch:{ all -> 0x033f }
        L_0x032f:
            com.google.android.gms.internal.ads.zzcbp r0 = r15.zzb
            r0.zzd()
        ...
        L_0x033f:
            r0 = move-exception
            com.google.android.gms.internal.ads.zzcbp r1 = r15.zzb
            r1.zzd()
