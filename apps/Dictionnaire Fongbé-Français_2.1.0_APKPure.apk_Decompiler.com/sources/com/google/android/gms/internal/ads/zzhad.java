...
class zzhad extends AbstractMap {
    ...
    public final Set entrySet() {
        if (this.zze == null) {
            this.zze = new zzhab(this, (zzhac) null);
        }
        return this.zze;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        int i = this.zzb;
        if (i != zzhad.zzb) {
            return entrySet().equals(zzhad.entrySet());
        }
        for (int i2 = 0; i2 < i; i2++) {
            if (!zzg(i2).equals(zzhad.zzg(i2))) {
                return false;
            }
        }
        if (i != size) {
            return this.zzc.equals(zzhad.zzc);
        }
        return true;
    }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        if (this.zzb == 16) {
            zzgzz zzgzz = (zzgzz) this.zza[15];
            this.zzb = 15;
            zzn().put(zzgzz.zza(), zzgzz.getValue());
        }
        Object[] objArr = this.zza;
