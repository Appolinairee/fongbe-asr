...
public final class zzaos {
                ...
                if (zza >= longValue) {
                    ...
                    if (allocate.getLong(8) == 2334950737559900225L && allocate.getLong(16) == 3617552046287187010L) {
                        ...
                        if (j4 >= 0) {
                                            ...
                                            while (slice.hasRemaining()) {
                                                ...
                                                if (slice.remaining() >= 8) {
                                                    ...
                                                    if (j6 < 4 || j6 > 2147483647L) {
                                                        throw new zzaoo("APK Signing Block entry #" + i2 + " size out of range: " + j6);
                                                    }
                                                    int i3 = (int) j6;
                                                    int position2 = slice.position() + i3;
                                                    if (i3 > slice.remaining()) {
                                                        throw new zzaoo("APK Signing Block entry #" + i2 + " size out of range: " + i3 + ", available: " + slice.remaining());
                                                    } else if (slice.getInt() == 1896449818) {
                                                        long j7 = j2;
                                                        X509Certificate[][] zzl = zzl(randomAccessFile.getChannel(), new zzaon(zze(slice, i3 - 4), longValue2, zza, j2, byteBuffer2, (zzaor) null));
                                                    ...
                                                    throw new zzaoo("Insufficient data to read size of APK Signing Block entry #" + i2);
                                                }
                                            }
                            ...
                            throw new zzaoo("APK Signing Block sizes in header and footer do not match: " + j5 + " vs " + j3);
                        }
    ...
    private static void zzh(Map map, FileChannel fileChannel, long j, long j2, long j3, ByteBuffer byteBuffer) throws SecurityException {
        if (!map.isEmpty()) {
            zzaom zzaom = new zzaom(fileChannel, 0, j);
            zzaom zzaom2 = new zzaom(fileChannel, j2, j3 - j2);
            ByteBuffer duplicate = byteBuffer.duplicate();
            duplicate.order(ByteOrder.LITTLE_ENDIAN);
            long j4 = j;
            zzaot.zzd(duplicate, j);
            zzaok zzaok = new zzaok(duplicate);
            int size = map.size();
            ...
            try {
                byte[][] zzk = zzk(iArr, new zzaol[]{zzaom, zzaom2, zzaok});
                while (i < size) {
                    int i3 = iArr[i];
                    Map map2 = map;
                    ...
                    if (arrayList.equals(arrayList2)) {
                        ...
                        if (bArr3 == null || MessageDigest.isEqual(bArr3, bArr)) {
                            ...
                            while (zzf6.hasRemaining()) {
                                ...
                                byte[] zzi2 = zzi(zzf6);
                                try {
                                    arrayList3.add(new zzaop((X509Certificate) certificateFactory.generateCertificate(new ByteArrayInputStream(zzi2)), zzi2));
    ...
    private static byte[][] zzk(int[] iArr, zzaol[] zzaolArr) throws DigestException {
        long j;
        int i;
        int length;
        int[] iArr2 = iArr;
        ...
        while (true) {
            ...
            j3 += (zzaolArr[i3].zza() + 1048575) / 1048576;
            i3++;
        }
        if (j3 < 2097151) {
            ...
            for (i = 3; i7 < i; i = 3) {
                ...
                while (zza > j2) {
                    ...
                    long j5 = j4;
                    try {
                        zzaol.zzb(messageDigestArr, j5, min);
                        byte[] bArr4 = bArr3;
                        int i10 = 0;
    ...
    private static X509Certificate[][] zzl(FileChannel fileChannel, zzaon zzaon) throws SecurityException {
        HashMap hashMap = new HashMap();
        ArrayList arrayList = new ArrayList();
        try {
            CertificateFactory instance = CertificateFactory.getInstance("X.509");
            try {
                ByteBuffer zzf = zzf(zzaon.zza);
                int i = 0;
                ...
                if (i <= 0) {
                    ...
                    zzh(hashMap, fileChannel, zzaon.zzb, zzaon.zzc, zzaon.zzd, zzaon.zze);
