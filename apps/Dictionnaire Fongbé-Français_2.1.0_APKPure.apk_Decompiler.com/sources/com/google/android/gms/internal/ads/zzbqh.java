...
public final class zzbqh implements MediationBannerListener, MediationInterstitialListener, MediationNativeListener {
    ...
    public final void zzd(MediationNativeAdapter mediationNativeAdapter, zzbgr zzbgr) {
        Preconditions.checkMainThread("#008 Must be called on the main UI thread.");
        zzo.zze("Adapter called onAdLoaded with template id ".concat(String.valueOf(zzbgr.zzb())));
        this.zzc = zzbgr;
        try {
            this.zza.zzo();
        } catch (RemoteException e) {
    ...
    public final void zze(MediationNativeAdapter mediationNativeAdapter, zzbgr zzbgr, String str) {
        try {
            zzbgr zzbgr2 = zzbgr;
            this.zza.zzr(zzbgr.zza(), str);
        } catch (RemoteException e) {
            zzo.zzl("#007 Could not call remote method.", e);
        }
    }
    ...
    public final void onAdFailedToLoad(MediationBannerAdapter mediationBannerAdapter, AdError adError) {
        ...
        zzo.zze("Adapter called onAdFailedToLoad with error. ErrorCode: " + code + ". ErrorMessage: " + message + ". ErrorDomain: " + domain);
        try {
