...
public final class zzfni {
    ...
    public static zzfni zza(Context context, Executor executor, boolean z) {
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        if (z) {
            executor.execute(new zzfng(context, taskCompletionSource));
        } else {
            executor.execute(new zzfnh(taskCompletionSource));
        }
    ...
    private final Task zzh(int i, long j, Exception exc, String str, Map map, String str2) {
        if (!this.zze) {
            return this.zzd.continueWith(this.zzc, new zzfne());
        }
        ...
        return this.zzd.continueWith(this.zzc, new zzfnf(zza2, i));
    }
