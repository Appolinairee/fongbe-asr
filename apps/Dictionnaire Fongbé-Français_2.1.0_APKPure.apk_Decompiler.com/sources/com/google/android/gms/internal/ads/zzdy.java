...
public final class zzdy {
    ...
    private final int zzP(Charset charset) {
        ...
        if (charset.equals(StandardCharsets.UTF_8) || charset.equals(StandardCharsets.US_ASCII)) {
            ...
            int i3 = this.zze;
            if (i2 - i3 > 0) {
                b = (byte) zzgan.zza((long) (this.zzd[i3] & 255));
                return (zzgan.zza((long) b) << 16) + i;
            }
        }
    ...
    public final String zzA(int i) {
        ...
        int i2 = this.zze;
        int i3 = (i2 + i) - 1;
        String zzC = zzei.zzC(this.zzd, i2, (i3 >= this.zzf || this.zzd[i3] != 0) ? i : i - 1);
        this.zze += i;
        return zzC;
    }
    ...
    public final void zzG(zzdx zzdx, int i) {
        zzH(zzdx.zza, 0, i);
        zzdx.zzl(0);
    }
    ...
    public final char zza(Charset charset) {
        zzcw.zze(zzc.contains(charset), "Unsupported charset: ".concat(String.valueOf(String.valueOf(charset))));
    ...
    public final String zzz(Charset charset) {
        ...
        while (true) {
            ...
            if (i2 >= i3 - (i - 1)) {
                i2 = i3;
                break;
            } else if ((charset.equals(StandardCharsets.UTF_8) || charset.equals(StandardCharsets.US_ASCII)) && zzei.zzL(this.zzd[i2])) {
                break;
            } else {
                if (charset.equals(StandardCharsets.UTF_16) || charset.equals(StandardCharsets.UTF_16BE)) {
                    byte[] bArr = this.zzd;
