...
public final class zzbda {
    ...
    public static final zzbcx zzf() {
        return new zzbcx(zzv.zzC().elapsedRealtime(), (String) null, (zzbcx) null);
    }

    public final zzbcz zza() {
        zzbcz zzbcz;
        boolean booleanValue = ((Boolean) zzbe.zzc().zza(zzbcl.zzbY)).booleanValue();
    ...
    public final boolean zze(zzbcx zzbcx, long j, String... strArr) {
        synchronized (this.zzc) {
            this.zza.add(new zzbcx(j, strArr[0], zzbcx));
        }
        return true;
    }
}
