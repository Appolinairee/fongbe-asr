...
final class zzgwn extends zzgwp {
    ...
    /* synthetic */ zzgwn(ByteBuffer byteBuffer, boolean z, zzgwo zzgwo) {
        super((zzgwo) null);
        this.zze = byteBuffer;
        long zze2 = zzhao.zze(byteBuffer);
        this.zzf = zze2;
    ...
    public final int zzh() throws IOException {
        ...
        if (this.zzg - j >= 4) {
            ...
            return ((zzhao.zza(j + 3) & 255) << Ascii.CAN) | zza | (zzhao.zza(j) & 255) | ((zzhao.zza(2 + j) & 255) << Ascii.DLE);
        }
    ...
    public final long zzp() throws IOException {
        ...
        if (this.zzg - j >= 8) {
            this.zzh = 8 + j;
            long zza = (long) zzhao.zza(5 + j);
            long zza2 = (((long) zzhao.zza(j)) & 255) | ((((long) zzhao.zza(1 + j)) & 255) << 8) | ((((long) zzhao.zza(2 + j)) & 255) << 16) | ((((long) zzhao.zza(3 + j)) & 255) << 24) | ((((long) zzhao.zza(4 + j)) & 255) << 32);
            return ((((long) zzhao.zza(j + 7)) & 255) << 56) | zza2 | ((zza & 255) << 40) | ((((long) zzhao.zza(6 + j)) & 255) << 48);
        }
        throw new zzgyg("While parsing a protocol message, the input ended unexpectedly in the middle of a field.  This could mean either that the input has been truncated or that an embedded message misreported its own length.");
    }
    ...
    public final String zzx() throws IOException {
        int zzi2 = zzi();
        if (zzi2 > 0 && zzi2 <= zzC()) {
            String zzg2 = zzhat.zzg(this.zze, (int) (this.zzh - this.zzf), zzi2);
            this.zzh += (long) zzi2;
            return zzg2;
        } else if (zzi2 == 0) {
            return "";
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:29:0x0089, code lost:
        if (com.google.android.gms.internal.ads.zzhao.zza(r3) >= 0) goto L_0x008b;
     */
        ...
        if (this.zzg != j4) {
            ...
            if (zza >= 0) {
                ...
                if (zza2 < 0) {
                    ...
                    long j7 = 3 + j4;
                    byte zza3 = zza2 ^ (zzhao.zza(j6) << Ascii.SO);
                    if (zza3 >= 0) {
                        j2 = (long) (zza3 ^ 16256);
                    } else {
                        j6 = 4 + j4;
                        ...
                        if (zza4 < 0) {
                            ...
                            j7 = 5 + j4;
                            long zza5 = (((long) zzhao.zza(j6)) << 28) ^ ((long) zza4);
                            if (zza5 >= 0) {
                                j2 = 266354560 ^ zza5;
                            } else {
                                long j8 = 6 + j4;
                                long zza6 = (((long) zzhao.zza(j7)) << 35) ^ zza5;
                                if (zza6 < 0) {
                                    j3 = -34093383808L;
                                } else {
                                    j = j4 + 7;
                                    long zza7 = zza6 ^ (((long) zzhao.zza(j8)) << 42);
                                    if (zza7 >= 0) {
                                        j2 = 4363953127296L ^ zza7;
                                    } else {
                                        j8 = 8 + j4;
                                        zza6 = zza7 ^ (((long) zzhao.zza(j)) << 49);
                                        if (zza6 < 0) {
                                            j3 = -558586000294016L;
                                        } else {
                                            j = j4 + 9;
                                            long zza8 = (zza6 ^ (((long) zzhao.zza(j8)) << 56)) ^ 71499008037633920L;
                                            if (zza8 < 0) {
                                                long j9 = j4 + 10;
                                                if (((long) zzhao.zza(j)) >= 0) {
                                                    j = j9;
                                                }
                                            }
                                            j2 = zza8;
