...
public final class zzcnh implements zzayk, zzcwo, zzr, zzcwn {
    ...
    public zzcnh(zzbop zzbop, zzcnd zzcnd, Executor executor, zzcnc zzcnc, Clock clock) {
        this.zza = zzcnc;
        this.zzd = zzbop.zza("google.afma.activeView.handleUpdate", zzbod.zza, zzbod.zza);
        this.zzb = zzcnd;
        this.zze = executor;
        this.zzf = clock;
    }
    ...
    public final synchronized void zzg() {
        /*
            ...
            if (r0 == 0) goto L_0x0059
            com.google.android.gms.internal.ads.zzcng r0 = r5.zzh     // Catch:{ Exception -> 0x0051 }
            ...
            com.google.android.gms.internal.ads.zzcnd r0 = r5.zzb     // Catch:{ Exception -> 0x0051 }
            com.google.android.gms.internal.ads.zzcng r1 = r5.zzh     // Catch:{ Exception -> 0x0051 }
        ...
        L_0x002d:
            ...
            com.google.android.gms.internal.ads.zzcex r2 = (com.google.android.gms.internal.ads.zzcex) r2     // Catch:{ Exception -> 0x0051 }
            java.util.concurrent.Executor r3 = r5.zze     // Catch:{ Exception -> 0x0051 }
            com.google.android.gms.internal.ads.zzcnf r4 = new com.google.android.gms.internal.ads.zzcnf     // Catch:{ Exception -> 0x0051 }
            r4.<init>(r2, r0)     // Catch:{ Exception -> 0x0051 }
            r3.execute(r4)     // Catch:{ Exception -> 0x0051 }
            goto L_0x002d
        L_0x0044:
            com.google.android.gms.internal.ads.zzbos r1 = r5.zzd     // Catch:{ Exception -> 0x0051 }
            ...
            com.google.android.gms.internal.ads.zzbzz.zzb(r0, r1)     // Catch:{ Exception -> 0x0051 }
            monitor-exit(r5)
            return
        L_0x0051:
            r0 = move-exception
        ...
        L_0x0060:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzcnh.zzg():void");
    }

    public final synchronized void zzh(zzcex zzcex) {
        this.zzc.add(zzcex);
        this.zza.zzd(zzcex);
    }
