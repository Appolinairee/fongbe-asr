...
public final class zzbzg {
    ...
    public zzbzg(String str, long j) {
        ...
        if (!TextUtils.isEmpty(str)) {
            try {
                ...
                if (((Boolean) zzbe.zzc().zza(zzbcl.zzly)).booleanValue() && zzj()) {
                    return;
                }
                        ...
                        if (!TextUtils.isEmpty(optString)) {
                            if (!TextUtils.isEmpty(optString2)) {
                                if ("interstitial".equalsIgnoreCase(optString)) {
                                    ...
                                    this.zzc.put(optString2, new zzboy(optJSONObject2));
                                }
                            }
                        }
                    }
                ...
                if (((Boolean) zzbe.zzc().zza(zzbcl.zzge)).booleanValue() && (optJSONObject = this.zzg.optJSONObject("common_settings")) != null) {
    ...
    public final boolean zzj() {
        if (!TextUtils.isEmpty(this.zze) && this.zzg != null) {
            long longValue = ((Long) zzbe.zzc().zza(zzbcl.zzlB)).longValue();
            if (((Boolean) zzbe.zzc().zza(zzbcl.zzlA)).booleanValue() && !TextUtils.isEmpty(this.zze)) {
                longValue = this.zzg.optLong("cache_ttl_sec", ((Long) zzbe.zzc().zza(zzbcl.zzlB)).longValue());
            }
