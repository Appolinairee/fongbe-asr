...
public abstract class zzaqv implements zzaqw {
    ...
    public final zzaqz zzb(zzhed zzhed, zzara zzara) throws IOException {
        int zza2;
        long j;
        String str;
        long zzb2 = zzhed.zzb();
        ...
        do {
            zza2 = zzhed.zza((ByteBuffer) this.zza.get());
            if (zza2 == 8) {
                ...
                if (zze >= 8 || zze <= 1) {
                    ...
                    try {
                        ...
                        long j2 = j;
                        if (zzara instanceof zzaqz) {
                            str = ((zzaqz) zzara).zza();
                        } else {
                            str = "";
                        }
                        zzaqz zza3 = zza(str2, bArr, str);
                        ((ByteBuffer) this.zza.get()).rewind();
                        zza3.zzb(zzhed, (ByteBuffer) this.zza.get(), j2, this);
                        return zza3;
