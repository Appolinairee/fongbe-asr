...
public final class zzbav extends AbstractSafeParcelable {
    ...
    zzbav(String str, long j, String str2, String str3, String str4, Bundle bundle, boolean z, long j2, String str5, int i) {
        this.zza = str;
        this.zzb = j;
    ...
    public static zzbav zza(Uri uri) {
        ...
        try {
            ...
            if (pathSegments.size() != 2) {
                ...
                zzo.zzj("Expected 2 path parts for namespace and id, found :" + size);
                return null;
            }
            ...
            return new zzbav(queryParameter, j, host, str, str2, bundle, equals, 0, "", 0);
