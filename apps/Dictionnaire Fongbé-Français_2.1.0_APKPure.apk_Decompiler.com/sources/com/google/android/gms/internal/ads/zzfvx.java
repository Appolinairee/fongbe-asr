...
final class zzfvx extends zzfwa implements NavigableMap {
    ...
    zzfvx(zzfwg zzfwg, NavigableMap navigableMap) {
        super(zzfwg, navigableMap);
        this.zzc = zzfwg;
    }
    ...
    public final NavigableMap descendingMap() {
        return new zzfvx(this.zzc, ((NavigableMap) ((SortedMap) this.zza)).descendingMap());
    }
    ...
    public final NavigableMap headMap(Object obj, boolean z) {
        return new zzfvx(this.zzc, ((NavigableMap) ((SortedMap) this.zza)).headMap(obj, z));
    }

    public final NavigableMap subMap(Object obj, boolean z, Object obj2, boolean z2) {
        return new zzfvx(this.zzc, ((NavigableMap) ((SortedMap) this.zza)).subMap(obj, z, obj2, z2));
    }

    public final NavigableMap tailMap(Object obj, boolean z) {
        return new zzfvx(this.zzc, ((NavigableMap) ((SortedMap) this.zza)).tailMap(obj, z));
    }
}
