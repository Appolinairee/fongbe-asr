...
public final class zzazj extends Thread {
    ...
    public zzazj() {
        ...
        this.zzj = ((Integer) zzbe.zzc().zza(zzbcl.zzae)).intValue();
        this.zzk = ((Integer) zzbe.zzc().zza(zzbcl.zzaf)).intValue();
        this.zzl = ((Integer) zzbe.zzc().zza(zzbcl.zzag)).intValue();
    ...
    public final void run() {
        /*
            r6 = this;
        L_0x0000:
            com.google.android.gms.internal.ads.zzaze r0 = com.google.android.gms.ads.internal.zzv.zzb()     // Catch:{ all -> 0x00a8 }
        ...
        L_0x002a:
            ...
            if (r0 == 0) goto L_0x00b2
            com.google.android.gms.internal.ads.zzaze r0 = com.google.android.gms.ads.internal.zzv.zzb()     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
            android.app.Activity r0 = r0.zza()     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
            if (r0 != 0) goto L_0x006d
            java.lang.String r0 = "ContentFetchThread: no activity. Sleeping."
            com.google.android.gms.ads.internal.util.client.zzo.zze(r0)     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
        ...
        L_0x008e:
            r0 = move-exception
            com.google.android.gms.internal.ads.zzbzm r2 = com.google.android.gms.ads.internal.zzv.zzp()     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
        ...
        L_0x009d:
            ...
            com.google.android.gms.internal.ads.zzazf r0 = new com.google.android.gms.internal.ads.zzazf     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
        ...
        L_0x00a8:
            r0 = move-exception
            com.google.android.gms.internal.ads.zzbzm r1 = com.google.android.gms.ads.internal.zzv.zzp()     // Catch:{ InterruptedException -> 0x00d3, Exception -> 0x00c3 }
        ...
        L_0x00dc:
            ...
            com.google.android.gms.ads.internal.util.client.zzo.zze(r1)     // Catch:{ InterruptedException -> 0x00dc }
    ...
    public final zzazi zza(View view, zzayz zzayz) {
        if (view != null) {
            boolean globalVisibleRect = view.getGlobalVisibleRect(new Rect());
            if ((view instanceof TextView) && !(view instanceof EditText)) {
                CharSequence text = ((TextView) view).getText();
                if (!TextUtils.isEmpty(text)) {
                    zzayz.zzh(text.toString(), globalVisibleRect, view.getX(), view.getY(), (float) view.getWidth(), (float) view.getHeight());
                ...
                if (PlatformVersion.isAtLeastKitKat()) {
                    zzayz.zzf();
                    webView.post(new zzazh(this, zzayz, webView, globalVisibleRect));
                ...
                for (int i3 = 0; i3 < viewGroup.getChildCount(); i3++) {
                    zzazi zza2 = zza(viewGroup.getChildAt(i3), zzayz);
                    i += zza2.zza;
                    i2 += zza2.zzb;
                }
    ...
    public final void zzb(android.view.View r11) {
        /*
            r10 = this;
            com.google.android.gms.internal.ads.zzayz r9 = new com.google.android.gms.internal.ads.zzayz     // Catch:{ Exception -> 0x007e }
            ...
            com.google.android.gms.internal.ads.zzaze r0 = com.google.android.gms.ads.internal.zzv.zzb()     // Catch:{ Exception -> 0x007e }
            ...
            com.google.android.gms.internal.ads.zzbcc r2 = com.google.android.gms.internal.ads.zzbcl.zzah     // Catch:{ Exception -> 0x007e }
            com.google.android.gms.internal.ads.zzbcj r3 = com.google.android.gms.ads.internal.client.zzbe.zzc()     // Catch:{ Exception -> 0x007e }
        ...
        L_0x0052:
            com.google.android.gms.internal.ads.zzazi r11 = r10.zza(r11, r9)     // Catch:{ Exception -> 0x007e }
            r9.zzj()     // Catch:{ Exception -> 0x007e }
        ...
        L_0x0061:
            ...
            int r11 = r9.zzb()     // Catch:{ Exception -> 0x007e }
            if (r11 == 0) goto L_0x0077
            goto L_0x006e
        L_0x006c:
            if (r11 != 0) goto L_0x0078
        L_0x006e:
            com.google.android.gms.internal.ads.zzaza r11 = r10.zzd     // Catch:{ Exception -> 0x007e }
            boolean r11 = r11.zzc(r9)     // Catch:{ Exception -> 0x007e }
            if (r11 != 0) goto L_0x0077
            goto L_0x0078
        L_0x0077:
            return
        L_0x0078:
            com.google.android.gms.internal.ads.zzaza r11 = r10.zzd     // Catch:{ Exception -> 0x007e }
            r11.zza(r9)     // Catch:{ Exception -> 0x007e }
            return
        L_0x007e:
            r11 = move-exception
    ...
    /* access modifiers changed from: package-private */
    public final void zzc(zzayz zzayz, WebView webView, String str, boolean z) {
        zzayz.zze();
        try {
            if (!TextUtils.isEmpty(str)) {
                String optString = new JSONObject(str).optString("text");
                if (this.zzn || TextUtils.isEmpty(webView.getTitle())) {
                    zzayz.zzi(optString, z, webView.getX(), webView.getY(), (float) webView.getWidth(), (float) webView.getHeight());
                } else {
