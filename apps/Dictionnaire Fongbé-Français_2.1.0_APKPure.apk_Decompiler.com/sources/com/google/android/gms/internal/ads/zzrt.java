...
final class zzrt extends MediaCodec.Callback {
    ...
    public static /* synthetic */ void zzd(zzrt zzrt) {
        synchronized (zzrt.zza) {
            if (!zzrt.zzm) {
                long j = zzrt.zzl - 1;
                zzrt.zzl = j;
                int i = (j > 0 ? 1 : (j == 0 ? 0 : -1));
                if (i <= 0) {
                    if (i < 0) {
                        ...
                        synchronized (zzrt.zza) {
                            zzrt.zzn = illegalStateException;
                        }
                        return;
                    }
                    zzrt.zzj();
    ...
    public final int zzb(android.media.MediaCodec.BufferInfo r10) {
        /*
            ...
            boolean r1 = r9.zzl()     // Catch:{ all -> 0x004b }
            r2 = -1
            if (r1 == 0) goto L_0x000f
        ...
        L_0x0019:
            ...
            com.google.android.gms.internal.ads.zzcw.zzb(r2)     // Catch:{ all -> 0x004b }
    ...
    public final void zzg(zzsc zzsc) {
        synchronized (this.zza) {
            this.zzo = zzsc;
        }
    }
