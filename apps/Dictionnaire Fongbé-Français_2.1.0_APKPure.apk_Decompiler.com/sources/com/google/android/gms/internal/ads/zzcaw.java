...
public final class zzcaw extends zzcay implements TextureView.SurfaceTextureListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener {
    ...
    public zzcaw(Context context, zzcbs zzcbs, boolean z, boolean z2, zzcbr zzcbr, zzcbt zzcbt) {
        super(context);
        ...
        if (this.zzj != null && surfaceTexture != null) {
            ...
            try {
                ...
                if (this.zzo) {
                    ...
                    this.zzn = zzcbq;
                    zzcbq.zzd(surfaceTexture, getWidth(), getHeight());
                    this.zzn.start();
                ...
                zzo.zzk("Failed to initialize MediaPlayer at ".concat(String.valueOf(String.valueOf(this.zzj))), e);
    ...
    private final boolean zzH() {
        ...
        L_0x000f:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzcaw.zzH():boolean");
    }

    static /* bridge */ /* synthetic */ void zzl(zzcaw zzcaw, MediaPlayer mediaPlayer) {
        MediaFormat format;
        if (((Boolean) zzbe.zzc().zza(zzbcl.zzbY)).booleanValue() && zzcaw.zzd != null && mediaPlayer != null) {
            try {
                ...
                if (trackInfo != null) {
                    ...
                    if (!hashMap.isEmpty()) {
                        zzcaw.zzd.zzd("onMetadataEvent", hashMap);
                    }
                }
    ...
    public final boolean onError(MediaPlayer mediaPlayer, int i, int i2) {
        ...
        zzF(-1);
        this.zzh = -1;
        zzs.zza.post(new zzcaq(this, str, str2));
        return true;
    }
    ...
    public final void onPrepared(android.media.MediaPlayer r9) {
        /*
            ...
            r0 = 2
            r8.zzF(r0)
            com.google.android.gms.internal.ads.zzcbt r0 = r8.zze
            r0.zzb()
            com.google.android.gms.internal.ads.zzfqw r0 = com.google.android.gms.ads.internal.util.zzs.zza
        ...
        L_0x0084:
            ...
            com.google.android.gms.ads.internal.util.client.zzo.zzi(r9)
            int r9 = r8.zzh
    ...
    public final void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i2) {
        ...
        zzs.zza.post(new zzcas(this, i, i2));
    }
