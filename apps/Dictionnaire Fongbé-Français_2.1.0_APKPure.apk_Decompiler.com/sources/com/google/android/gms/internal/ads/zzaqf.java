...
final class zzaqf {
    ...
    zzaqf(java.lang.String r14, com.google.android.gms.internal.ads.zzaov r15) {
        /*
            r13 = this;
    ...
    static zzaqf zza(zzaqg zzaqg) throws IOException {
        if (zzaqi.zze(zzaqg) == 538247942) {
            String zzh2 = zzaqi.zzh(zzaqg);
            String zzh3 = zzaqi.zzh(zzaqg);
            long zzf2 = zzaqi.zzf(zzaqg);
            long zzf3 = zzaqi.zzf(zzaqg);
            long zzf4 = zzaqi.zzf(zzaqg);
            long zzf5 = zzaqi.zzf(zzaqg);
            int zze2 = zzaqi.zze(zzaqg);
            if (zze2 >= 0) {
                List emptyList = zze2 == 0 ? Collections.emptyList() : new ArrayList();
                for (int i = 0; i < zze2; i++) {
                    emptyList.add(new zzape(zzaqi.zzh(zzaqg).intern(), zzaqi.zzh(zzaqg).intern()));
                }
                return new zzaqf(zzh2, zzh3, zzf2, zzf3, zzf4, zzf5, emptyList);
            }
