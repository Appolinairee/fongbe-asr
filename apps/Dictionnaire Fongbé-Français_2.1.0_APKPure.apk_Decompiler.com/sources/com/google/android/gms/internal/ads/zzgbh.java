...
abstract class zzgbh extends zzgbm {
    ...
    zzgbh(zzfxi zzfxi, boolean z, boolean z2) {
        super(zzfxi.size());
        zzfxi.getClass();
        zzfxi zzfxi2 = zzfxi;
        this.zzb = zzfxi;
    ...
    /* renamed from: zzH */
    public final void zzx(@CheckForNull zzfxi zzfxi) {
        int zzA = zzA();
        int i = 0;
        zzfun.zzm(zzA >= 0, "Less than 0 remaining futures");
        if (zzA == 0) {
            if (zzfxi != null) {
                zzfzt zze = zzfxi.iterator();
                while (zze.hasNext()) {
    ...
    public final String zza() {
        ...
        if (zzfxi != null) {
            return "futures=".concat(zzfxi.toString());
        }
        return super.zza();
    }
        ...
        if (this.zzb.isEmpty()) {
            ...
            while (zze.hasNext()) {
                ...
                if (listenableFuture.isDone()) {
                    ...
                    listenableFuture.addListener(new zzgbf(this, i, listenableFuture), zzgbv.INSTANCE);
                }
                i = i2;
            }
        } else {
            zzfxi zzfxi = this.zzf ? this.zzb : null;
            zzgbg zzgbg = new zzgbg(this, zzfxi);
            zzfzt zze2 = this.zzb.iterator();
            while (zze2.hasNext()) {
                ListenableFuture listenableFuture2 = (ListenableFuture) zze2.next();
                if (listenableFuture2.isDone()) {
                    zzx(zzfxi);
                } else {
                    listenableFuture2.addListener(zzgbg, zzgbv.INSTANCE);
                }
            }
        }
    }
