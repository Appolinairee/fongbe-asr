...
public final class zzcbr {
    ...
    public zzcbr(String str) {
        ...
        String str2 = (String) zzbe.zzc().zza(zzbcc);
        this.zze = zzb(jSONObject, "exo_read_timeout_millis", zzbcl.zzf);
        this.zzf = zzb(jSONObject, "load_check_interval_bytes", zzbcl.zzg);
        this.zzg = zzb(jSONObject, "player_precache_limit", zzbcl.zzh);
        this.zzh = zzb(jSONObject, "socket_receive_buffer_size", zzbcl.zzj);
    ...
    private static final boolean zza(JSONObject jSONObject, String str, zzbcc zzbcc) {
        boolean booleanValue = ((Boolean) zzbe.zzc().zza(zzbcc)).booleanValue();
        if (jSONObject == null) {
            return booleanValue;
        }
        try {
    ...
    private static final int zzb(JSONObject jSONObject, String str, zzbcc zzbcc) {
        if (jSONObject != null) {
            try {
        ...
        return ((Integer) zzbe.zzc().zza(zzbcc)).intValue();
    }

    private static final long zzc(JSONObject jSONObject, String str, zzbcc zzbcc) {
        if (jSONObject != null) {
            try {
        ...
        return ((Long) zzbe.zzc().zza(zzbcc)).longValue();
    }
}
