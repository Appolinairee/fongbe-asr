...
public final class zzfly implements zzflw {
    ...
    public zzfly(zzflw zzflw) {
        this.zza = zzflw;
    }

    public final JSONObject zza(View view) {
        boolean z = false;
        JSONObject zza2 = zzfmg.zza(0, 0, 0, 0);
        int zzb = zzfmj.zzb();
        int i = zzb - 1;
        if (zzb != 0) {
            if (i == 0) {
    ...
    public final void zzb(View view, JSONObject jSONObject, zzflv zzflv, boolean z, boolean z2) {
        ArrayList arrayList = new ArrayList();
        zzflk zza2 = zzflk.zza();
        if (zza2 != null) {
            Collection<zzfkt> zzb = zza2.zzb();
            int size = zzb.size();
        ...
        for (int i2 = 0; i2 < size3; i2++) {
            zzflv.zza((View) arrayList.get(i2), this.zza, jSONObject, z2);
        }
    }
}
