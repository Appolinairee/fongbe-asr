...
public final class zzbvg extends zzbve {
    ...
    public zzbvg(Context context, zzbnw zzbnw, VersionInfoParcel versionInfoParcel) {
    ...
    public final ListenableFuture zza() {
        ...
        if (zzv.zzC().currentTimeMillis() - j < ((Long) zzbel.zzd.zze()).longValue()) {
            return zzgch.zzh((Object) null);
        }
        return zzgch.zzm(this.zzd.zzb(zzc(this.zzb, this.zze)), new zzbvf(this), zzbzw.zzg);
    }
    ...
    public final /* synthetic */ Void zzb(JSONObject jSONObject) {
        ...
        zzbe.zzb();
        SharedPreferences zza2 = zzbce.zza(this.zzb);
        if (zza2 == null) {
            return null;
        }
