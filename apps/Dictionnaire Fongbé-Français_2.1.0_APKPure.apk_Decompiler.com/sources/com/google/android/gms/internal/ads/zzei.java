...
public final class zzei {
    ...
    public static boolean zzH(zzdy zzdy, zzdy zzdy2, Inflater inflater) {
        boolean z = false;
        if (zzdy.zzb() <= 0) {
            return false;
        }
        if (zzdy2.zzc() < zzdy.zzb()) {
            int zzb2 = zzdy.zzb();
            zzdy2.zzF(zzb2 + zzb2);
        }
        if (inflater == null) {
        ...
        inflater.setInput(zzdy.zzN(), zzdy.zzd(), zzdy.zzb());
        int i = 0;
        while (true) {
            try {
                i += inflater.inflate(zzdy2.zzN(), i, zzdy2.zzc() - i);
    ...
    public static int zza(long[] r4, long r5, boolean r7, boolean r8) {
        /*
            int r8 = java.util.Arrays.binarySearch(r4, r5)
        ...
        L_0x001a:
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzei.zza(long[], long, boolean, boolean):int");
    }

    public static int zzb(zzdp zzdp, long j, boolean z, boolean z2) {
        int zza2 = zzdp.zza() - 1;
        int i = 0;
        while (i <= zza2) {
            int i2 = (i + zza2) >>> 1;
    ...
    public static int zzc(int[] r3, int r4, boolean r5, boolean r6) {
        ...
        L_0x0021:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzei.zzc(int[], int, boolean, boolean):int");
    }
    ...
    public static int zzo(android.net.Uri r7) {
        /*
            ...
            boolean r0 = com.google.android.gms.internal.ads.zzftt.zzc(r2, r0)
    ...
    public static Point zzw(Context context) {
        ...
        if (display.getDisplayId() == 0 && zzM(context)) {
            if (zza < 28) {
                str = zzQ("sys.display-size");
            } else {
                str = zzQ("vendor.display-size");
            }
            if (!TextUtils.isEmpty(str)) {
                ...
                zzdo.zzc("Util", "Invalid display size: ".concat(String.valueOf(str)));
            }
    ...
    public static void zzF(long[] jArr, long j, long j2) {
        ...
        long j3 = j2;
        int i = 0;
        int i2 = (j3 > 1000000 ? 1 : (j3 == 1000000 ? 0 : -1));
        RoundingMode roundingMode = RoundingMode.DOWN;
        if (i2 >= 0 && j3 % 1000000 == 0) {
            long zzb2 = zzgal.zzb(j3, 1000000, RoundingMode.UNNECESSARY);
            while (i < jArr2.length) {
                jArr2[i] = zzgal.zzb(jArr2[i], zzb2, roundingMode);
                i++;
            }
        } else if (i2 >= 0 || 1000000 % j3 != 0) {
            for (int i3 = 0; i3 < jArr2.length; i3++) {
                long j4 = jArr2[i3];
                if (j4 != 0) {
                    int i4 = (j3 > j4 ? 1 : (j3 == j4 ? 0 : -1));
                    if (i4 >= 0 && j3 % j4 == 0) {
                        jArr2[i3] = zzgal.zzb(1000000, zzgal.zzb(j3, j4, RoundingMode.UNNECESSARY), roundingMode);
                    } else if (i4 >= 0 || j4 % j3 != 0) {
                        jArr2[i3] = zzP(j4, 1000000, j2, roundingMode);
                    } else {
                        jArr2[i3] = zzgal.zzd(1000000, zzgal.zzb(j4, j3, RoundingMode.UNNECESSARY));
                    }
                }
            }
        } else {
            long zzb3 = zzgal.zzb(1000000, j3, RoundingMode.UNNECESSARY);
            while (i < jArr2.length) {
                jArr2[i] = zzgal.zzd(jArr2[i], zzb3);
                i++;
            }
        }
    }
