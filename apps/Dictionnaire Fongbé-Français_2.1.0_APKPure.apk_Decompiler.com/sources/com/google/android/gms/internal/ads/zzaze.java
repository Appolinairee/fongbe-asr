...
public final class zzaze {
    ...
    public final Activity zza() {
        synchronized (this.zza) {
            zzazc zzazc = this.zzb;
            if (zzazc == null) {
                return null;
            }
            Activity zza2 = zzazc.zza();
            return zza2;
        }
    }
    ...
    public final Context zzb() {
        synchronized (this.zza) {
            ...
            Context zzb2 = zzazc.zzb();
            return zzb2;
        }
    }

    public final void zzc(zzazd zzazd) {
        synchronized (this.zza) {
            if (this.zzb == null) {
                this.zzb = new zzazc();
            }
    ...
    public final void zzd(android.content.Context r4) {
        ...
        L_0x0016:
            ...
            com.google.android.gms.ads.internal.util.client.zzo.zzj(r4)     // Catch:{ all -> 0x0034 }
            monitor-exit(r0)     // Catch:{ all -> 0x0034 }
            return
        L_0x001f:
            com.google.android.gms.internal.ads.zzazc r2 = r3.zzb     // Catch:{ all -> 0x0034 }
            if (r2 != 0) goto L_0x002a
            com.google.android.gms.internal.ads.zzazc r2 = new com.google.android.gms.internal.ads.zzazc     // Catch:{ all -> 0x0034 }
        ...
        L_0x0034:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzaze.zzd(android.content.Context):void");
    }
