...
final class zzftn {
    ...
    zzftn(Context context, zzfto zzfto, String str, Intent intent, zzfss zzfss) {
        this.zzb = context;
        this.zzc = zzfto;
        this.zzd = "OverlayDisplayService";
        this.zzg = intent;
        this.zza = zzfvj.zza(new zzfte("OverlayDisplayService"));
        this.zzh = new zzftf(this);
    }

    /* access modifiers changed from: private */
    public final void zzo(Runnable runnable) {
        ((Handler) this.zza.zza()).post(new zzftg(this, runnable));
    }
    ...
    public final /* synthetic */ void zzj(Runnable runnable) {
        if (this.zzj == null && !this.zzf) {
            ...
            zzftl zzftl = new zzftl(this, (zzftm) null);
            this.zzi = zzftl;
            this.zzf = true;
            if (!this.zzb.bindService(this.zzg, zzftl, 1)) {
