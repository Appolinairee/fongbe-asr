...
public final class zzawk implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener, Application.ActivityLifecycleCallbacks {
    ...
    public zzawk(Context context, zzavw zzavw) {
    ...
    private final void zzh(View view) {
        ...
        if (this.zzf == null) {
            ...
            zzawj zzawj = new zzawj(this);
            this.zzf = zzawj;
            this.zzb.registerReceiver(zzawj, intentFilter);
        }
    ...
    private final void zzi(android.view.View r4) {
        ...
        L_0x0038:
            ...
            com.google.android.gms.internal.ads.zzavs r0 = r3.zzj     // Catch:{ Exception -> 0x0041 }
            r4.unregisterActivityLifecycleCallbacks(r0)     // Catch:{ Exception -> 0x0041 }
        L_0x0041:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzawk.zzi(android.view.View):void");
    }
