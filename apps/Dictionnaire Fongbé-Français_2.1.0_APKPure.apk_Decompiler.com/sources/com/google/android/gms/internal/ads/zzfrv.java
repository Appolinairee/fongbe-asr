...
final class zzfrv extends zzfsy {
    ...
    /* synthetic */ zzfrv(IBinder iBinder, String str, int i, float f, int i2, int i3, String str2, int i4, String str3, String str4, String str5, zzfru zzfru) {
        this.zza = iBinder;
        this.zzb = str;
        this.zzc = i;
        this.zzd = f;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof zzfsy) {
            zzfsy zzfsy = (zzfsy) obj;
            if (this.zza.equals(zzfsy.zzf()) && ((str = this.zzb) != null ? str.equals(zzfsy.zzh()) : zzfsy.zzh() == null) && this.zzc == zzfsy.zzc() && Float.floatToIntBits(this.zzd) == Float.floatToIntBits(zzfsy.zza())) {
                zzfsy.zzb();
                zzfsy.zzd();
                zzfsy.zzj();
                if (this.zze == zzfsy.zze()) {
                    zzfsy.zzi();
                    String str2 = this.zzf;
                    if (str2 != null ? str2.equals(zzfsy.zzg()) : zzfsy.zzg() == null) {
                        zzfsy.zzk();
                        return true;
                    }
                }
