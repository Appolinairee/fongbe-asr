...
public final class zzel {
    ...
    public final AdSize zzb() {
        ...
        try {
            ...
            if (!(zzby == null || (zzg2 = zzby.zzg()) == null)) {
                return zzc.zzc(zzg2.zze, zzg2.zzb, zzg2.zza);
            }
        } catch (RemoteException e) {
            zzo.zzl("#007 Could not call remote method.", e);
        }
    ...
    public final void zzv(AppEventListener appEventListener) {
        try {
            ...
            zzby zzby = this.zzj;
            if (zzby != null) {
                zzby.zzG(appEventListener != null ? new zzayy(appEventListener) : null);
            }
        } catch (RemoteException e) {
            zzo.zzl("#007 Could not call remote method.", e);
        }
            ...
            try {
                ...
                if (viewGroup.isInEditMode()) {
                    ...
                    if (adSize.equals(AdSize.INVALID)) {
                        ...
                        zzs zzs2 = new zzs(context, adSize);
                        zzs2.zzj = zzE(i2);
                        zzs = zzs2;
                    }
                    zzb2.zzm(viewGroup2, zzs, "Ads by Google");
                }
            } catch (IllegalArgumentException e) {
                zzbc.zzb().zzl(viewGroup2, new zzs(context, AdSize.BANNER), e.getMessage(), e.getMessage());
            }
        }
    }
}
