...
public final class zzbv {
    ...
    public static WindowManager.LayoutParams zzb() {
        ...
        layoutParams.flags = ((Integer) zzbe.zzc().zza(zzbcl.zzhT)).intValue();
        layoutParams.type = 2;
            ...
            while (it.hasNext()) {
                ...
                if (view2 != null) {
                    ...
                    try {
                        ...
                        try {
                            jSONObject5.put("width", zzbc.zzb().zzb(context2, view2.getMeasuredWidth()));
                            jSONObject5.put("height", zzbc.zzb().zzb(context2, view2.getMeasuredHeight()));
                            jSONObject5.put("x", zzbc.zzb().zzb(context2, zzj2[0] - zzj[0]));
                            jSONObject5.put("y", zzbc.zzb().zzb(context2, zzj2[1] - zzj[1]));
                            ...
                            if (view2.getLocalVisibleRect(rect)) {
                                ...
                                jSONObject2.put("x", zzbc.zzb().zzb(context2, zzj2[0] - zzj[0]));
                                jSONObject2.put("y", zzbc.zzb().zzb(context2, zzj2[1] - zzj[1]));
    ...
    /* JADX WARNING: Removed duplicated region for block: B:44:0x015c A[Catch:{ JSONException -> 0x0161 }] */
    /* JADX WARNING: Removed duplicated region for block: B:49:0x0179 A[SYNTHETIC, Splitter:B:49:0x0179] */
    ...
    public static org.json.JSONObject zzg(android.content.Context r16, android.view.View r17) {
        ...
        L_0x0059:
            ...
            com.google.android.gms.ads.internal.util.client.zzf r14 = com.google.android.gms.ads.internal.client.zzbc.zzb()     // Catch:{ Exception -> 0x00fe }
            ...
            com.google.android.gms.ads.internal.util.client.zzf r10 = com.google.android.gms.ads.internal.client.zzbc.zzb()     // Catch:{ Exception -> 0x00fe }
            ...
            com.google.android.gms.ads.internal.util.client.zzf r15 = com.google.android.gms.ads.internal.client.zzbc.zzb()     // Catch:{ Exception -> 0x00fe }
        ...
        L_0x00ce:
            ...
            com.google.android.gms.ads.internal.util.client.zzf r7 = com.google.android.gms.ads.internal.client.zzbc.zzb()     // Catch:{ Exception -> 0x00fe }
            int r6 = r7.zzb(r0, r6)     // Catch:{ Exception -> 0x00fe }
            r9.put(r5, r6)     // Catch:{ Exception -> 0x00fe }
            r5 = 1
            r6 = r12[r5]     // Catch:{ Exception -> 0x00fe }
            com.google.android.gms.ads.internal.util.client.zzf r5 = com.google.android.gms.ads.internal.client.zzbc.zzb()     // Catch:{ Exception -> 0x00fe }
        ...
        L_0x0103:
            ...
            java.lang.Class r2 = r0.getClass()     // Catch:{ NoSuchMethodException -> 0x0125, SecurityException -> 0x011f, IllegalAccessException -> 0x011d, InvocationTargetException -> 0x011b }
            java.lang.String r3 = "getTemplateTypeName"
            r4 = 0
            java.lang.reflect.Method r2 = r2.getMethod(r3, r4)     // Catch:{ NoSuchMethodException -> 0x0125, SecurityException -> 0x011f, IllegalAccessException -> 0x011d, InvocationTargetException -> 0x011b }
            java.lang.Object r0 = r2.invoke(r0, r4)     // Catch:{ NoSuchMethodException -> 0x0125, SecurityException -> 0x011f, IllegalAccessException -> 0x011d, InvocationTargetException -> 0x011b }
            java.lang.String r0 = (java.lang.String) r0     // Catch:{ NoSuchMethodException -> 0x0125, SecurityException -> 0x011f, IllegalAccessException -> 0x011d, InvocationTargetException -> 0x011b }
            goto L_0x0127
        L_0x011b:
            r0 = move-exception
            goto L_0x0120
        ...
        L_0x0127:
            r10 = -1
            int r2 = r0.hashCode()     // Catch:{ JSONException -> 0x0161 }
        ...
        L_0x014c:
            ...
            r8.put(r2, r11)     // Catch:{ JSONException -> 0x0161 }
            goto L_0x0167
        L_0x0157:
            r3 = 2
            r8.put(r2, r3)     // Catch:{ JSONException -> 0x0161 }
            goto L_0x0167
        L_0x015c:
            r3 = 1
            r8.put(r2, r3)     // Catch:{ JSONException -> 0x0161 }
        ...
        L_0x0161:
            ...
            com.google.android.gms.ads.internal.util.client.zzo.zzh(r2, r0)
        L_0x0167:
            com.google.android.gms.internal.ads.zzbcc r0 = com.google.android.gms.internal.ads.zzbcl.zzhP
            ...
            android.view.ViewGroup$LayoutParams r0 = r17.getLayoutParams()     // Catch:{ Exception -> 0x0196 }
            java.lang.String r1 = "view_width_layout_type"
            int r2 = r0.width     // Catch:{ Exception -> 0x0196 }
            int r2 = zzl(r2)     // Catch:{ Exception -> 0x0196 }
            int r2 = r2 + r10
            r8.put(r1, r2)     // Catch:{ Exception -> 0x0196 }
            java.lang.String r1 = "view_height_layout_type"
            int r0 = r0.height     // Catch:{ Exception -> 0x0196 }
            int r0 = zzl(r0)     // Catch:{ Exception -> 0x0196 }
            int r0 = r0 + r10
            r8.put(r1, r0)     // Catch:{ Exception -> 0x0196 }
            goto L_0x019b
        L_0x0196:
    ...
    public static boolean zzh(Context context, zzfbo zzfbo) {
        if (!zzfbo.zzN) {
            return false;
        }
        ...
        String str = (String) zzbe.zzc().zza(zzbcl.zzhS);
        if (!str.isEmpty() && context != null) {
            String packageName = context.getPackageName();
            for (String equals : zzfvc.zzb(zzfty.zzc(';')).zzd(str)) {
    ...
    public static boolean zzi(int i) {
        ...
        return ((Boolean) zzbe.zzc().zza(zzbcl.zzdC)).booleanValue() || i <= 15299999;
    }
