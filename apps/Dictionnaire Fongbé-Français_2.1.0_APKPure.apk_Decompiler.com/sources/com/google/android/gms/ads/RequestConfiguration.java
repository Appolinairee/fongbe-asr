...
public class RequestConfiguration {
    ...
    public static class Builder {
        ...
        public RequestConfiguration build() {
            return new RequestConfiguration(this.zza, this.zzb, this.zzc, this.zzd, this.zze, (zzi) null);
        }
    ...
    /* synthetic */ RequestConfiguration(int i, int i2, String str, List list, PublisherPrivacyPersonalizationState publisherPrivacyPersonalizationState, zzi zzi) {
        this.zzb = i;
        this.zzc = i2;
        this.zzd = str;
        this.zze = list;
