...
public final class zzf {
    ...
    zzf(Context context, zzbbu zzbbu, List list, VersionInfoParcel versionInfoParcel) {
        this.zza = context;
        ...
        if (!this.zzf.getAndSet(true)) {
            ...
            if (packageInfo != null) {
                try {
                    ...
                    zzv.zzp().zzw(e, "PawAppSignalGenerator.initialize");
                    return;
                }
            }
            ...
            for (String str : ((String) zzbe.zzc().zza(zzbcl.zzjG)).split(",", -1)) {
