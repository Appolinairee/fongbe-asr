...
public final class zzu extends zzbx {
    ...
    /* access modifiers changed from: private */
    public final Future zzc = zzbzw.zza.zzb(new zzq(this));
    /* access modifiers changed from: private */
    ...
    public final int zzb(String str) {
        ...
        try {
            zzbc.zzb();
            return zzf.zzx(this.zzd, Integer.parseInt(queryParameter));
    ...
    public final String zzp() {
        ...
        zzava zzava = this.zzh;
        if (zzava != null) {
            try {
                build = zzava.zzb(build, this.zzd);
            } catch (zzavb e) {
                zzo.zzk("Unable to process ad data", e);
            }
        }
    ...
    public final String zzq() {
        ...
        return "https://" + zzb2 + ((String) zzbdx.zzd.zze());
    }
