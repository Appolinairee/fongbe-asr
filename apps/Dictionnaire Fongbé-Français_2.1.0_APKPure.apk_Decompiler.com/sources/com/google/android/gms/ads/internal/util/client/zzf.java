...
public final class zzf {
    ...
    private static final void zzD(ViewGroup viewGroup, zzs zzs, String str, int i, int i2) {
        if (viewGroup.getChildCount() == 0) {
            ...
            frameLayout.addView(textView, new FrameLayout.LayoutParams(zzs.zzf - zzx, zzs.zzc - zzx, 17));
            viewGroup.addView(frameLayout, zzs.zzf, zzs.zzc);
        }
    }
    ...
    public static final void zzw(Context context, String str, String str2, Bundle bundle, boolean z, zze zze2) {
    ...
    public final void zzl(ViewGroup viewGroup, zzs zzs, String str, String str2) {
        if (str2 != null) {
            zzo.zzj(str2);
        }
        zzD(viewGroup, zzs, str, SupportMenu.CATEGORY_MASK, ViewCompat.MEASURED_STATE_MASK);
    }

    public final void zzm(ViewGroup viewGroup, zzs zzs, String str) {
        zzD(viewGroup, zzs, "Ads by Google", ViewCompat.MEASURED_STATE_MASK, -1);
    }

    public final void zzn(Context context, String str, String str2, Bundle bundle, boolean z) {
        zzw(context, str, "gmob-apps", bundle, true, new zzc(this));
    }
}
