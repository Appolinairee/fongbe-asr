...
public final class NativeAdView extends FrameLayout {
    ...
    private final void zzf(String str, View view) {
        zzbga zzbga = this.zzb;
        if (zzbga != null) {
            try {
                zzbga.zzdt(str, ObjectWrapper.wrap(view));
    ...
    public final void onVisibilityChanged(View view, int i) {
        ...
        if (zzbga != null) {
            try {
                zzbga.zze(ObjectWrapper.wrap(view), i);
            } catch (RemoteException e) {
    ...
    public final void setClickConfirmingView(View view) {
        ...
        if (zzbga != null) {
            try {
                zzbga.zzdu(ObjectWrapper.wrap(view));
            } catch (RemoteException e) {
    ...
    public void setNativeAd(NativeAd nativeAd) {
        ...
        if (zzbga != null) {
            try {
                zzbga.zzdx((IObjectWrapper) nativeAd.zza());
            } catch (RemoteException e) {
    ...
    public final View zza(String str) {
        ...
        if (zzbga != null) {
            try {
                IObjectWrapper zzb2 = zzbga.zzb(str);
                if (zzb2 != null) {
        ...
        if (zzbga != null) {
            try {
                if (mediaContent instanceof zzfd) {
                    zzbga.zzdv(((zzfd) mediaContent).zzc());
                } else if (mediaContent == null) {
                    zzbga.zzdv((zzbft) null);
                } else {
    ...
    public final /* synthetic */ void zzc(ImageView.ScaleType scaleType) {
        zzbga zzbga = this.zzb;
        if (zzbga != null && scaleType != null) {
            try {
                zzbga.zzdw(ObjectWrapper.wrap(scaleType));
            } catch (RemoteException e) {
