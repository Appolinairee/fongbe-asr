...
public abstract class InterstitialAd {
    ...
    public static void load(Context context, String str, AdRequest adRequest, InterstitialAdLoadCallback interstitialAdLoadCallback) {
        ...
        if (((Boolean) zzbej.zzi.zze()).booleanValue()) {
            if (((Boolean) zzbe.zzc().zza(zzbcl.zzla)).booleanValue()) {
                com.google.android.gms.ads.internal.util.client.zzb.zzb.execute(new zza(context, str, adRequest, interstitialAdLoadCallback));
                return;
            }
        }
    ...
    public static InterstitialAd pollAd(Context context, String str) {
        try {
            ...
            zzo.zzl("Failed to obtain an Interstitial Ad from the preloader.", (Throwable) null);
            return null;
        } catch (RemoteException e) {
            zzo.zzl("#007 Could not call remote method.", e);
            return null;
