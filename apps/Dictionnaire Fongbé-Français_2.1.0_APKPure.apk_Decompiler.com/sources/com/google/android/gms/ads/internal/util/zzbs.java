...
public final class zzbs {
            ...
            if (opt != null) {
                if (opt instanceof Boolean) {
                    ...
                    if (jSONArray.length() != 0) {
                        ...
                        if (obj == null) {
                            zzo.zzj("Expected JSONArray with at least 1 non-null element for key:".concat(String.valueOf(next)));
                            ...
                            zzo.zzj(String.format("JSONArray with unsupported type %s for key:%s", new Object[]{obj.getClass().getCanonicalName(), next}));
                        }
                    }
                } else if (opt instanceof JSONObject) {
                    bundle.putBundle(next, zza((JSONObject) opt));
                } else {
                    zzo.zzj("Unsupported type for key:".concat(String.valueOf(next)));
                }
            }
        }
        return bundle;
    ...
    public static String zzm(zzfbt zzfbt) {
        if (zzfbt == null) {
            return null;
        }
