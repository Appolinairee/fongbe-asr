...
public final class zzu extends FrameLayout implements View.OnClickListener {
    ...
    public zzu(Context context, zzt zzt, zzag zzag) {
        ...
        zzbc.zzb();
        int zzx = zzf.zzx(context, zzt.zza);
        zzbc.zzb();
        int zzx2 = zzf.zzx(context, 0);
        zzbc.zzb();
        int zzx3 = zzf.zzx(context, zzt.zzb);
        zzbc.zzb();
        imageButton.setPadding(zzx, zzx2, zzx3, zzf.zzx(context, zzt.zzc));
        imageButton.setContentDescription("Interstitial close button");
        zzbc.zzb();
        int zzx4 = zzf.zzx(context, zzt.zzd + zzt.zza + zzt.zzb);
        zzbc.zzb();
        addView(imageButton, new FrameLayout.LayoutParams(zzx4, zzf.zzx(context, zzt.zzd + zzt.zzc), 17));
        long longValue = ((Long) zzbe.zzc().zza(zzbcl.zzbl)).longValue();
        if (longValue > 0) {
            zzs zzs = ((Boolean) zzbe.zzc().zza(zzbcl.zzbm)).booleanValue() ? new zzs(this) : null;
