...
public final class zzcj {
    ...
    public static java.util.List zza(java.lang.String r13) {
        ...
        L_0x0071:
            ...
            int r11 = r10.profile     // Catch:{ RuntimeException -> 0x010a, LinkageError -> 0x0108 }
            java.lang.Integer r11 = java.lang.Integer.valueOf(r11)     // Catch:{ RuntimeException -> 0x010a, LinkageError -> 0x0108 }
            ...
            r12 = 2
            java.lang.Integer[] r12 = new java.lang.Integer[r12]     // Catch:{ RuntimeException -> 0x010a, LinkageError -> 0x0108 }
            r12[r2] = r11     // Catch:{ RuntimeException -> 0x010a, LinkageError -> 0x0108 }
            r11 = 1
            r12[r11] = r10     // Catch:{ RuntimeException -> 0x010a, LinkageError -> 0x0108 }
            r6.add(r12)     // Catch:{ RuntimeException -> 0x010a, LinkageError -> 0x0108 }
            int r9 = r9 + 1
            goto L_0x0071
        L_0x008f:
            java.lang.String r7 = "profileLevels"
            r5.put(r7, r6)     // Catch:{ RuntimeException -> 0x010a, LinkageError -> 0x0108 }
            android.media.MediaCodecInfo$VideoCapabilities r6 = r4.getVideoCapabilities()     // Catch:{ RuntimeException -> 0x010a, LinkageError -> 0x0108 }
            java.lang.String r7 = "bitRatesBps"
            android.util.Range r8 = r6.getBitrateRange()     // Catch:{ RuntimeException -> 0x010a, LinkageError -> 0x0108 }
            java.lang.Integer[] r8 = zzb(r8)     // Catch:{ RuntimeException -> 0x010a, LinkageError -> 0x0108 }
            r5.put(r7, r8)     // Catch:{ RuntimeException -> 0x010a, LinkageError -> 0x0108 }
            java.lang.String r7 = "widthAlignment"
            int r8 = r6.getWidthAlignment()     // Catch:{ RuntimeException -> 0x010a, LinkageError -> 0x0108 }
            java.lang.Integer r8 = java.lang.Integer.valueOf(r8)     // Catch:{ RuntimeException -> 0x010a, LinkageError -> 0x0108 }
            r5.put(r7, r8)     // Catch:{ RuntimeException -> 0x010a, LinkageError -> 0x0108 }
            java.lang.String r7 = "heightAlignment"
            int r8 = r6.getHeightAlignment()     // Catch:{ RuntimeException -> 0x010a, LinkageError -> 0x0108 }
            java.lang.Integer r8 = java.lang.Integer.valueOf(r8)     // Catch:{ RuntimeException -> 0x010a, LinkageError -> 0x0108 }
            r5.put(r7, r8)     // Catch:{ RuntimeException -> 0x010a, LinkageError -> 0x0108 }
            java.lang.String r7 = "frameRates"
            android.util.Range r8 = r6.getSupportedFrameRates()     // Catch:{ RuntimeException -> 0x010a, LinkageError -> 0x0108 }
            java.lang.Integer[] r8 = zzb(r8)     // Catch:{ RuntimeException -> 0x010a, LinkageError -> 0x0108 }
            r5.put(r7, r8)     // Catch:{ RuntimeException -> 0x010a, LinkageError -> 0x0108 }
            java.lang.String r7 = "widths"
            android.util.Range r8 = r6.getSupportedWidths()     // Catch:{ RuntimeException -> 0x010a, LinkageError -> 0x0108 }
            java.lang.Integer[] r8 = zzb(r8)     // Catch:{ RuntimeException -> 0x010a, LinkageError -> 0x0108 }
            r5.put(r7, r8)     // Catch:{ RuntimeException -> 0x010a, LinkageError -> 0x0108 }
            java.lang.String r7 = "heights"
            android.util.Range r6 = r6.getSupportedHeights()     // Catch:{ RuntimeException -> 0x010a, LinkageError -> 0x0108 }
            java.lang.Integer[] r6 = zzb(r6)     // Catch:{ RuntimeException -> 0x010a, LinkageError -> 0x0108 }
            r5.put(r7, r6)     // Catch:{ RuntimeException -> 0x010a, LinkageError -> 0x0108 }
        ...
        L_0x012c:
            ...
            throw r13
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.ads.internal.util.zzcj.zza(java.lang.String):java.util.List");
    }
