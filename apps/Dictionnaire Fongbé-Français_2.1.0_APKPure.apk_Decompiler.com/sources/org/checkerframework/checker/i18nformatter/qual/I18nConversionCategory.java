...
public enum I18nConversionCategory {
    ...
    public String toString() {
        ...
        if (this.types == null) {
            ...
            StringJoiner m = NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m((CharSequence) ", ", (CharSequence) " conversion category (one of: ", (CharSequence) ")");
            for (Class<?> canonicalName : this.types) {
                StringJoiner unused = m.add(canonicalName.getCanonicalName());
            }
            sb.append(m);
        }
        return sb.toString();
