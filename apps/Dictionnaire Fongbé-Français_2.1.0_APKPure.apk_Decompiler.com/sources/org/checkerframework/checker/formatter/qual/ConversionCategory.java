...
public enum ConversionCategory {
    ...
    public String toString() {
        ...
        StringJoiner m = NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m((CharSequence) ", ", (CharSequence) "(one of: ", (CharSequence) ")");
        for (Class<?> simpleName : this.types) {
            StringJoiner unused = m.add(simpleName.getSimpleName());
        }
        sb.append(" ");
        sb.append(m);
        return sb.toString();
