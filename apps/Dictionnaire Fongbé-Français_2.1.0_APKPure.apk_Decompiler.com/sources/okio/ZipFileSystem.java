...
public final class ZipFileSystem extends FileSystem {
    ...
    public okio.FileMetadata metadataOrNull(okio.Path r15) {
        ...
        L_0x004c:
            ...
            r2 = r1
            okio.FileHandle r2 = (okio.FileHandle) r2     // Catch:{ all -> 0x006d }
            long r3 = r15.getOffset()     // Catch:{ all -> 0x006d }
            okio.Source r15 = r2.source(r3)     // Catch:{ all -> 0x006d }
            okio.BufferedSource r15 = okio.Okio.buffer((okio.Source) r15)     // Catch:{ all -> 0x006d }
