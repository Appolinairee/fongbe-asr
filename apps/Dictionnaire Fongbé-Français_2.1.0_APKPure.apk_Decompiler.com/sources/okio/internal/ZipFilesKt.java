...
public final class ZipFilesKt {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x0075, code lost:
        if (r7.readIntLe() != ZIP64_LOCATOR_SIGNATURE) goto L_0x00e0;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:19:0x0084, code lost:
        if (r7.readIntLe() != 1) goto L_0x00d8;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:58:?, code lost:
        r7 = (okio.BufferedSource) r5;
        r12 = r10.getEntryCount();
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:62:0x011d, code lost:
        if (r14.getOffset() >= r10.getCentralDirectoryOffset()) goto L_0x0135;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:64:0x0129, code lost:
        if (r2.invoke(r14).booleanValue() == false) goto L_0x0131;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:71:?, code lost:
        ...
        r5 = new okio.ZipFileSystem(r0, r1, buildIndex(r6), r11);
     */
    ...
    public static final okio.ZipFileSystem openZip(okio.Path r20, okio.FileSystem r21, kotlin.jvm.functions.Function1<? super okio.internal.ZipEntry, java.lang.Boolean> r22) throws java.io.IOException {
        /*
            ...
            r5 = r4
            okio.FileHandle r5 = (okio.FileHandle) r5     // Catch:{ all -> 0x0187 }
            long r6 = r5.size()     // Catch:{ all -> 0x0187 }
            r8 = 22
            long r8 = (long) r8     // Catch:{ all -> 0x0187 }
            long r6 = r6 - r8
            r8 = 0
            ...
            long r10 = r6 - r10
            long r10 = java.lang.Math.max(r10, r8)     // Catch:{ all -> 0x0187 }
        L_0x0037:
            okio.Source r3 = r5.source(r6)     // Catch:{ all -> 0x0187 }
            okio.BufferedSource r3 = okio.Okio.buffer((okio.Source) r3)     // Catch:{ all -> 0x0187 }
            int r12 = r3.readIntLe()     // Catch:{ all -> 0x016c }
            r13 = 101010256(0x6054b50, float:2.506985E-35)
            if (r12 != r13) goto L_0x0158
            okio.internal.EocdRecord r10 = readEocdRecord(r3)     // Catch:{ all -> 0x016c }
            int r11 = r10.getCommentByteCount()     // Catch:{ all -> 0x016c }
            long r11 = (long) r11     // Catch:{ all -> 0x016c }
            java.lang.String r11 = r3.readUtf8(r11)     // Catch:{ all -> 0x016c }
            r3.close()     // Catch:{ all -> 0x0187 }
            r3 = 20
            long r12 = (long) r3     // Catch:{ all -> 0x0187 }
            long r6 = r6 - r12
            r3 = 0
            int r12 = (r6 > r8 ? 1 : (r6 == r8 ? 0 : -1))
            if (r12 <= 0) goto L_0x00ef
            okio.Source r6 = r5.source(r6)     // Catch:{ all -> 0x0187 }
            okio.BufferedSource r6 = okio.Okio.buffer((okio.Source) r6)     // Catch:{ all -> 0x0187 }
            java.io.Closeable r6 = (java.io.Closeable) r6     // Catch:{ all -> 0x0187 }
            r7 = r6
            okio.BufferedSource r7 = (okio.BufferedSource) r7     // Catch:{ all -> 0x00e6 }
            int r12 = r7.readIntLe()     // Catch:{ all -> 0x00e6 }
            r13 = 117853008(0x7064b50, float:1.0103172E-34)
            if (r12 != r13) goto L_0x00e0
            int r12 = r7.readIntLe()     // Catch:{ all -> 0x00e6 }
            long r13 = r7.readLongLe()     // Catch:{ all -> 0x00e6 }
            int r7 = r7.readIntLe()     // Catch:{ all -> 0x00e6 }
            r15 = 1
            if (r7 != r15) goto L_0x00d8
            if (r12 != 0) goto L_0x00d8
            okio.Source r7 = r5.source(r13)     // Catch:{ all -> 0x00e6 }
            okio.BufferedSource r7 = okio.Okio.buffer((okio.Source) r7)     // Catch:{ all -> 0x00e6 }
            java.io.Closeable r7 = (java.io.Closeable) r7     // Catch:{ all -> 0x00e6 }
            r12 = r7
            okio.BufferedSource r12 = (okio.BufferedSource) r12     // Catch:{ all -> 0x00cf }
            int r13 = r12.readIntLe()     // Catch:{ all -> 0x00cf }
            r14 = 101075792(0x6064b50, float:2.525793E-35)
            if (r13 != r14) goto L_0x00a8
            okio.internal.EocdRecord r10 = readZip64EocdRecord(r12, r10)     // Catch:{ all -> 0x00cf }
            kotlin.Unit r12 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00cf }
            kotlin.io.CloseableKt.closeFinally(r7, r3)     // Catch:{ all -> 0x00e6 }
            goto L_0x00e0
        L_0x00a8:
            ...
            java.lang.String r2 = getHex(r14)     // Catch:{ all -> 0x00cf }
            r1.append(r2)     // Catch:{ all -> 0x00cf }
            java.lang.String r2 = " but was "
            r1.append(r2)     // Catch:{ all -> 0x00cf }
            java.lang.String r2 = getHex(r13)     // Catch:{ all -> 0x00cf }
            r1.append(r2)     // Catch:{ all -> 0x00cf }
        ...
        L_0x00d2:
            r0 = move-exception
            r2 = r0
            kotlin.io.CloseableKt.closeFinally(r7, r1)     // Catch:{ all -> 0x00e6 }
            throw r2     // Catch:{ all -> 0x00e6 }
        L_0x00d8:
            java.io.IOException r0 = new java.io.IOException     // Catch:{ all -> 0x00e6 }
            java.lang.String r1 = "unsupported zip: spanned"
            r0.<init>(r1)     // Catch:{ all -> 0x00e6 }
            throw r0     // Catch:{ all -> 0x00e6 }
        L_0x00e0:
            kotlin.Unit r7 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00e6 }
            kotlin.io.CloseableKt.closeFinally(r6, r3)     // Catch:{ all -> 0x0187 }
            goto L_0x00ef
        L_0x00e6:
            r0 = move-exception
            r1 = r0
        ...
        L_0x00e9:
            r0 = move-exception
            r2 = r0
            kotlin.io.CloseableKt.closeFinally(r6, r1)     // Catch:{ all -> 0x0187 }
            throw r2     // Catch:{ all -> 0x0187 }
        L_0x00ef:
            java.util.ArrayList r6 = new java.util.ArrayList     // Catch:{ all -> 0x0187 }
            r6.<init>()     // Catch:{ all -> 0x0187 }
            java.util.List r6 = (java.util.List) r6     // Catch:{ all -> 0x0187 }
            long r12 = r10.getCentralDirectoryOffset()     // Catch:{ all -> 0x0187 }
            okio.Source r5 = r5.source(r12)     // Catch:{ all -> 0x0187 }
            okio.BufferedSource r5 = okio.Okio.buffer((okio.Source) r5)     // Catch:{ all -> 0x0187 }
            java.io.Closeable r5 = (java.io.Closeable) r5     // Catch:{ all -> 0x0187 }
            r7 = r5
            okio.BufferedSource r7 = (okio.BufferedSource) r7     // Catch:{ all -> 0x014f }
            long r12 = r10.getEntryCount()     // Catch:{ all -> 0x014f }
        L_0x010b:
            int r14 = (r8 > r12 ? 1 : (r8 == r12 ? 0 : -1))
            if (r14 >= 0) goto L_0x013d
            okio.internal.ZipEntry r14 = readEntry(r7)     // Catch:{ all -> 0x014f }
            long r15 = r14.getOffset()     // Catch:{ all -> 0x014f }
            long r17 = r10.getCentralDirectoryOffset()     // Catch:{ all -> 0x014f }
            int r19 = (r15 > r17 ? 1 : (r15 == r17 ? 0 : -1))
            if (r19 >= 0) goto L_0x0135
            java.lang.Object r15 = r2.invoke(r14)     // Catch:{ all -> 0x014f }
            java.lang.Boolean r15 = (java.lang.Boolean) r15     // Catch:{ all -> 0x014f }
            boolean r15 = r15.booleanValue()     // Catch:{ all -> 0x014f }
            if (r15 == 0) goto L_0x0131
            r15 = r6
            java.util.Collection r15 = (java.util.Collection) r15     // Catch:{ all -> 0x014f }
            r15.add(r14)     // Catch:{ all -> 0x014f }
        L_0x0131:
            r14 = 1
            long r8 = r8 + r14
            goto L_0x010b
        L_0x0135:
            java.io.IOException r0 = new java.io.IOException     // Catch:{ all -> 0x014f }
        ...
        L_0x013d:
            kotlin.Unit r2 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x014f }
            kotlin.io.CloseableKt.closeFinally(r5, r3)     // Catch:{ all -> 0x0187 }
            java.util.Map r2 = buildIndex(r6)     // Catch:{ all -> 0x0187 }
            okio.ZipFileSystem r5 = new okio.ZipFileSystem     // Catch:{ all -> 0x0187 }
            r5.<init>(r0, r1, r2, r11)     // Catch:{ all -> 0x0187 }
        ...
        L_0x0152:
            r0 = move-exception
            r2 = r0
            kotlin.io.CloseableKt.closeFinally(r5, r1)     // Catch:{ all -> 0x0187 }
            throw r2     // Catch:{ all -> 0x0187 }
        L_0x0158:
            r3.close()     // Catch:{ all -> 0x0187 }
            r12 = -1
            ...
            goto L_0x0037
        L_0x0164:
            java.io.IOException r0 = new java.io.IOException     // Catch:{ all -> 0x0187 }
        ...
        L_0x0171:
            ...
            r1.<init>(r3)     // Catch:{ all -> 0x0187 }
            long r2 = r5.size()     // Catch:{ all -> 0x0187 }
            r1.append(r2)     // Catch:{ all -> 0x0187 }
            java.lang.String r1 = r1.toString()     // Catch:{ all -> 0x0187 }
            r0.<init>(r1)     // Catch:{ all -> 0x0187 }
            throw r0     // Catch:{ all -> 0x0187 }
        L_0x0187:
            r0 = move-exception
        ...
        if (readIntLe == CENTRAL_FILE_HEADER_SIGNATURE) {
            ...
            if ((readShortLe & 1) == 0) {
                ...
                if (!StringsKt.contains$default((CharSequence) readUtf8, 0, false, 2, (Object) null)) {
                    ...
                    readExtra(bufferedSource2, readShortLe4, new ZipFilesKt$readEntry$1(booleanRef, j3, longRef2, bufferedSource, longRef4, longRef3));
                    if (j3 <= 0 || booleanRef2.element) {
                        String str2 = str;
                        return new ZipEntry(Path.Companion.get$default(Path.Companion, "/", false, 1, (Object) null).resolve(str2), StringsKt.endsWith$default(str2, "/", false, 2, (Object) null), bufferedSource2.readUtf8((long) readShortLe5), j4, longRef4.element, longRef2.element, readShortLe2, dosDateTimeToEpochMillis, longRef5.element);
                    }
    ...
    private static final FileMetadata readOrSkipLocalHeader(BufferedSource bufferedSource, FileMetadata fileMetadata) {
        ...
        if (readIntLe == LOCAL_FILE_HEADER_SIGNATURE) {
            ...
            if ((readShortLe & 1) == 0) {
                ...
                short readShortLe2 = bufferedSource.readShortLe() & UShort.MAX_VALUE;
                bufferedSource2.skip(((long) bufferedSource.readShortLe()) & 65535);
    ...
    private static final Long dosDateTimeToEpochMillis(int i, int i2) {
        ...
        gregorianCalendar2.set(((i >> 9) & WorkQueueKt.MASK) + 1980, ((i >> 5) & 15) - 1, i & 31, (i2 >> 11) & 31, (i2 >> 5) & 63, (i2 & 31) << 1);
