    ...
    public final void invoke(int i, long j) {
        ...
        if (!this.$hasZip64Extra.element) {
            ...
            if (j >= this.$requiredZip64ExtraSize) {
                ...
                longRef.element = longRef.element == KeyboardMap.kValueMask ? this.$this_readEntry.readLongLe() : this.$size.element;
                Ref.LongRef longRef2 = this.$compressedSize;
                long j2 = 0;
                longRef2.element = longRef2.element == KeyboardMap.kValueMask ? this.$this_readEntry.readLongLe() : 0;
