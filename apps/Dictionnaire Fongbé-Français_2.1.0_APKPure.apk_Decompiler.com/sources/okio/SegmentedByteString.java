...
public final class SegmentedByteString {
    ...
    public static final String toHexString(long j) {
        ...
        int i = 0;
        char[] cArr = {c, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12, ByteString.getHEX_DIGIT_CHARS()[(int) ((j >> 12) & 15)], ByteString.getHEX_DIGIT_CHARS()[(int) ((j >> 8) & 15)], ByteString.getHEX_DIGIT_CHARS()[(int) ((j >> 4) & 15)], ByteString.getHEX_DIGIT_CHARS()[(int) (j & 15)]};
        while (i < 16 && cArr[i] == '0') {
            i++;
        }
