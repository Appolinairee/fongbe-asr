...
public class SemaphoreImpl implements Semaphore {
    ...
    public final boolean addAcquireToQueue(Waiter waiter) {
        ...
        while (true) {
            ...
            Segment r10 = SegmentOrClosed.m1788getSegmentimpl(findSegmentInternal);
            while (true) {
        ...
        SemaphoreSegment semaphoreSegment2 = (SemaphoreSegment) SegmentOrClosed.m1788getSegmentimpl(findSegmentInternal);
    ...
    private final boolean tryResumeNextFromQueue() {
        ...
        while (true) {
            ...
            Segment r8 = SegmentOrClosed.m1788getSegmentimpl(findSegmentInternal);
            while (true) {
                Segment segment = (Segment) atomicReferenceFieldUpdater.get(this);
                if (segment.id >= r8.id) {
                    break loop0;
