...
public class JobSupport implements Job, ChildJob, ParentJob {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:53:0x0091, code lost:
        if (tryWaitForChild(r1, r8, r9) == false) goto L_0x0096;
     */
    ...
    private final java.lang.Object tryMakeCompletingSlowPath(kotlinx.coroutines.Incomplete r8, java.lang.Object r9) {
        ...
        L_0x001d:
            ...
            r3.<init>()
            monitor-enter(r1)
            boolean r4 = r1.isCompleting()     // Catch:{ all -> 0x009b }
            if (r4 == 0) goto L_0x002f
            kotlinx.coroutines.internal.Symbol r8 = kotlinx.coroutines.JobSupportKt.COMPLETING_ALREADY     // Catch:{ all -> 0x009b }
            monitor-exit(r1)
            return r8
        L_0x002f:
            r4 = 1
            r1.setCompleting(r4)     // Catch:{ all -> 0x009b }
            if (r1 == r8) goto L_0x0043
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r5 = _state$FU     // Catch:{ all -> 0x009b }
            boolean r5 = androidx.concurrent.futures.AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(r5, r7, r8, r1)     // Catch:{ all -> 0x009b }
            if (r5 != 0) goto L_0x0043
            kotlinx.coroutines.internal.Symbol r8 = kotlinx.coroutines.JobSupportKt.COMPLETING_RETRY     // Catch:{ all -> 0x009b }
            monitor-exit(r1)
            return r8
        L_0x0043:
            boolean r5 = kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED()     // Catch:{ all -> 0x009b }
            if (r5 == 0) goto L_0x0056
            boolean r5 = r1.isSealed()     // Catch:{ all -> 0x009b }
            if (r5 != 0) goto L_0x0050
            goto L_0x0056
        L_0x0050:
            java.lang.AssertionError r8 = new java.lang.AssertionError     // Catch:{ all -> 0x009b }
            r8.<init>()     // Catch:{ all -> 0x009b }
            throw r8     // Catch:{ all -> 0x009b }
        L_0x0056:
            boolean r5 = r1.isCancelling()     // Catch:{ all -> 0x009b }
            boolean r6 = r9 instanceof kotlinx.coroutines.CompletedExceptionally     // Catch:{ all -> 0x009b }
            if (r6 == 0) goto L_0x0062
            r6 = r9
            kotlinx.coroutines.CompletedExceptionally r6 = (kotlinx.coroutines.CompletedExceptionally) r6     // Catch:{ all -> 0x009b }
            goto L_0x0063
        L_0x0062:
            r6 = r2
        L_0x0063:
            if (r6 == 0) goto L_0x006a
            java.lang.Throwable r6 = r6.cause     // Catch:{ all -> 0x009b }
            r1.addExceptionLocked(r6)     // Catch:{ all -> 0x009b }
        L_0x006a:
            java.lang.Throwable r6 = r1.getRootCause()     // Catch:{ all -> 0x009b }
            r4 = r4 ^ r5
