...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object r4 = conflatedBufferedChannel.m1752trySendImplMj0NB7M(e, true);
        if (!(r4 instanceof ChannelResult.Closed)) {
            return Unit.INSTANCE;
        }
        ChannelResult.m1737exceptionOrNullimpl(r4);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object r0 = conflatedBufferedChannel.m1752trySendImplMj0NB7M(e, true);
    ...
    public Object m1753trySendJP2dKIU(E e) {
        return m1752trySendImplMj0NB7M(e, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M  reason: not valid java name */
    private final Object m1752trySendImplMj0NB7M(E e, boolean z) {
        if (this.onBufferOverflow == BufferOverflow.DROP_LATEST) {
            return m1750trySendDropLatestMj0NB7M(e, z);
        }
        return m1751trySendDropOldestJP2dKIU(e);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M  reason: not valid java name */
    private final Object m1750trySendDropLatestMj0NB7M(E e, boolean z) {
        Function1 function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object r0 = super.m1725trySendJP2dKIU(e);
        if (ChannelResult.m1743isSuccessimpl(r0) || ChannelResult.m1741isClosedimpl(r0)) {
            return r0;
        }
        if (!z || (function1 = this.onUndeliveredElement) == null || (callUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, (UndeliveredElementException) null, 2, (Object) null)) == null) {
            return ChannelResult.Companion.m1748successJP2dKIU(Unit.INSTANCE);
        }
        throw callUndeliveredElementCatchingException$default;
    }

    /* renamed from: trySendDropOldest-JP2dKIU  reason: not valid java name */
    private final Object m1751trySendDropOldestJP2dKIU(E e) {
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (access$findSegmentSend != null) {
                    ...
                    return ChannelResult.Companion.m1746closedJP2dKIU(getSendException());
                }
            } else {
