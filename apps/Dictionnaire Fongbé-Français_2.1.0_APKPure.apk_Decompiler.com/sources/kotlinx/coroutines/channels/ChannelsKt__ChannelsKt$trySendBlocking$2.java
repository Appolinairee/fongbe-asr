    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m511constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m511constructorimpl(Unit.INSTANCE);
        if (Result.m518isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m1748successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m1746closedJP2dKIU(Result.m514exceptionOrNullimpl(obj2));
        }
