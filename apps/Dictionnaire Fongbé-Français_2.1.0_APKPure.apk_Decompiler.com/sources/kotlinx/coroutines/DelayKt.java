...
public final class DelayKt {
    ...
    public static final Object m374delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m375toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m375toDelayMillisLRDsOJo(long j) {
        if (Duration.m200compareToLRDsOJo(j, Duration.Companion.m304getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m219getInWholeMillisecondsimpl(j), 1);
        }
        return 0;
    }
}
