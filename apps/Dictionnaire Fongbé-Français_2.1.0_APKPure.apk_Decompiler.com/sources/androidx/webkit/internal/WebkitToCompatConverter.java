...
public class WebkitToCompatConverter {
    ...
    public ServiceWorkerWebSettings convertServiceWorkerSettings(InvocationHandler invocationHandler) {
        return Constraints$Builder$$ExternalSyntheticApiModelOutline0.m(this.mImpl.convertServiceWorkerSettings(invocationHandler));
    }
    ...
    public WebResourceError convertWebResourceError(InvocationHandler invocationHandler) {
        return Constraints$Builder$$ExternalSyntheticApiModelOutline0.m(this.mImpl.convertWebResourceError(invocationHandler));
    }
    ...
    public SafeBrowsingResponse convertSafeBrowsingResponse(InvocationHandler invocationHandler) {
        return Constraints$Builder$$ExternalSyntheticApiModelOutline0.m(this.mImpl.convertSafeBrowsingResponse(invocationHandler));
    }
    ...
    public WebMessagePort convertWebMessagePort(InvocationHandler invocationHandler) {
        return Constraints$Builder$$ExternalSyntheticApiModelOutline0.m(this.mImpl.convertWebMessagePort(invocationHandler));
    }
