...
public class WebViewProviderAdapter {
    ...
    public void prerenderUrlAsync(String str, CancellationSignal cancellationSignal, Executor executor, PrerenderOperationCallback prerenderOperationCallback) {
        this.mImpl.prerenderUrl(str, cancellationSignal, executor, new WebViewProviderAdapter$$ExternalSyntheticLambda2(prerenderOperationCallback), new WebViewProviderAdapter$$ExternalSyntheticLambda3(prerenderOperationCallback));
    }
    ...
    public void prerenderUrlAsync(String str, CancellationSignal cancellationSignal, Executor executor, SpeculativeLoadingParameters speculativeLoadingParameters, PrerenderOperationCallback prerenderOperationCallback) {
        this.mImpl.prerenderUrl(str, cancellationSignal, executor, BoundaryInterfaceReflectionUtil.createInvocationHandlerFor(new SpeculativeLoadingParametersAdapter(speculativeLoadingParameters)), new WebViewProviderAdapter$$ExternalSyntheticLambda0(prerenderOperationCallback), new WebViewProviderAdapter$$ExternalSyntheticLambda1(prerenderOperationCallback));
    }
