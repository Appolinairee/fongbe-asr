...
public class WebViewRenderProcessImpl extends WebViewRenderProcess {
    ...
    public static WebViewRenderProcessImpl forInvocationHandler(InvocationHandler invocationHandler) {
        ...
        return (WebViewRenderProcessImpl) webViewRendererBoundaryInterface.getOrCreatePeer(new WebViewRenderProcessImpl$$ExternalSyntheticLambda1(webViewRendererBoundaryInterface));
    }
    ...
    public boolean terminate() {
        ...
        if (q.isSupportedByFramework()) {
            android.webkit.WebViewRenderProcess m = Constraints$Builder$$ExternalSyntheticApiModelOutline0.m(this.mFrameworkObject.get());
