...
public class ApiHelperForN {
    ...
    public static File getDataDir(Context context) {
        return Constraints$Builder$$ExternalSyntheticApiModelOutline0.m(context);
    }
    ...
    public static int getCacheMode(ServiceWorkerWebSettings serviceWorkerWebSettings) {
        return Constraints$Builder$$ExternalSyntheticApiModelOutline0.m(serviceWorkerWebSettings);
    }
