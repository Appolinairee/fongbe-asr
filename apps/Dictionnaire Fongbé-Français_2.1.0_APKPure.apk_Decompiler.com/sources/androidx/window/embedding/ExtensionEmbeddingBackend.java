...
public final class ExtensionEmbeddingBackend implements EmbeddingBackend {
    ...
    public ActivityStack getActivityStack(Activity activity) {
        ...
        try {
            ...
            for (SplitInfo next : lastInfo) {
                if (next.contains(activity)) {
                    if (next.getPrimaryActivityStack().contains(activity)) {
                        ActivityStack primaryActivityStack = next.getPrimaryActivityStack();
                        lock.unlock();
                        return primaryActivityStack;
                    } else if (next.getSecondaryActivityStack().contains(activity)) {
                        ActivityStack secondaryActivityStack = next.getSecondaryActivityStack();
                        lock.unlock();
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:2:0x000e, code lost:
        r3 = r0.setLaunchingActivityStack(r2, r3);
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public android.app.ActivityOptions setLaunchingActivityStack(android.app.ActivityOptions r2, android.os.IBinder r3) {
        /*
            r1 = this;
            ...
            androidx.window.embedding.EmbeddingInterfaceCompat r0 = r1.embeddingExtension
            if (r0 == 0) goto L_0x0016
            android.app.ActivityOptions r3 = r0.setLaunchingActivityStack(r2, r3)
        ...
        L_0x0016:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.window.embedding.ExtensionEmbeddingBackend.setLaunchingActivityStack(android.app.ActivityOptions, android.os.IBinder):android.app.ActivityOptions");
    }
