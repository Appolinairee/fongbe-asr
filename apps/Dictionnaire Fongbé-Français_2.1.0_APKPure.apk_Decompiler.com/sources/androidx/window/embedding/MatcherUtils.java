...
public final class MatcherUtils {
    ...
    public final boolean areComponentsMatching$window_release(ActivityComponentInfo activityComponentInfo, ActivityComponentInfo activityComponentInfo2) {
        ...
        if (activityComponentInfo == null) {
            if (!Intrinsics.areEqual((Object) activityComponentInfo2.getPackageName(), (Object) ProxyConfig.MATCH_ALL_SCHEMES) || !Intrinsics.areEqual((Object) activityComponentInfo2.getClassName(), (Object) ProxyConfig.MATCH_ALL_SCHEMES)) {
                return false;
            }
            return true;
    ...
    public final boolean isIntentMatching$window_release(Intent intent, ActivityComponentInfo activityComponentInfo) {
        ...
        if ((Intrinsics.areEqual((Object) str, (Object) activityComponentInfo.getPackageName()) || wildcardMatch(str, activityComponentInfo.getPackageName())) && Intrinsics.areEqual((Object) activityComponentInfo.getClassName(), (Object) ProxyConfig.MATCH_ALL_SCHEMES)) {
            return true;
        }
        return false;
    }
    ...
    private final boolean wildcardMatch(String str, String str2) {
        ...
        if (!StringsKt.contains$default(charSequence, (CharSequence) ProxyConfig.MATCH_ALL_SCHEMES, false, 2, (Object) null)) {
            return false;
        }
        if (Intrinsics.areEqual((Object) str2, (Object) ProxyConfig.MATCH_ALL_SCHEMES)) {
            return true;
        }
        CharSequence charSequence2 = charSequence;
        if (StringsKt.indexOf$default(charSequence2, ProxyConfig.MATCH_ALL_SCHEMES, 0, false, 6, (Object) null) != StringsKt.lastIndexOf$default(charSequence2, ProxyConfig.MATCH_ALL_SCHEMES, 0, false, 6, (Object) null) || !StringsKt.endsWith$default(str2, ProxyConfig.MATCH_ALL_SCHEMES, false, 2, (Object) null)) {
    ...
    public final void validateComponentName$window_release(String str, String str2) {
        ...
        if (charSequence.length() > 0) {
            ...
            } else if (StringsKt.contains$default(charSequence, (CharSequence) ProxyConfig.MATCH_ALL_SCHEMES, false, 2, (Object) null) && StringsKt.indexOf$default(charSequence, ProxyConfig.MATCH_ALL_SCHEMES, 0, false, 6, (Object) null) != str.length() - 1) {
                throw new IllegalArgumentException("Wildcard in package name is only allowed at the end.".toString());
            } else if (StringsKt.contains$default(charSequence2, (CharSequence) ProxyConfig.MATCH_ALL_SCHEMES, false, 2, (Object) null) && StringsKt.indexOf$default(charSequence2, ProxyConfig.MATCH_ALL_SCHEMES, 0, false, 6, (Object) null) != str2.length() - 1) {
