...
public interface WindowMetricsCalculator {
    ...
    public static final class Companion {
        ...
        public final WindowMetrics translateWindowMetrics$window_release(WindowMetrics windowMetrics) {
            ...
            Rect m = Constraints$Builder$$ExternalSyntheticApiModelOutline0.m(windowMetrics);
            Intrinsics.checkNotNullExpressionValue(m, "windowMetrics.bounds");
            WindowInsetsCompat windowInsetsCompat = WindowInsetsCompat.toWindowInsetsCompat(Constraints$Builder$$ExternalSyntheticApiModelOutline0.m(windowMetrics));
