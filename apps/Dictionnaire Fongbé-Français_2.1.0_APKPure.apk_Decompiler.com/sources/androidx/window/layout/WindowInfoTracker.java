...
public interface WindowInfoTracker {
    ...
    public final /* synthetic */ class CC {
        ...
        public static Flow $default$windowLayoutInfo(WindowInfoTracker _this, Context context) {
            ...
            if (activity != null) {
                flow = _this.windowLayoutInfo(activity);
            }
            if (flow != null) {
                return flow;
            }
    ...
    public static final class Companion {
        ...
        private static final Lazy<WindowBackend> extensionBackend$delegate = LazyKt.lazy(WindowInfoTracker$Companion$extensionBackend$2.INSTANCE);
