...
public final class WindowInfoTrackerImpl implements WindowInfoTracker {
    ...
    public Flow<WindowLayoutInfo> windowLayoutInfo(Context context) {
        ...
        return FlowKt.flowOn(FlowKt.callbackFlow(new WindowInfoTrackerImpl$windowLayoutInfo$1(this, context, (Continuation<? super WindowInfoTrackerImpl$windowLayoutInfo$1>) null)), Dispatchers.getMain());
    }

    public Flow<WindowLayoutInfo> windowLayoutInfo(Activity activity) {
        Intrinsics.checkNotNullParameter(activity, "activity");
        return FlowKt.flowOn(FlowKt.callbackFlow(new WindowInfoTrackerImpl$windowLayoutInfo$2(this, activity, (Continuation<? super WindowInfoTrackerImpl$windowLayoutInfo$2>) null)), Dispatchers.getMain());
    }
}
