...
public final class ContextCompatHelperApi30 {
    ...
    public final WindowMetrics currentWindowMetrics(Context context) {
        ...
        WindowInsetsCompat windowInsetsCompat = WindowInsetsCompat.toWindowInsetsCompat(Constraints$Builder$$ExternalSyntheticApiModelOutline0.m(windowManager.getCurrentWindowMetrics()));
        Intrinsics.checkNotNullExpressionValue(windowInsetsCompat, "toWindowInsetsCompat(wm.…ndowMetrics.windowInsets)");
        Rect m = Constraints$Builder$$ExternalSyntheticApiModelOutline0.m(windowManager.getCurrentWindowMetrics());
    ...
    public final Rect currentWindowBounds(Context context) {
        Intrinsics.checkNotNullParameter(context, "context");
        Rect m = Constraints$Builder$$ExternalSyntheticApiModelOutline0.m(((WindowManager) context.getSystemService(WindowManager.class)).getCurrentWindowMetrics());
        Intrinsics.checkNotNullExpressionValue(m, "wm.currentWindowMetrics.bounds");
        return m;
    }
    ...
    public final Rect maximumWindowBounds(Context context) {
        Intrinsics.checkNotNullParameter(context, "context");
        Rect m = Constraints$Builder$$ExternalSyntheticApiModelOutline0.m(((WindowManager) context.getSystemService(WindowManager.class)).getMaximumWindowMetrics());
    ...
    public final WindowInsetsCompat currentWindowInsets(Context context) {
        Intrinsics.checkNotNullParameter(context, "context");
        WindowInsets m = Constraints$Builder$$ExternalSyntheticApiModelOutline0.m(((WindowManager) context.getSystemService(WindowManager.class)).getCurrentWindowMetrics());
        Intrinsics.checkNotNullExpressionValue(m, "context.getSystemService…indowMetrics.windowInsets");
