...
public final class WindowAreaInfo {
    ...
    public WindowAreaInfo(WindowMetrics windowMetrics, Type type2, Binder binder, WindowAreaComponent windowAreaComponent2) {
    ...
    public final WindowAreaSession getActiveSession(WindowAreaCapability.Operation operation) {
        Intrinsics.checkNotNullParameter(operation, "operation");
        if (!Intrinsics.areEqual((Object) getCapability(operation).getStatus(), (Object) WindowAreaCapability.Status.WINDOW_AREA_STATUS_ACTIVE)) {
            throw new IllegalStateException("No session is currently active");
        } else if (Intrinsics.areEqual((Object) this.type, (Object) Type.TYPE_REAR_FACING)) {
    ...
    private final WindowAreaSession createRearFacingSession(WindowAreaCapability.Operation operation) {
        if (Intrinsics.areEqual((Object) operation, (Object) WindowAreaCapability.Operation.OPERATION_TRANSFER_ACTIVITY_TO_AREA)) {
            return new RearDisplaySessionImpl(this.windowAreaComponent);
        }
        if (Intrinsics.areEqual((Object) operation, (Object) WindowAreaCapability.Operation.OPERATION_PRESENT_ON_AREA)) {
            ...
            return new RearDisplayPresentationSessionPresenterImpl(windowAreaComponent2, rearDisplayPresentation);
        }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof WindowAreaInfo) {
            ...
            return Intrinsics.areEqual((Object) this.metrics, (Object) windowAreaInfo.metrics) && Intrinsics.areEqual((Object) this.type, (Object) windowAreaInfo.type) && Intrinsics.areEqual((Object) this.capabilityMap.entrySet(), (Object) windowAreaInfo.capabilityMap.entrySet());
        }
    }
