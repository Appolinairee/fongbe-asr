...
public interface WindowAreaController {
    ...
    public static final class Companion {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:15:0x004c, code lost:
            if (r1.hasDeviceMetrics$window_release(r2, r3) != false) goto L_0x004e;
         */
        ...
        public final androidx.window.area.WindowAreaController getOrCreate() {
            /*
                r5 = this;
                r0 = 0
                java.lang.Class r1 = r5.getClass()     // Catch:{ all -> 0x0015 }
                java.lang.ClassLoader r1 = r1.getClassLoader()     // Catch:{ all -> 0x0015 }
                if (r1 == 0) goto L_0x0027
                androidx.window.area.SafeWindowAreaComponentProvider r2 = new androidx.window.area.SafeWindowAreaComponentProvider     // Catch:{ all -> 0x0015 }
                r2.<init>(r1)     // Catch:{ all -> 0x0015 }
                androidx.window.extensions.area.WindowAreaComponent r0 = r2.getWindowAreaComponent()     // Catch:{ all -> 0x0015 }
                goto L_0x0027
            L_0x0015:
            ...
            L_0x005f:
                ...
                androidx.window.area.WindowAreaController r1 = (androidx.window.area.WindowAreaController) r1
            L_0x0067:
                androidx.window.area.WindowAreaControllerDecorator r0 = decorator
