...
public final class SplitControllerCallbackAdapter {
    ...
    private SplitControllerCallbackAdapter(SplitController splitController, CallbackToFlowAdapter callbackToFlowAdapter2) {
    ...
    public SplitControllerCallbackAdapter(SplitController splitController) {
        ...
        Intrinsics.checkNotNullParameter(splitController, "controller");
    }
