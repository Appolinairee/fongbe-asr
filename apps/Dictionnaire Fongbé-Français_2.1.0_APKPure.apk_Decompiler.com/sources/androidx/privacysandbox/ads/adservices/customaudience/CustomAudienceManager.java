    ...
    private static final class Api33Ext4Impl extends CustomAudienceManager {
        ...
        public Api33Ext4Impl(android.content.Context r2) {
            /*
                ...
                java.lang.Class r0 = androidx.transition.CanvasUtils$$ExternalSyntheticApiModelOutline0.m$1()
                java.lang.Object r2 = r2.getSystemService(r0)
                java.lang.String r0 = "context.getSystemService…:class.java\n            )"
                kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r0)
                android.adservices.customaudience.CustomAudienceManager r2 = androidx.transition.CanvasUtils$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r2)
        ...
        public final JoinCustomAudienceRequest convertJoinRequest(JoinCustomAudienceRequest joinCustomAudienceRequest) {
            JoinCustomAudienceRequest m = CanvasUtils$$ExternalSyntheticApiModelOutline0.m().setCustomAudience(convertCustomAudience(joinCustomAudienceRequest.getCustomAudience())).build();
        ...
        private final List<AdData> convertAdData(List<androidx.privacysandbox.ads.adservices.common.AdData> list) {
            ...
            for (androidx.privacysandbox.ads.adservices.common.AdData next : list) {
                AdData m = CanvasUtils$$ExternalSyntheticApiModelOutline0.m().setMetadata(next.getMetadata()).setRenderUri(next.getRenderUri()).build();
                Intrinsics.checkNotNullExpressionValue(m, "Builder()\n              …                 .build()");
                arrayList.add(m);
            }
            return arrayList;
        ...
        private final AdTechIdentifier convertAdTechIdentifier(androidx.privacysandbox.ads.adservices.common.AdTechIdentifier adTechIdentifier) {
            AdTechIdentifier m = PrintHelper$$ExternalSyntheticApiModelOutline0.m(adTechIdentifier.getIdentifier());
            Intrinsics.checkNotNullExpressionValue(m, "fromString(input.identifier)");
            return m;
        }
        ...
        private final TrustedBiddingData convertTrustedSignals(TrustedBiddingData trustedBiddingData) {
            ...
            return CanvasUtils$$ExternalSyntheticApiModelOutline0.m().setTrustedBiddingKeys(trustedBiddingData.getTrustedBiddingKeys()).setTrustedBiddingUri(trustedBiddingData.getTrustedBiddingUri()).build();
        }
        ...
        private final AdSelectionSignals convertBiddingSignals(androidx.privacysandbox.ads.adservices.common.AdSelectionSignals adSelectionSignals) {
            ...
            return PrintHelper$$ExternalSyntheticApiModelOutline0.m(adSelectionSignals.getSignals());
        }
