...
public final class DeletionRequest {
    ...
    public /* synthetic */ DeletionRequest(int r8, int r9, java.time.Instant r10, java.time.Instant r11, java.util.List r12, java.util.List r13, int r14, kotlin.jvm.internal.DefaultConstructorMarker r15) {
        /*
            ...
            java.time.Instant r10 = androidx.transition.CanvasUtils$$ExternalSyntheticApiModelOutline0.m()
        ...
        L_0x000d:
            ...
            java.time.Instant r11 = androidx.transition.CanvasUtils$$ExternalSyntheticApiModelOutline0.m$1()
    ...
    public static final class Builder {
        ...
        public Builder(int i, int i2) {
            this.deletionMode = i;
            this.matchBehavior = i2;
            Instant m = CanvasUtils$$ExternalSyntheticApiModelOutline0.m();
            Intrinsics.checkNotNullExpressionValue(m, "MIN");
            this.start = m;
            Instant m$1 = CanvasUtils$$ExternalSyntheticApiModelOutline0.m$1();
            Intrinsics.checkNotNullExpressionValue(m$1, "MAX");
            this.end = m$1;
        }
