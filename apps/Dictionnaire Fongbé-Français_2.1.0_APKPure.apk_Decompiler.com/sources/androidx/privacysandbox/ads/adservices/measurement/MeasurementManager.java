    ...
    private static final class Api33Ext5Impl extends MeasurementManager {
        ...
        public Api33Ext5Impl(android.content.Context r2) {
            /*
                ...
                java.lang.Class r0 = androidx.transition.CanvasUtils$$ExternalSyntheticApiModelOutline0.m$2()
                java.lang.Object r2 = r2.getSystemService(r0)
                java.lang.String r0 = "context.getSystemService…:class.java\n            )"
                kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r0)
                android.adservices.measurement.MeasurementManager r2 = androidx.transition.CanvasUtils$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r2)
        ...
        private final List<WebSourceParams> convertWebSourceParams(List<WebSourceParams> list) {
            ...
            for (WebSourceParams next : list) {
                ...
                WebSourceParams m = CanvasUtils$$ExternalSyntheticApiModelOutline0.m(next.getRegistrationUri()).setDebugKeyAllowed(next.getDebugKeyAllowed()).build();
                Intrinsics.checkNotNullExpressionValue(m, "Builder(param.registrati…                 .build()");
                arrayList.add(m);
            }
            return arrayList;
        }
        ...
        public final WebTriggerRegistrationRequest convertWebTriggerRequest(WebTriggerRegistrationRequest webTriggerRegistrationRequest) {
            ...
            WebTriggerRegistrationRequest m = CanvasUtils$$ExternalSyntheticApiModelOutline0.m((List) convertWebTriggerParams(webTriggerRegistrationRequest.getWebTriggerParams()), webTriggerRegistrationRequest.getDestination()).build();
            Intrinsics.checkNotNullExpressionValue(m, "Builder(\n               …\n                .build()");
            return m;
        }
        ...
        private final List<WebTriggerParams> convertWebTriggerParams(List<WebTriggerParams> list) {
            ...
            for (WebTriggerParams next : list) {
                ...
                WebTriggerParams m = CanvasUtils$$ExternalSyntheticApiModelOutline0.m(next.getRegistrationUri()).setDebugKeyAllowed(next.getDebugKeyAllowed()).build();
                Intrinsics.checkNotNullExpressionValue(m, "Builder(param.registrati…                 .build()");
                arrayList.add(m);
            }
            return arrayList;
