...
public final class TopicsManagerApi33Ext5Impl extends TopicsManagerImplCommon {
    ...
    public TopicsManagerApi33Ext5Impl(android.content.Context r2) {
        /*
            ...
            java.lang.Class r0 = androidx.transition.CanvasUtils$$ExternalSyntheticApiModelOutline0.m$3()
            java.lang.Object r2 = r2.getSystemService(r0)
            java.lang.String r0 = "context.getSystemService…opicsManager::class.java)"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r0)
            android.adservices.topics.TopicsManager r2 = androidx.transition.CanvasUtils$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r2)
            r1.<init>(r2)
            return
        */
    ...
    public GetTopicsRequest convertRequest$ads_adservices_release(GetTopicsRequest getTopicsRequest) {
        ...
        GetTopicsRequest m = CanvasUtils$$ExternalSyntheticApiModelOutline0.m().setAdsSdkName(getTopicsRequest.getAdsSdkName()).setShouldRecordObservation(getTopicsRequest.shouldRecordObservation()).build();
