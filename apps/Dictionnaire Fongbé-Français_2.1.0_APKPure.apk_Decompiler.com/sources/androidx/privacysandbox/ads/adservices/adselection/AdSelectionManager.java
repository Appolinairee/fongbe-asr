    ...
    private static final class Api33Ext4Impl extends AdSelectionManager {
        ...
        public Api33Ext4Impl(android.content.Context r2) {
            /*
                ...
                java.lang.Class r0 = androidx.print.PrintHelper$$ExternalSyntheticApiModelOutline0.m$1()
                java.lang.Object r2 = r2.getSystemService(r0)
                java.lang.String r0 = "context.getSystemService…:class.java\n            )"
                kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r0)
                android.adservices.adselection.AdSelectionManager r2 = androidx.print.PrintHelper$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r2)
        ...
        public java.lang.Object selectAds(androidx.privacysandbox.ads.adservices.adselection.AdSelectionConfig r5, kotlin.coroutines.Continuation<? super androidx.privacysandbox.ads.adservices.adselection.AdSelectionOutcome> r6) {
            ...
            L_0x0048:
                r5 = r4
            L_0x0049:
                android.adservices.adselection.AdSelectionOutcome r6 = androidx.print.PrintHelper$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r6)
        ...
        private final AdSelectionConfig convertAdSelectionConfig(AdSelectionConfig adSelectionConfig) {
            AdSelectionConfig m = PrintHelper$$ExternalSyntheticApiModelOutline0.m().setAdSelectionSignals(convertAdSelectionSignals(adSelectionConfig.getAdSelectionSignals())).setCustomAudienceBuyers(convertBuyers(adSelectionConfig.getCustomAudienceBuyers())).setDecisionLogicUri(adSelectionConfig.getDecisionLogicUri()).setSeller(PrintHelper$$ExternalSyntheticApiModelOutline0.m(adSelectionConfig.getSeller().getIdentifier())).setPerBuyerSignals(convertPerBuyerSignals(adSelectionConfig.getPerBuyerSignals())).setSellerSignals(convertAdSelectionSignals(adSelectionConfig.getSellerSignals())).setTrustedScoringSignalsUri(adSelectionConfig.getTrustedScoringSignalsUri()).build();
        ...
        private final AdSelectionSignals convertAdSelectionSignals(androidx.privacysandbox.ads.adservices.common.AdSelectionSignals adSelectionSignals) {
            AdSelectionSignals m = PrintHelper$$ExternalSyntheticApiModelOutline0.m(adSelectionSignals.getSignals());
            Intrinsics.checkNotNullExpressionValue(m, "fromString(request.signals)");
            return m;
        }
        ...
        private final List<AdTechIdentifier> convertBuyers(List<androidx.privacysandbox.ads.adservices.common.AdTechIdentifier> list) {
            ...
            for (androidx.privacysandbox.ads.adservices.common.AdTechIdentifier identifier : list) {
                AdTechIdentifier m = PrintHelper$$ExternalSyntheticApiModelOutline0.m(identifier.getIdentifier());
                Intrinsics.checkNotNullExpressionValue(m, "fromString(buyer.identifier)");
                arrayList.add(m);
            }
            return arrayList;
        }
        ...
        private final Map<AdTechIdentifier, AdSelectionSignals> convertPerBuyerSignals(Map<androidx.privacysandbox.ads.adservices.common.AdTechIdentifier, androidx.privacysandbox.ads.adservices.common.AdSelectionSignals> map) {
            ...
            for (androidx.privacysandbox.ads.adservices.common.AdTechIdentifier next : map.keySet()) {
                AdTechIdentifier m = PrintHelper$$ExternalSyntheticApiModelOutline0.m(next.getIdentifier());
                Intrinsics.checkNotNullExpressionValue(m, "fromString(key.identifier)");
                ...
                hashMap.put(m, adSelectionSignals);
            }
            return hashMap;
        }

        private final AdSelectionOutcome convertResponse(AdSelectionOutcome adSelectionOutcome) {
            long m = PrintHelper$$ExternalSyntheticApiModelOutline0.m(adSelectionOutcome);
            Uri m2 = PrintHelper$$ExternalSyntheticApiModelOutline0.m(adSelectionOutcome);
            Intrinsics.checkNotNullExpressionValue(m2, "response.renderUri");
            return new AdSelectionOutcome(m, m2);
        }

        /* access modifiers changed from: private */
        public final ReportImpressionRequest convertReportImpressionRequest(ReportImpressionRequest reportImpressionRequest) {
            PrintHelper$$ExternalSyntheticApiModelOutline0.m();
            return PrintHelper$$ExternalSyntheticApiModelOutline0.m(reportImpressionRequest.getAdSelectionId(), convertAdSelectionConfig(reportImpressionRequest.getAdSelectionConfig()));
        }
