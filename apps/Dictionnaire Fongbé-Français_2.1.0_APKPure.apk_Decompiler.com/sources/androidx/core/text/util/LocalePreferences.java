...
public final class LocalePreferences {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            /*
                android.icu.text.DateFormat$HourCycle[] r0 = androidx.core.util.HalfKt$$ExternalSyntheticApiModelOutline0.m()
                int r0 = r0.length
                int[] r0 = new int[r0]
                $SwitchMap$android$icu$text$DateFormat$HourCycle = r0
                android.icu.text.DateFormat$HourCycle r1 = androidx.core.util.HalfKt$$ExternalSyntheticApiModelOutline0.m()     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = $SwitchMap$android$icu$text$DateFormat$HourCycle     // Catch:{ NoSuchFieldError -> 0x0021 }
                android.icu.text.DateFormat$HourCycle r1 = androidx.core.util.HalfKt$$ExternalSyntheticApiModelOutline0.m$1()     // Catch:{ NoSuchFieldError -> 0x0021 }
