...
public class ShortcutManagerCompat {
    ...
    public static List<ShortcutInfoCompat> getDynamicShortcuts(Context context) {
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            for (Object m2 : m) {
                arrayList.add(new ShortcutInfoCompat.Builder(context, ComponentDialog$$ExternalSyntheticApiModelOutline0.m(m2)).build());
            }
            return arrayList;
        }
        try {
    ...
    public static boolean pushDynamicShortcut(android.content.Context r6, androidx.core.content.pm.ShortcutInfoCompat r7) {
        ...
        L_0x009c:
            ...
            java.lang.String[] r0 = new java.lang.String[]{r0}     // Catch:{ Exception -> 0x010d, all -> 0x00e8 }
