...
public class ShortcutInfoCompat {
    ...
    public ShortcutInfo toShortcutInfo() {
        ...
        ShortcutInfo.Builder m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m(this.mContext, this.mId).setShortLabel(this.mLabel).setIntents(this.mIntents);
    ...
    static List<ShortcutInfoCompat> fromShortcuts(Context context, List<ShortcutInfo> list) {
        ...
        for (ShortcutInfo m : list) {
            arrayList.add(new Builder(context, ComponentDialog$$ExternalSyntheticApiModelOutline0.m((Object) m)).build());
        }
        return arrayList;
    }
    ...
    static LocusIdCompat getLocusId(ShortcutInfo shortcutInfo) {
        if (Build.VERSION.SDK_INT < 29) {
            return getLocusIdFromExtra(ColorKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo));
        }
        if (ColorKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo) == null) {
            return null;
        }
        return LocusIdCompat.toLocusIdCompat(ColorKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo));
    }
    ...
    public static class Builder {
        ...
        public Builder(Context context, ShortcutInfo shortcutInfo) {
            ...
            this.mInfo = shortcutInfoCompat;
            shortcutInfoCompat.mContext = context;
            shortcutInfoCompat.mId = ColorKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mPackageName = ColorKt$$ExternalSyntheticApiModelOutline0.m$1(shortcutInfo);
            Intent[] m = ColorKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            ...
            shortcutInfoCompat.mLongLabel = ColorKt$$ExternalSyntheticApiModelOutline0.m$1(shortcutInfo);
            shortcutInfoCompat.mDisabledMessage = ColorKt$$ExternalSyntheticApiModelOutline0.m$2(shortcutInfo);
            if (Build.VERSION.SDK_INT >= 28) {
                shortcutInfoCompat.mDisabledReason = ColorKt$$ExternalSyntheticApiModelOutline0.m$1(shortcutInfo);
            } else {
                shortcutInfoCompat.mDisabledReason = shortcutInfo.isEnabled() ? 0 : 3;
            }
            shortcutInfoCompat.mCategories = ColorKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mPersons = ShortcutInfoCompat.getPersonsFromExtra(ColorKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo));
            shortcutInfoCompat.mUser = ColorKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mLastChangedTimestamp = ColorKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            if (Build.VERSION.SDK_INT >= 30) {
                shortcutInfoCompat.mIsCached = ColorKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            }
            shortcutInfoCompat.mIsDynamic = ColorKt$$ExternalSyntheticApiModelOutline0.m$1(shortcutInfo);
            shortcutInfoCompat.mIsPinned = ColorKt$$ExternalSyntheticApiModelOutline0.m$2(shortcutInfo);
            ...
            shortcutInfoCompat.mRank = ColorKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mExtras = ColorKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
        }
