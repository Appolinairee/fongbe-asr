...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        private static Style constructCompatStyleByPlatformName(String str) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                if (str.equals(ComponentDialog$$ExternalSyntheticApiModelOutline0.m$2().getName())) {
    ...
    public static class BigPictureStyle extends Style {
        ...
        private static IconCompat asIconCompat(Parcelable parcelable) {
            ...
            if (Build.VERSION.SDK_INT >= 23 && ComponentDialog$$ExternalSyntheticApiModelOutline0.m$1((Object) parcelable)) {
                return IconCompat.createFromIcon(ComponentDialog$$ExternalSyntheticApiModelOutline0.m((Object) parcelable));
            }
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                for (Message androidMessage : this.mMessages) {
                    Api24Impl.addMessage(ComponentDialog$$ExternalSyntheticApiModelOutline0.m((Object) messagingStyle), androidMessage.toAndroidMessage());
                }
                if (Build.VERSION.SDK_INT >= 26) {
                    for (Message androidMessage2 : this.mHistoricMessages) {
                        Api26Impl.addHistoricMessage(ComponentDialog$$ExternalSyntheticApiModelOutline0.m((Object) messagingStyle), androidMessage2.toAndroidMessage());
                    }
                }
                if (this.mIsGroupConversation.booleanValue() || Build.VERSION.SDK_INT >= 28) {
                    Api24Impl.setConversationTitle(ComponentDialog$$ExternalSyntheticApiModelOutline0.m((Object) messagingStyle), this.mConversationTitle);
                }
                if (Build.VERSION.SDK_INT >= 28) {
                    Api28Impl.setGroupConversation(ComponentDialog$$ExternalSyntheticApiModelOutline0.m((Object) messagingStyle), this.mIsGroupConversation.booleanValue());
                }
    ...
    public static class CallStyle extends Style {
        ...
        public void restoreFromCompatExtras(Bundle bundle) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && bundle.containsKey(NotificationCompat.EXTRA_CALL_PERSON)) {
                this.mPerson = Person.fromAndroidPerson(ComponentDialog$$ExternalSyntheticApiModelOutline0.m((Object) bundle.getParcelable(NotificationCompat.EXTRA_CALL_PERSON)));
            ...
            if (Build.VERSION.SDK_INT >= 23 && bundle.containsKey(NotificationCompat.EXTRA_VERIFICATION_ICON)) {
                this.mVerificationIcon = IconCompat.createFromIcon(ComponentDialog$$ExternalSyntheticApiModelOutline0.m((Object) bundle.getParcelable(NotificationCompat.EXTRA_VERIFICATION_ICON)));
    ...
    public static final class CarExtender implements Extender {
        ...
        private static UnreadConversation getUnreadConversationFromBundle(Bundle bundle) {
            ...
            if (remoteInput2 != null) {
                remoteInput = new RemoteInput(Api20Impl.getResultKey(remoteInput2), Api20Impl.getLabel(remoteInput2), Api20Impl.getChoices(remoteInput2), Api20Impl.getAllowFreeFormInput(remoteInput2), Build.VERSION.SDK_INT >= 29 ? Api29Impl.getEditChoicesBeforeSending(remoteInput2) : 0, Api20Impl.getExtras(remoteInput2), (Set<String>) null);
            }
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (Build.VERSION.SDK_INT < 23) {
            return new Action(action2.icon, action2.title, action2.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z2, i3, z3, isContextual, isAuthenticationRequired);
        }
        ...
        return new Action(iconCompat, action2.title, action2.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z2, i3, z3, isContextual, isAuthenticationRequired);
    }
