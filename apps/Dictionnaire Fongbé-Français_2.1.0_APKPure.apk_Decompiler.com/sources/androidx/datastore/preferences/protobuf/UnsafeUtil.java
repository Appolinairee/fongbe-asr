    ...
    private static abstract class MemoryAccessor {
        ...
        public boolean supportsUnsafeArrayOperations() {
            ...
            try {
                ...
                cls.getMethod("putObject", new Class[]{cls3, Long.TYPE, cls3});
                return true;
            } catch (Throwable th) {
    ...
    private static final class JvmMemoryAccessor extends MemoryAccessor {
        ...
        public boolean supportsUnsafeByteBufferOperations() {
            ...
            try {
                ...
                cls.getMethod("copyMemory", new Class[]{cls3, cls3, cls3});
                Class<Object> cls4 = Object.class;
                Class cls5 = Long.TYPE;
                cls.getMethod("copyMemory", new Class[]{cls4, cls5, cls4, cls5, cls5});
                return true;
            } catch (Throwable th) {
                UnsafeUtil.logMissingMethod(th);
                return false;
