    ...
    public DataStore<T> getValue(Context context, KProperty<?> kProperty) {
        ...
        synchronized (this.lock) {
            if (this.INSTANCE == null) {
                ...
                Storage okioStorage = new OkioStorage(FileSystem.SYSTEM, this.serializer, (Function2) null, new DataStoreSingletonDelegate$getValue$1$1(applicationContext, this), 4, (DefaultConstructorMarker) null);
