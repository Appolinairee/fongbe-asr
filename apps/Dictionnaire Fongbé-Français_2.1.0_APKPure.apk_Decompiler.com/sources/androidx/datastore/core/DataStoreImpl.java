...
public final class DataStoreImpl<T> implements DataStore<T> {
    ...
    public final java.lang.Object handleUpdate(androidx.datastore.core.Message.Update<T> r9, kotlin.coroutines.Continuation<? super kotlin.Unit> r10) {
        ...
        L_0x0056:
            ...
            kotlin.Result$Companion r2 = kotlin.Result.Companion     // Catch:{ all -> 0x00dc }
            r2 = r8
            androidx.datastore.core.DataStoreImpl r2 = (androidx.datastore.core.DataStoreImpl) r2     // Catch:{ all -> 0x00dc }
            androidx.datastore.core.DataStoreInMemoryCache<T> r2 = r8.inMemoryCache     // Catch:{ all -> 0x00dc }
            androidx.datastore.core.State r2 = r2.getCurrentState()     // Catch:{ all -> 0x00dc }
            boolean r6 = r2 instanceof androidx.datastore.core.Data     // Catch:{ all -> 0x00dc }
            if (r6 == 0) goto L_0x0083
            kotlin.jvm.functions.Function2 r2 = r9.getTransform()     // Catch:{ all -> 0x00dc }
            kotlin.coroutines.CoroutineContext r9 = r9.getCallerContext()     // Catch:{ all -> 0x00dc }
            r0.L$0 = r10     // Catch:{ all -> 0x00dc }
            r0.label = r5     // Catch:{ all -> 0x00dc }
            java.lang.Object r9 = r8.transformAndWrite(r2, r9, r0)     // Catch:{ all -> 0x00dc }
        ...
        L_0x007f:
            ...
            goto L_0x00ba
        L_0x0083:
            boolean r6 = r2 instanceof androidx.datastore.core.ReadException     // Catch:{ all -> 0x00dc }
            if (r6 == 0) goto L_0x0088
            goto L_0x008a
        L_0x0088:
            boolean r5 = r2 instanceof androidx.datastore.core.UnInitialized     // Catch:{ all -> 0x00dc }
        L_0x008a:
            if (r5 == 0) goto L_0x00cb
            androidx.datastore.core.State r5 = r9.getLastState()     // Catch:{ all -> 0x00dc }
            if (r2 != r5) goto L_0x00bf
            r0.L$0 = r9     // Catch:{ all -> 0x00dc }
            r0.L$1 = r8     // Catch:{ all -> 0x00dc }
            r0.L$2 = r10     // Catch:{ all -> 0x00dc }
            r0.label = r4     // Catch:{ all -> 0x00dc }
            java.lang.Object r2 = r8.readAndInitOrPropagateAndThrowFailure(r0)     // Catch:{ all -> 0x00dc }
            if (r2 != r1) goto L_0x00a1
            return r1
        L_0x00a1:
            r2 = r8
        L_0x00a2:
            kotlin.jvm.functions.Function2 r4 = r9.getTransform()     // Catch:{ all -> 0x00dc }
            kotlin.coroutines.CoroutineContext r9 = r9.getCallerContext()     // Catch:{ all -> 0x00dc }
            r0.L$0 = r10     // Catch:{ all -> 0x00dc }
            r5 = 0
            ...
            java.lang.Object r9 = r2.transformAndWrite(r4, r9, r0)     // Catch:{ all -> 0x00dc }
            if (r9 != r1) goto L_0x007f
            return r1
        L_0x00ba:
            java.lang.Object r10 = kotlin.Result.m511constructorimpl(r10)     // Catch:{ all -> 0x0053 }
            goto L_0x00ea
        L_0x00bf:
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNull(r2, r9)     // Catch:{ all -> 0x00dc }
            androidx.datastore.core.ReadException r2 = (androidx.datastore.core.ReadException) r2     // Catch:{ all -> 0x00dc }
            java.lang.Throwable r9 = r2.getReadException()     // Catch:{ all -> 0x00dc }
            throw r9     // Catch:{ all -> 0x00dc }
        L_0x00cb:
            boolean r9 = r2 instanceof androidx.datastore.core.Final     // Catch:{ all -> 0x00dc }
            if (r9 == 0) goto L_0x00d6
            androidx.datastore.core.Final r2 = (androidx.datastore.core.Final) r2     // Catch:{ all -> 0x00dc }
            java.lang.Throwable r9 = r2.getFinalException()     // Catch:{ all -> 0x00dc }
            throw r9     // Catch:{ all -> 0x00dc }
        L_0x00d6:
            kotlin.NoWhenBranchMatchedException r9 = new kotlin.NoWhenBranchMatchedException     // Catch:{ all -> 0x00dc }
        ...
        L_0x00e0:
            ...
            java.lang.Object r10 = kotlin.Result.m511constructorimpl(r10)
        L_0x00ea:
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:58:?, code lost:
        ...
        r0.Z$0 = r11;
        r0.label = 4;
        r12 = r2.getCoordinator().tryLock(new androidx.datastore.core.DataStoreImpl$readDataOrHandleCorruption$2(r2, r12, (kotlin.coroutines.Continuation<? super androidx.datastore.core.DataStoreImpl$readDataOrHandleCorruption$2>) null), r0);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:71:0x014d, code lost:
        if (r7.doWithWriteFileLock(r11, new androidx.datastore.core.DataStoreImpl$readDataOrHandleCorruption$3(r2, r7, r12, (kotlin.coroutines.Continuation<? super androidx.datastore.core.DataStoreImpl$readDataOrHandleCorruption$3>) null), r0) == r1) goto L_0x014f;
     */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:66:0x012c A[RETURN] */
    ...
    public final java.lang.Object readDataOrHandleCorruption(boolean r11, kotlin.coroutines.Continuation<? super androidx.datastore.core.Data<T>> r12) {
        ...
        L_0x005d:
            ...
            java.lang.Object r2 = r0.L$0
            androidx.datastore.core.DataStoreImpl r2 = (androidx.datastore.core.DataStoreImpl) r2
            kotlin.ResultKt.throwOnFailure(r12)     // Catch:{ CorruptionException -> 0x0091 }
            goto L_0x010c
        L_0x0068:
            boolean r11 = r0.Z$0
            java.lang.Object r2 = r0.L$0
        ...
        L_0x0073:
            ...
            kotlin.ResultKt.throwOnFailure(r12)     // Catch:{ CorruptionException -> 0x0081 }
            goto L_0x00ce
        L_0x0081:
            r12 = move-exception
            r11 = r2
        ...
        L_0x0095:
            ...
            r0.L$0 = r10     // Catch:{ CorruptionException -> 0x0110 }
            r0.Z$0 = r11     // Catch:{ CorruptionException -> 0x0110 }
            r0.label = r3     // Catch:{ CorruptionException -> 0x0110 }
            java.lang.Object r12 = r10.readDataFromFileOrDefault(r0)     // Catch:{ CorruptionException -> 0x0110 }
        ...
        L_0x00a8:
            ...
            int r2 = r12.hashCode()     // Catch:{ CorruptionException -> 0x00af }
            goto L_0x00b2
        L_0x00af:
            r12 = move-exception
            goto L_0x0083
        ...
        L_0x00b2:
            ...
            r0.L$1 = r12     // Catch:{ CorruptionException -> 0x00af }
            r0.Z$0 = r11     // Catch:{ CorruptionException -> 0x00af }
        ...
        L_0x00c8:
            ...
            r12 = r9
        L_0x00ce:
            java.lang.Number r12 = (java.lang.Number) r12     // Catch:{ CorruptionException -> 0x0081 }
            int r12 = r12.intValue()     // Catch:{ CorruptionException -> 0x0081 }
            androidx.datastore.core.Data r7 = new androidx.datastore.core.Data     // Catch:{ CorruptionException -> 0x0081 }
            r7.<init>(r3, r11, r12)     // Catch:{ CorruptionException -> 0x0081 }
            goto L_0x010f
        L_0x00da:
            androidx.datastore.core.InterProcessCoordinator r12 = r10.getCoordinator()     // Catch:{ CorruptionException -> 0x0110 }
            r0.L$0 = r10     // Catch:{ CorruptionException -> 0x0110 }
            r0.Z$0 = r11     // Catch:{ CorruptionException -> 0x0110 }
            r2 = 3
            r0.label = r2     // Catch:{ CorruptionException -> 0x0110 }
            java.lang.Object r12 = r12.getVersion(r0)     // Catch:{ CorruptionException -> 0x0110 }
            if (r12 != r1) goto L_0x00ec
            return r1
        L_0x00ec:
            r2 = r10
        L_0x00ed:
            java.lang.Number r12 = (java.lang.Number) r12     // Catch:{ CorruptionException -> 0x0091 }
            int r12 = r12.intValue()     // Catch:{ CorruptionException -> 0x0091 }
            ...
            r6.<init>(r2, r12, r4)     // Catch:{ CorruptionException -> 0x0091 }
            ...
            r0.Z$0 = r11     // Catch:{ CorruptionException -> 0x0091 }
            r12 = 4
            r0.label = r12     // Catch:{ CorruptionException -> 0x0091 }
            java.lang.Object r12 = r3.tryLock(r6, r0)     // Catch:{ CorruptionException -> 0x0091 }
            if (r12 != r1) goto L_0x010c
            return r1
        L_0x010c:
            r7 = r12
            androidx.datastore.core.Data r7 = (androidx.datastore.core.Data) r7     // Catch:{ CorruptionException -> 0x0091 }
        L_0x010f:
            return r7
        L_0x0110:
            r12 = move-exception
        ...
        L_0x0130:
            ...
            r12.<init>()
            androidx.datastore.core.DataStoreImpl$readDataOrHandleCorruption$3 r3 = new androidx.datastore.core.DataStoreImpl$readDataOrHandleCorruption$3     // Catch:{ all -> 0x0164 }
            r3.<init>(r2, r7, r12, r4)     // Catch:{ all -> 0x0164 }
            kotlin.jvm.functions.Function1 r3 = (kotlin.jvm.functions.Function1) r3     // Catch:{ all -> 0x0164 }
            r0.L$0 = r6     // Catch:{ all -> 0x0164 }
            r0.L$1 = r2     // Catch:{ all -> 0x0164 }
            r0.L$2 = r12     // Catch:{ all -> 0x0164 }
            r0.L$3 = r4     // Catch:{ all -> 0x0164 }
            r4 = 6
            r0.label = r4     // Catch:{ all -> 0x0164 }
            java.lang.Object r11 = r7.doWithWriteFileLock(r11, r3, r0)     // Catch:{ all -> 0x0164 }
        ...
        L_0x0166:
            ...
            kotlin.ExceptionsKt.addSuppressed(r12, r11)
            throw r0
        */
