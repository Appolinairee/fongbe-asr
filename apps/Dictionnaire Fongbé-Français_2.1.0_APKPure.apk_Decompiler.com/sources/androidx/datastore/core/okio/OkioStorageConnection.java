...
public final class OkioStorageConnection<T> implements StorageConnection<T> {
    ...
    public <R> java.lang.Object readScope(kotlin.jvm.functions.Function3<? super androidx.datastore.core.ReadScope<T>, ? super java.lang.Boolean, ? super kotlin.coroutines.Continuation<? super R>, ? extends java.lang.Object> r10, kotlin.coroutines.Continuation<? super R> r11) {
        ...
        L_0x003f:
            ...
            okio.FileSystem r5 = r9.fileSystem     // Catch:{ all -> 0x0095 }
            okio.Path r6 = r9.path     // Catch:{ all -> 0x0095 }
            androidx.datastore.core.okio.OkioSerializer<T> r7 = r9.serializer     // Catch:{ all -> 0x0095 }
            ...
            java.lang.Boolean r6 = kotlin.coroutines.jvm.internal.Boxing.boxBoolean(r11)     // Catch:{ all -> 0x0084 }
            r0.L$0 = r9     // Catch:{ all -> 0x0084 }
            r0.L$1 = r2     // Catch:{ all -> 0x0084 }
            r0.Z$0 = r11     // Catch:{ all -> 0x0084 }
            r0.label = r3     // Catch:{ all -> 0x0084 }
            java.lang.Object r10 = r10.invoke(r5, r6, r0)     // Catch:{ all -> 0x0084 }
        ...
        L_0x008e:
            r1 = move-exception
            kotlin.ExceptionsKt.addSuppressed(r11, r1)     // Catch:{ all -> 0x0093 }
        L_0x0092:
    ...
    /* JADX WARNING: Missing exception handler attribute for start block: B:68:0x0112 */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:48:0x00ec A[SYNTHETIC, Splitter:B:48:0x00ec] */
    ...
    public java.lang.Object writeScope(kotlin.jvm.functions.Function2<? super androidx.datastore.core.WriteScope<T>, ? super kotlin.coroutines.Continuation<? super kotlin.Unit>, ? extends java.lang.Object> r10, kotlin.coroutines.Continuation<? super kotlin.Unit> r11) {
        ...
        L_0x0088:
            ...
            okio.Path r8 = r7.path     // Catch:{ all -> 0x0113 }
            java.lang.String r8 = r8.name()     // Catch:{ all -> 0x0113 }
            r5.append(r8)     // Catch:{ all -> 0x0113 }
            java.lang.String r8 = ".tmp"
            r5.append(r8)     // Catch:{ all -> 0x0113 }
            java.lang.String r5 = r5.toString()     // Catch:{ all -> 0x0113 }
            okio.Path r2 = r2.resolve((java.lang.String) r5)     // Catch:{ all -> 0x0113 }
            okio.FileSystem r5 = r7.fileSystem     // Catch:{ IOException -> 0x0104 }
            r5.delete(r2, r3)     // Catch:{ IOException -> 0x0104 }
            androidx.datastore.core.okio.OkioWriteScope r3 = new androidx.datastore.core.okio.OkioWriteScope     // Catch:{ IOException -> 0x0104 }
            okio.FileSystem r5 = r7.fileSystem     // Catch:{ IOException -> 0x0104 }
            androidx.datastore.core.okio.OkioSerializer<T> r8 = r7.serializer     // Catch:{ IOException -> 0x0104 }
            r3.<init>(r5, r2, r8)     // Catch:{ IOException -> 0x0104 }
            androidx.datastore.core.Closeable r3 = (androidx.datastore.core.Closeable) r3     // Catch:{ IOException -> 0x0104 }
            r5 = r3
            androidx.datastore.core.okio.OkioWriteScope r5 = (androidx.datastore.core.okio.OkioWriteScope) r5     // Catch:{ all -> 0x00ed }
            r0.L$0 = r7     // Catch:{ all -> 0x00ed }
            r0.L$1 = r11     // Catch:{ all -> 0x00ed }
            r0.L$2 = r2     // Catch:{ all -> 0x00ed }
            r0.L$3 = r3     // Catch:{ all -> 0x00ed }
            r0.label = r4     // Catch:{ all -> 0x00ed }
            java.lang.Object r10 = r10.invoke(r5, r0)     // Catch:{ all -> 0x00ed }
        ...
        L_0x00d3:
            ...
            okio.FileSystem r10 = r0.fileSystem     // Catch:{ IOException -> 0x00ff }
            boolean r10 = r10.exists(r1)     // Catch:{ IOException -> 0x00ff }
            if (r10 == 0) goto L_0x00e4
            okio.FileSystem r10 = r0.fileSystem     // Catch:{ IOException -> 0x00ff }
            okio.Path r11 = r0.path     // Catch:{ IOException -> 0x00ff }
            r10.atomicMove(r1, r11)     // Catch:{ IOException -> 0x00ff }
        L_0x00e4:
            kotlin.Unit r10 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00fc }
            r2.unlock(r6)
        ...
        L_0x00ed:
            ...
            r10 = r3
        L_0x00f3:
            r10.close()     // Catch:{ all -> 0x00f7 }
            goto L_0x00fb
        L_0x00f7:
            r10 = move-exception
            kotlin.ExceptionsKt.addSuppressed(r11, r10)     // Catch:{ IOException -> 0x00ff }
        L_0x00fb:
            throw r11     // Catch:{ IOException -> 0x00ff }
        L_0x00fc:
            r10 = move-exception
            r11 = r2
            goto L_0x0114
        ...
        L_0x0104:
            r10 = move-exception
        L_0x0105:
            okio.FileSystem r0 = r7.fileSystem     // Catch:{ all -> 0x0113 }
            boolean r0 = r0.exists(r2)     // Catch:{ all -> 0x0113 }
            if (r0 == 0) goto L_0x0112
            okio.FileSystem r0 = r7.fileSystem     // Catch:{ IOException -> 0x0112 }
            r0.delete(r2)     // Catch:{ IOException -> 0x0112 }
        L_0x0112:
