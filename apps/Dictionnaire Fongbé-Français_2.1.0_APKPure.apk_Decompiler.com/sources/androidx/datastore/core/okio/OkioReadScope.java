...
public class OkioReadScope<T> implements ReadScope<T> {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:46:0x0097 A[Catch:{ FileNotFoundException -> 0x0090 }] */
    /* JADX WARNING: Removed duplicated region for block: B:47:0x009b A[Catch:{ FileNotFoundException -> 0x0090 }] */
    ...
    static /* synthetic */ <T> java.lang.Object readData$suspendImpl(androidx.datastore.core.okio.OkioReadScope<T> r8, kotlin.coroutines.Continuation<? super T> r9) {
        ...
        L_0x004c:
            ...
            androidx.datastore.core.okio.OkioSerializer<T> r6 = r8.serializer     // Catch:{ all -> 0x0080 }
            r0.L$0 = r8     // Catch:{ all -> 0x0080 }
            r0.L$1 = r9     // Catch:{ all -> 0x0080 }
            r0.label = r4     // Catch:{ all -> 0x0080 }
            java.lang.Object r2 = r6.readFrom(r2, r0)     // Catch:{ all -> 0x0080 }
        ...
        L_0x008b:
            r8 = move-exception
            kotlin.ExceptionsKt.addSuppressed(r9, r8)     // Catch:{ FileNotFoundException -> 0x0090 }
            goto L_0x0093
        L_0x0090:
            r8 = r2
            goto L_0x009d
        ...
        L_0x0095:
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNull(r9)     // Catch:{ FileNotFoundException -> 0x0090 }
            goto L_0x00f1
        L_0x009b:
            throw r8     // Catch:{ FileNotFoundException -> 0x0090 }
        L_0x009c:
        L_0x009d:
            ...
            r2 = r9
            okio.BufferedSource r2 = (okio.BufferedSource) r2     // Catch:{ all -> 0x00d2 }
            androidx.datastore.core.okio.OkioSerializer<T> r8 = r8.serializer     // Catch:{ all -> 0x00d2 }
            r0.L$0 = r9     // Catch:{ all -> 0x00d2 }
            r0.L$1 = r5     // Catch:{ all -> 0x00d2 }
            r0.label = r3     // Catch:{ all -> 0x00d2 }
            java.lang.Object r8 = r8.readFrom(r2, r0)     // Catch:{ all -> 0x00d2 }
