...
public final class FileStorageConnection<T> implements StorageConnection<T> {
    ...
    public <R> java.lang.Object readScope(kotlin.jvm.functions.Function3<? super androidx.datastore.core.ReadScope<T>, ? super java.lang.Boolean, ? super kotlin.coroutines.Continuation<? super R>, ? extends java.lang.Object> r9, kotlin.coroutines.Continuation<? super R> r10) {
        ...
        L_0x003f:
            ...
            java.io.File r5 = r8.file     // Catch:{ all -> 0x0093 }
            androidx.datastore.core.Serializer<T> r6 = r8.serializer     // Catch:{ all -> 0x0093 }
            ...
            java.lang.Boolean r6 = kotlin.coroutines.jvm.internal.Boxing.boxBoolean(r10)     // Catch:{ all -> 0x0082 }
            r0.L$0 = r8     // Catch:{ all -> 0x0082 }
            r0.L$1 = r2     // Catch:{ all -> 0x0082 }
            r0.Z$0 = r10     // Catch:{ all -> 0x0082 }
            r0.label = r3     // Catch:{ all -> 0x0082 }
            java.lang.Object r9 = r9.invoke(r5, r6, r0)     // Catch:{ all -> 0x0082 }
        ...
        L_0x008c:
            r1 = move-exception
            kotlin.ExceptionsKt.addSuppressed(r10, r1)     // Catch:{ all -> 0x0091 }
        L_0x0090:
    ...
    public java.lang.Object writeScope(kotlin.jvm.functions.Function2<? super androidx.datastore.core.WriteScope<T>, ? super kotlin.coroutines.Continuation<? super kotlin.Unit>, ? extends java.lang.Object> r11, kotlin.coroutines.Continuation<? super kotlin.Unit> r12) {
        ...
        L_0x007b:
            ...
            r3 = r12
        L_0x007d:
            java.io.File r12 = new java.io.File     // Catch:{ all -> 0x0117 }
            java.lang.StringBuilder r7 = new java.lang.StringBuilder     // Catch:{ all -> 0x0117 }
            r7.<init>()     // Catch:{ all -> 0x0117 }
            java.io.File r8 = r5.file     // Catch:{ all -> 0x0117 }
            java.lang.String r8 = r8.getAbsolutePath()     // Catch:{ all -> 0x0117 }
            r7.append(r8)     // Catch:{ all -> 0x0117 }
            java.lang.String r8 = ".tmp"
            r7.append(r8)     // Catch:{ all -> 0x0117 }
            java.lang.String r7 = r7.toString()     // Catch:{ all -> 0x0117 }
            r12.<init>(r7)     // Catch:{ all -> 0x0117 }
            androidx.datastore.core.FileWriteScope r7 = new androidx.datastore.core.FileWriteScope     // Catch:{ IOException -> 0x010c }
            androidx.datastore.core.Serializer<T> r8 = r5.serializer     // Catch:{ IOException -> 0x010c }
            r7.<init>(r12, r8)     // Catch:{ IOException -> 0x010c }
            androidx.datastore.core.Closeable r7 = (androidx.datastore.core.Closeable) r7     // Catch:{ IOException -> 0x010c }
            r8 = r7
            androidx.datastore.core.FileWriteScope r8 = (androidx.datastore.core.FileWriteScope) r8     // Catch:{ all -> 0x00fc }
            r1.L$0 = r5     // Catch:{ all -> 0x00fc }
            r1.L$1 = r3     // Catch:{ all -> 0x00fc }
            r1.L$2 = r12     // Catch:{ all -> 0x00fc }
            r1.L$3 = r7     // Catch:{ all -> 0x00fc }
            r1.label = r4     // Catch:{ all -> 0x00fc }
            java.lang.Object r11 = r11.invoke(r8, r1)     // Catch:{ all -> 0x00fc }
        ...
        L_0x00c1:
            ...
            boolean r11 = r2.exists()     // Catch:{ IOException -> 0x0109 }
            if (r11 == 0) goto L_0x00f3
            java.io.File r11 = r1.file     // Catch:{ IOException -> 0x0109 }
            boolean r11 = androidx.datastore.core.FileMoves_androidKt.atomicMoveTo(r2, r11)     // Catch:{ IOException -> 0x0109 }
            if (r11 == 0) goto L_0x00d2
            goto L_0x00f3
        L_0x00d2:
            java.io.IOException r11 = new java.io.IOException     // Catch:{ IOException -> 0x0109 }
            java.lang.StringBuilder r12 = new java.lang.StringBuilder     // Catch:{ IOException -> 0x0109 }
            r12.<init>(r0)     // Catch:{ IOException -> 0x0109 }
            r12.append(r2)     // Catch:{ IOException -> 0x0109 }
            java.lang.String r0 = " to "
            r12.append(r0)     // Catch:{ IOException -> 0x0109 }
            java.io.File r0 = r1.file     // Catch:{ IOException -> 0x0109 }
            r12.append(r0)     // Catch:{ IOException -> 0x0109 }
            java.lang.String r0 = ". This likely means that there are multiple instances of DataStore for this file. Ensure that you are only creating a single instance of datastore for this file."
            r12.append(r0)     // Catch:{ IOException -> 0x0109 }
            java.lang.String r12 = r12.toString()     // Catch:{ IOException -> 0x0109 }
            r11.<init>(r12)     // Catch:{ IOException -> 0x0109 }
            throw r11     // Catch:{ IOException -> 0x0109 }
        L_0x00f3:
            kotlin.Unit r11 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0117 }
            r3.unlock(r6)
        ...
        L_0x0104:
            r11 = move-exception
            kotlin.ExceptionsKt.addSuppressed(r12, r11)     // Catch:{ IOException -> 0x0109 }
        L_0x0108:
            throw r12     // Catch:{ IOException -> 0x0109 }
        L_0x0109:
            r11 = move-exception
            r12 = r2
            goto L_0x010d
        L_0x010c:
            r11 = move-exception
        L_0x010d:
            boolean r0 = r12.exists()     // Catch:{ all -> 0x0117 }
            if (r0 == 0) goto L_0x0116
            r12.delete()     // Catch:{ all -> 0x0117 }
        L_0x0116:
            throw r11     // Catch:{ all -> 0x0117 }
        L_0x0117:
            r11 = move-exception
            r3.unlock(r6)
            throw r11
