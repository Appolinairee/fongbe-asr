...
public final class MultiProcessCoordinator implements InterProcessCoordinator {
    ...
    /* access modifiers changed from: private */
    public static final long MAX_WAIT_MILLIS = 60000;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:85:0x010e, code lost:
        throw r5;
     */
    /* JADX WARNING: Exception block dominator not found, dom blocks: [B:17:0x0054, B:79:0x0108] */
    ...
    public <T> java.lang.Object tryLock(kotlin.jvm.functions.Function2<? super java.lang.Boolean, ? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> r19, kotlin.coroutines.Continuation<? super T> r20) {
        ...
        L_0x005b:
            ...
            java.lang.Boolean r0 = kotlin.coroutines.jvm.internal.Boxing.boxBoolean(r10)     // Catch:{ all -> 0x010f }
            r3.L$0 = r5     // Catch:{ all -> 0x010f }
            r3.Z$0 = r9     // Catch:{ all -> 0x010f }
            r3.label = r7     // Catch:{ all -> 0x010f }
            java.lang.Object r0 = r2.invoke(r0, r3)     // Catch:{ all -> 0x010f }
        ...
        L_0x007f:
            return r0
        L_0x0080:
            java.io.FileInputStream r0 = new java.io.FileInputStream     // Catch:{ all -> 0x010f }
            java.io.File r11 = r18.getLockFile()     // Catch:{ all -> 0x010f }
            r0.<init>(r11)     // Catch:{ all -> 0x010f }
            r11 = r0
            java.io.Closeable r11 = (java.io.Closeable) r11     // Catch:{ all -> 0x010f }
            r0 = r11
            java.io.FileInputStream r0 = (java.io.FileInputStream) r0     // Catch:{ all -> 0x0104 }
            java.nio.channels.FileChannel r12 = r0.getChannel()     // Catch:{ IOException -> 0x00a8 }
        ...
        L_0x00a8:
            r0 = move-exception
            java.lang.String r12 = r0.getMessage()     // Catch:{ all -> 0x00a2 }
            if (r12 == 0) goto L_0x00b8
            java.lang.String r13 = r1.LOCK_ERROR_MESSAGE     // Catch:{ all -> 0x00a2 }
            boolean r12 = kotlin.text.StringsKt.startsWith$default(r12, r13, r10, r6, r8)     // Catch:{ all -> 0x00a2 }
            if (r12 != r7) goto L_0x00b8
            goto L_0x00c6
        L_0x00b8:
            java.lang.String r12 = r0.getMessage()     // Catch:{ all -> 0x00a2 }
            if (r12 == 0) goto L_0x00f8
            java.lang.String r13 = DEADLOCK_ERROR_MESSAGE     // Catch:{ all -> 0x00a2 }
            boolean r12 = kotlin.text.StringsKt.startsWith$default(r12, r13, r10, r6, r8)     // Catch:{ all -> 0x00a2 }
        ...
        L_0x00ca:
            r7 = 0
        L_0x00cb:
            java.lang.Boolean r0 = kotlin.coroutines.jvm.internal.Boxing.boxBoolean(r7)     // Catch:{ all -> 0x00f2 }
            r3.L$0 = r5     // Catch:{ all -> 0x00f2 }
            r3.L$1 = r11     // Catch:{ all -> 0x00f2 }
            r3.L$2 = r12     // Catch:{ all -> 0x00f2 }
            r3.Z$0 = r9     // Catch:{ all -> 0x00f2 }
            r3.label = r6     // Catch:{ all -> 0x00f2 }
            java.lang.Object r0 = r2.invoke(r0, r3)     // Catch:{ all -> 0x00f2 }
        ...
        L_0x0109:
            r0 = move-exception
            r5 = r0
            kotlin.io.CloseableKt.closeFinally(r11, r4)     // Catch:{ all -> 0x0058 }
    ...
    private final <T> Object withLazyCounter(Function2<? super SharedCounter, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        ...
        InlineMarker.mark(0);
        Object withContext = BuildersKt.withContext(this.context, new MultiProcessCoordinator$withLazyCounter$2(function2, this, (Continuation<? super MultiProcessCoordinator$withLazyCounter$2>) null), continuation);
        InlineMarker.mark(1);
        return withContext;
    }
    ...
    public static final class Companion {
        ...
        public final java.lang.Object getExclusiveFileLockWithRetryIfDeadlock(java.io.FileOutputStream r14, kotlin.coroutines.Continuation<? super java.nio.channels.FileLock> r15) {
            ...
            L_0x0040:
                ...
                java.nio.channels.FileChannel r7 = r14.getChannel()     // Catch:{ IOException -> 0x005e }
                r10 = 9223372036854775807(0x7fffffffffffffff, double:NaN)
                r12 = 0
                r8 = 0
                java.nio.channels.FileLock r2 = r7.lock(r8, r10, r12)     // Catch:{ IOException -> 0x005e }
                kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r15)     // Catch:{ IOException -> 0x005e }
                return r2
            L_0x005e:
                r15 = move-exception
